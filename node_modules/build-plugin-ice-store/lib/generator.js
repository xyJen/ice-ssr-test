...
var Generator = /** @class */ (function () {
    ...
    Generator.prototype.renderAppStore = function () {
        ...
        var targetPath = path.join(this.tempPath, "".concat(sourceFilename, ".ts"));
    ...
    Generator.prototype.renderPageComponent = function (_a) {
        ...
        var pageComponentRenderData = {
            pageComponentImport: "import ".concat(pageComponentName, " from '").concat(pageComponentSourcePath, "'"),
            pageComponentExport: pageComponentName,
            storeFileExists: !!pageStoreFile,
            pageStoreImport: pageStoreFile ? "import store from '".concat(pageStoreFile.replace(pageStoreExtname, ''), "'") : '',
    ...
    Generator.prototype.renderPageLayout = function (_a) {
        ...
        var pageComponentSourcePath = (0, app_helpers_1.formatPath)("".concat(pageDir, "/Layout"));
        if (!fse.pathExistsSync(pageComponentSourcePath)) {
            return;
        }
        var pageLayoutName = "".concat(pageName, "Layout");
        var pageStoreExtname = path.extname(pageStoreFile);
        var pageLayoutRenderData = {
            pageComponentImport: "import ".concat(pageLayoutName, " from '").concat(pageComponentSourcePath, "'"),
