    ...
    return {
        ...
        transform: function (code, id) {
            return __awaiter(this, void 0, void 0, function () {
                var imports, s, str, _loop_1, index;
                                        ...
                                        if (fse.existsSync(styleFilePath_1)) {
                                            ...
                                            if (matches) {
                                                var styleStatements = matches.map(function (matchStr) {
                                                    ...
                                                    return "import \"".concat(!requireSource.startsWith('.') ? requireSource : (0, vite_1.normalizePath)(path.join(path.dirname(styleFilePath_1), requireSource)), "\"");
                                                });
                                                str().prependRight(se, ";\n".concat(styleStatements.join(';\n')));
                                            }
                                            else {
                                                // import style
                                                str().prependRight(se, ";\nimport \"".concat((0, vite_1.normalizePath)(styleFilePath_1), "\""));
                                            }
                                        }
                                    }
                                }
