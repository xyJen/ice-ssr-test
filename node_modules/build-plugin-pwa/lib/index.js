...
var WorkboxPlugin = require("@builder/pack/deps/workbox-webpack-plugin");
...
var plugin = function (_a, options) {
    ...
    onGetWebpackConfig(function (config) {
        ...
        log.info("[PWA]: ".concat(sw, " compiled to ").concat(swDest));
        ...
        * Define global varibles for registration
        ...
        config
            ...
            .tap(function (_a) {
            var args = _a[0];
            return [__assign(__assign({}, args), { __ICE_PWA_SW__: "'".concat(swPath, "'"), __ICE_START_URL__: "'".concat(basename, "'"), __ICE_SW_SCOPE__: "'".concat(swScope, "'"), __ICE_DYNAMIC_START_URL__: "'".concat(dynamicStartUrl, "'") })];
        });
