...
var Overlay = /*#__PURE__*/_react["default"].forwardRef(function (props, ref) {
  ...
  (0, _utils.useListener)(overflowRef.current, 'scroll', scrollEvent, false, !!(visible && overlayRef.current && (_overflowRef$current = overflowRef.current) !== null && _overflowRef$current !== void 0 && _overflowRef$current.length));
