...
export declare function useListener(nodeList: HTMLElement | HTMLElement[], eventName: string, callback: EventListenerOrEventListenerObject, useCapture: boolean, condition: boolean): void;
/**
 * 将N个方法合并为一个链式调用的方法
