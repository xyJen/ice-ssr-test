...
@font-face {
  ...
  src: url("//at.alicdn.com/t/font_1533967_slipq25tezj.eot");
  src: url("//at.alicdn.com/t/font_1533967_slipq25tezj.eot?#iefix") format("embedded-opentype"), url("//at.alicdn.com/t/font_1533967_slipq25tezj.woff2") format("woff2"), url("//at.alicdn.com/t/font_1533967_slipq25tezj.woff") format("woff"), url("//at.alicdn.com/t/font_1533967_slipq25tezj.ttf") format("truetype"), url("//at.alicdn.com/t/font_1533967_slipq25tezj.svg#NextIcon") format("svg");
  font-display: swap; }
...
.next-loading {
  ...
  .next-loading-fusion-reactor {
    display: inline-block;
    width: 40px;
    width: var(--loading-large-size, 40px);
    height: 40px;
    height: var(--loading-large-size, 40px);
    position: relative;
    margin: 0;
    ...
    .next-loading-fusion-reactor .next-loading-dot {
      ...
      border-radius: 50%;
      background: #209BFA;
      background: var(--loading-dot-color, #209BFA);
  ...
  .next-loading-medium-fusion-reactor {
    width: 24px;
    width: var(--loading-medium-size, 24px);
    height: 24px;
    height: var(--loading-medium-size, 24px); }
...
@-webkit-keyframes nextVectorDotsYR {
  ...
  45%,
  50% {
    bottom: calc(40px/2 - 12px*1.2/2);
    bottom: calc(var(--loading-large-size, 40px)/2 - var(--loading-large-dot-size, 12px)*1.2/2);
...
@-webkit-keyframes nextVectorDotsY {
  ...
  45%,
  50% {
    top: calc(40px/2 - 12px*1.2/2);
    top: calc(var(--loading-large-size, 40px)/2 - var(--loading-large-dot-size, 12px)*1.2/2);
    height: calc(12px*1.2);
    height: calc(var(--loading-large-dot-size, 12px)*1.2);
    width: calc(12px*1.2);
    width: calc(var(--loading-large-dot-size, 12px)*1.2); }
...
@-webkit-keyframes nextVectorDotsX {
  ...
  45%,
  50% {
    left: calc(40px/2 - 12px*1.2/2);
    left: calc(var(--loading-large-size, 40px)/2 - var(--loading-large-dot-size, 12px)*1.2/2);
    width: calc(12px*1.2);
    width: calc(var(--loading-large-dot-size, 12px)*1.2);
    height: calc(12px*1.2);
    height: calc(var(--loading-large-dot-size, 12px)*1.2); }
...
@-webkit-keyframes nextVectorDotsXR {
  ...
  45%,
  50% {
    right: calc(40px/2 - 12px*1.2/2);
    right: calc(var(--loading-large-size, 40px)/2 - var(--loading-large-dot-size, 12px)*1.2/2);
    width: calc(12px*1.2);
    width: calc(var(--loading-large-dot-size, 12px)*1.2);
    height: calc(12px*1.2);
    height: calc(var(--loading-large-dot-size, 12px)*1.2); }
...
@-webkit-keyframes nextVectorDotsYR-medium {
  ...
  45%,
  50% {
    bottom: calc(24px/2 - 8px*1.2/2);
    bottom: calc(var(--loading-medium-size, 24px)/2 - var(--loading-medium-dot-size, 8px)*1.2/2);
    height: calc(8px*1.2);
...
@-webkit-keyframes nextVectorDotsY-medium {
  ...
  45%,
  50% {
    top: calc(24px/2 - 8px*1.2/2);
    top: calc(var(--loading-medium-size, 24px)/2 - var(--loading-medium-dot-size, 8px)*1.2/2);
    height: calc(8px*1.2);
    height: calc(var(--loading-medium-dot-size, 8px)*1.2);
    width: calc(8px*1.2);
    width: calc(var(--loading-medium-dot-size, 8px)*1.2); }
...
@-webkit-keyframes nextVectorDotsX-medium {
  ...
  45%,
  50% {
    left: calc(24px/2 - 8px*1.2/2);
    left: calc(var(--loading-medium-size, 24px)/2 - var(--loading-medium-dot-size, 8px)*1.2/2);
    width: calc(8px*1.2);
    width: calc(var(--loading-medium-dot-size, 8px)*1.2);
    height: calc(8px*1.2);
    height: calc(var(--loading-medium-dot-size, 8px)*1.2); }
...
@-webkit-keyframes nextVectorDotsXR-medium {
  ...
  45%,
  50% {
    right: calc(24px/2 - 8px*1.2/2);
    right: calc(var(--loading-medium-size, 24px)/2 - var(--loading-medium-dot-size, 8px)*1.2/2);
    width: calc(8px*1.2);
    width: calc(var(--loading-medium-dot-size, 8px)*1.2);
    height: calc(8px*1.2);
    height: calc(var(--loading-medium-dot-size, 8px)*1.2); }
...
.next-radio-wrapper {
  ...
  .next-radio-wrapper .next-radio-inner {
    ...
    border: var(--radio-circle-border-width, 1px) solid var(--radio-border-color, #DDDDDD);
  ...
  .next-radio-wrapper.checked .next-radio-inner {
    border-color: #209BFA;
    border-color: var(--radio-checked-border-color, #209BFA);
    background: #209BFA;
    background: var(--radio-checked-bg-color, #209BFA); }
  ...
  .next-radio-wrapper.disabled .next-radio-inner {
    border-color: #EEEEEE;
    border-color: var(--radio-disabled-border-color, #EEEEEE);
    background: #FAFAFA;
  ...
  .next-radio-wrapper.disabled.checked .next-radio-inner {
    border-color: #EEEEEE;
    border-color: var(--radio-checked-disabled-border-color, #EEEEEE);
    background: #FAFAFA;
  ...
  .next-radio-wrapper:not(.disabled):hover .next-radio-inner, .next-radio-wrapper:not(.disabled).hovered .next-radio-inner {
    border-color: #209BFA;
    border-color: var(--radio-hovered-border-color, #209BFA);
    background-color: #ADD9FF;
    background-color: var(--radio-hovered-bg-color, #ADD9FF); }
  ...
  .next-radio-wrapper.checked:not(.disabled):hover .next-radio-inner, .next-radio-wrapper.checked:not(.disabled).hovered .next-radio-inner {
    ...
    border-color: var(--radio-checked-hovered-border-color, transparent);
    background: #1274E7;
    background: var(--radio-checked-hovered-bg-color, #1274E7); }
...
.next-radio-button > label {
  ...
  margin: 0 0 0 -1px;
  border: 1px solid #DDDDDD;
  border: 1px solid var(--radio-button-border-color, #DDDDDD);
  ...
  .next-radio-button > label:hover, .next-radio-button > label.hovered {
    z-index: 10;
    border-color: #CCCCCC;
    border-color: var(--radio-button-border-color-hovered, #CCCCCC);
    background-color: #F9F9F9;
    background-color: var(--radio-button-bg-color-hovered, #F9F9F9); }
  ...
  .next-radio-button > label.checked {
    z-index: 11;
    border-color: #209BFA;
    border-color: var(--radio-button-border-color-checked, #209BFA);
    background-color: #FFFFFF;
    background-color: var(--radio-button-bg-color-checked, #FFFFFF); }
    .next-radio-button > label.checked .next-radio-label {
      color: #209BFA;
      color: var(--radio-button-font-color-checked, #209BFA); }
  .next-radio-button > label.disabled {
    z-index: 0;
    cursor: not-allowed;
    border-color: #EEEEEE;
    border-color: var(--radio-button-border-color-disabled, #EEEEEE);
  ...
  .next-radio-button > label.checked.disabled {
    z-index: 0;
    border-color: #EEEEEE;
    border-color: var(--radio-button-border-color-checked-disabled, #EEEEEE);
    background-color: #F9F9F9;
    background-color: var(--radio-button-bg-color-checked-disabled, #F9F9F9); }
...
.next-badge {
  ...
  .next-badge .next-badge-count {
    color: #FFFFFF;
    background: #D23C26;
    background: var(--badge-color-bg, #D23C26);
    text-align: center;
    white-space: nowrap;
    border-radius: 8px;
  ...
  .next-badge .next-badge-dot {
    color: #FFFFFF;
    background: #D23C26;
    background: var(--badge-dot-color-bg, #D23C26);
    text-align: center;
    white-space: nowrap;
    border-radius: 8px;
...
.next-balloon {
  ...
  .next-balloon-title {
    ...
    .next-balloon-title.next-balloon-closable {
      ...
      .next-balloon-title.next-balloon-closable .next-balloon-close {
        top: -1px;
        -webkit-transform: translateY(calc(16px + 16px/2 - 16px/2));
        -webkit-transform: translateY(calc(var(--balloon-size-padding-top, 16px) + var(--balloon-title-font-size, 16px)/2 - var(--balloon-size-close, 16px)/2));
            -ms-transform: translateY(calc(16px + 16px/2 - 16px/2));
            -ms-transform: translateY(calc(var(--balloon-size-padding-top, 16px) + var(--balloon-title-font-size, 16px)/2 - var(--balloon-size-close, 16px)/2));
                transform: translateY(calc(16px + 16px/2 - 16px/2));
  ...
  .next-balloon-primary {
    ...
    border-color: #209BFA;
    border-color: var(--balloon-primary-color-border, #209BFA);
    background-color: #ADD9FF;
    background-color: var(--balloon-primary-color-bg, #ADD9FF);
    -webkit-box-shadow: 0px 1px 3px 0px rgba(0, 0, 0, 0.12);
    -webkit-box-shadow: var(--balloon-primary-shadow, 0px 1px 3px 0px rgba(0, 0, 0, 0.12));
    ...
    .next-balloon-primary .next-balloon-close {
      position: absolute;
      top: -1px;
      -webkit-transform: translateY(calc(16px + 14px/2 - 16px/2));
      -webkit-transform: translateY(calc(var(--balloon-size-padding-top, 16px) + var(--balloon-content-font-size, 14px)/2 - var(--balloon-size-close, 16px)/2));
          -ms-transform: translateY(calc(16px + 14px/2 - 16px/2));
          -ms-transform: translateY(calc(var(--balloon-size-padding-top, 16px) + var(--balloon-content-font-size, 14px)/2 - var(--balloon-size-close, 16px)/2));
              transform: translateY(calc(16px + 14px/2 - 16px/2));
    ...
    .next-balloon-primary:after {
      ...
      border: var(--balloon-primary-border-width, 1px) var(--balloon-border-style, solid) var(--balloon-primary-color-border, #209BFA);
      background-color: #ADD9FF;
      background-color: var(--balloon-primary-color-bg, #ADD9FF);
      z-index: -1; }
  ...
  .next-balloon-normal {
    ...
    -webkit-box-shadow: var(--balloon-normal-shadow, 0px 4px 8px 0px rgba(0, 0, 0, 0.12));
            box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.12);
            box-shadow: var(--balloon-normal-shadow, 0px 4px 8px 0px rgba(0, 0, 0, 0.12));
    border-width: 1px;
...
.next-balloon-tooltip {
  ...
  /* stylelint-enable */
  color: #FAFAFA;
  color: var(--balloon-tooltip-color, #FAFAFA);
  border-color: transparent;
  border-color: var(--balloon-tooltip-color-border, transparent);
  background-color: #333333;
  background-color: var(--balloon-tooltip-color-bg, #333333);
  -webkit-box-shadow: none;
  ...
  .next-balloon-tooltip-right .next-balloon-arrow {
    ...
    .next-balloon-tooltip-right .next-balloon-arrow .next-balloon-arrow-content {
      -webkit-transform: translateX(calc(0px - 12px)) rotate(45deg);
      -webkit-transform: translateX(calc(0px - var(--balloon-size-arrow-size, 12px))) rotate(45deg);
          -ms-transform: translateX(calc(0px - 12px)) rotate(45deg);
  ...
  .next-balloon-tooltip-bottom .next-balloon-arrow {
    ...
    .next-balloon-tooltip-bottom .next-balloon-arrow .next-balloon-arrow-content {
      -webkit-transform: translateY(calc(0px - 12px)) rotate(45deg);
      -webkit-transform: translateY(calc(0px - var(--balloon-size-arrow-size, 12px))) rotate(45deg);
          -ms-transform: translateY(calc(0px - 12px)) rotate(45deg);
...
.next-menu {
  ...
  .next-menu-item {
    ...
    .next-menu-item:not(.next-disabled):hover, .next-menu-item:not(.next-disabled).next-selected:hover, .next-menu-item:not(.next-disabled).next-selected.next-focused:hover, .next-menu-item:not(.next-disabled).next-selected:focus:hover, .next-menu-item:not(.next-disabled).next-focused, .next-menu-item:not(.next-disabled).next-selected.next-focused, .next-menu-item:not(.next-disabled).next-selected:focus {
      ...
      background-color: #F9F9F9;
      background-color: var(--menu-background-hover, #F9F9F9); }
  ...
  .next-menu-divider {
    ...
    border-bottom: var(--menu-divider-width, 1px) var(--menu-divider-style, solid) var(--menu-divider-color, #EEEEEE); }
...
.next-breadcrumb {
  ...
  .next-breadcrumb .next-breadcrumb-text {
    ...
    .next-breadcrumb .next-breadcrumb-text > b {
      color: #209BFA;
      color: var(--breadcrumb-text-keyword-color, #209BFA); }
  ...
  .next-breadcrumb .next-breadcrumb-text.activated {
    ...
    font-weight: bold;
    font-weight: var(--breadcrumb-text-current-weight, bold); }
  ...
  .next-breadcrumb .next-breadcrumb-separator {
    color: #999999;
    color: var(--breadcrumb-icon-color, #999999); }
  .next-breadcrumb .next-breadcrumb-text:not(.next-breadcrumb-text-ellipsis):hover > a {
    color: #209BFA;
    color: var(--breadcrumb-text-color-hover, #209BFA); }
  .next-breadcrumb a.next-breadcrumb-text.activated:hover > a {
    color: #209BFA;
    color: var(--breadcrumb-text-current-color-hover, #209BFA); }
  .next-breadcrumb a.next-breadcrumb-text:not(.next-breadcrumb-text-ellipsis):hover {
    ...
    .next-breadcrumb a.next-breadcrumb-text:not(.next-breadcrumb-text-ellipsis):hover > b {
      color: #209BFA;
      color: var(--breadcrumb-text-keyword-color-hover, #209BFA); }
...
.next-btn {
  ...
  .next-btn.next-small {
    ...
    padding: 0 16px;
    padding: 0 var(--btn-size-s-padding, 16px);
    height: 24px;
    ...
    .next-btn.next-small.next-btn-loading:before {
      ...
      line-height: 12px;
      left: 16px;
      left: var(--btn-size-s-padding, 16px);
      top: 50%;
      text-align: center;
      margin-right: 4px; }
  ...
  .next-btn.next-btn-normal {
    ...
    border-color: #DDDDDD;
    border-color: var(--btn-pure-normal-border-color, #DDDDDD); }
    ...
    .next-btn.next-btn-normal:focus, .next-btn.next-btn-normal:hover, .next-btn.next-btn-normal.hover {
      ...
      background: #F9F9F9;
      background: var(--btn-pure-normal-bg-hover, #F9F9F9);
      border-color: #CCCCCC;
      border-color: var(--btn-pure-normal-border-color-hover, #CCCCCC);
      text-decoration: none; }
    .next-btn.next-btn-normal:active, .next-btn.next-btn-normal.active {
      color: #333333;
      color: var(--btn-pure-normal-color-active, #333333);
      background: #F9F9F9;
      background: var(--btn-pure-normal-bg-active, #F9F9F9);
      border-color: #CCCCCC;
      border-color: var(--btn-pure-normal-border-color-active, #CCCCCC);
      text-decoration: none; }
  .next-btn.next-btn-primary {
    border-style: solid;
    border-style: var(--btn-pure-primary-border-style, solid);
    background: #209BFA;
    background: var(--btn-pure-primary-bg, #209BFA);
    border-color: transparent;
    ...
    .next-btn.next-btn-primary:focus, .next-btn.next-btn-primary:hover, .next-btn.next-btn-primary.hover {
      ...
      background: #1274E7;
      background: var(--btn-pure-primary-bg-hover, #1274E7);
      border-color: transparent;
    ...
    .next-btn.next-btn-primary:active, .next-btn.next-btn-primary.active {
      ...
      background: #1274E7;
      background: var(--btn-pure-primary-bg-active, #1274E7);
      border-color: transparent;
  ...
  .next-btn.next-btn-secondary {
    ...
    border-color: #209BFA;
    border-color: var(--btn-pure-secondary-border-color, #209BFA); }
    .next-btn.next-btn-secondary, .next-btn.next-btn-secondary:link, .next-btn.next-btn-secondary:visited, .next-btn.next-btn-secondary.visited {
      color: #209BFA;
      color: var(--btn-pure-secondary-color, #209BFA); }
    .next-btn.next-btn-secondary:focus, .next-btn.next-btn-secondary:hover, .next-btn.next-btn-secondary.hover {
      ...
      background: #1274E7;
      background: var(--btn-pure-secondary-bg-hover, #1274E7);
      border-color: #1274E7;
      border-color: var(--btn-pure-secondary-border-color-hover, #1274E7);
      text-decoration: none; }
    .next-btn.next-btn-secondary:active, .next-btn.next-btn-secondary.active {
      color: #FFFFFF;
      color: var(--btn-pure-secondary-color-active, #FFFFFF);
      background: #1274E7;
      background: var(--btn-pure-secondary-bg-active, #1274E7);
      border-color: #1274E7;
      border-color: var(--btn-pure-secondary-border-color-active, #1274E7);
      text-decoration: none; }
  .next-btn.disabled, .next-btn[disabled] {
    ...
    .next-btn.disabled.next-btn-normal, .next-btn[disabled].next-btn-normal {
      ...
      border-color: #EEEEEE;
      border-color: var(--btn-pure-normal-border-color-disabled, #EEEEEE); }
    ...
    .next-btn.disabled.next-btn-primary, .next-btn[disabled].next-btn-primary {
      ...
      border-color: #EEEEEE;
      border-color: var(--btn-pure-primary-border-color-disabled, #EEEEEE); }
    ...
    .next-btn.disabled.next-btn-secondary, .next-btn[disabled].next-btn-secondary {
      ...
      border-color: #EEEEEE;
      border-color: var(--btn-pure-secondary-border-color-disabled, #EEEEEE); }
  ...
  .next-btn-warning {
    ...
    .next-btn-warning.next-btn-primary {
      background: #D23C26;
      background: var(--btn-warning-primary-bg, #D23C26);
      border-color: #D23C26;
      border-color: var(--btn-warning-primary-border-color, #D23C26); }
      ...
      .next-btn-warning.next-btn-primary:focus, .next-btn-warning.next-btn-primary:hover, .next-btn-warning.next-btn-primary.hover {
        ...
        background: #B7321E;
        background: var(--btn-warning-primary-bg-hover, #B7321E);
        border-color: #B7321E;
        border-color: var(--btn-warning-primary-border-color-hover, #B7321E);
        text-decoration: none; }
      .next-btn-warning.next-btn-primary:active, .next-btn-warning.next-btn-primary.active {
        ...
        background: #B7321E;
        background: var(--btn-warning-primary-bg-active, #B7321E);
        border-color: #B7321E;
        border-color: var(--btn-warning-primary-border-color-active, #B7321E);
        text-decoration: none; }
    ...
    .next-btn-warning.next-btn-normal {
      ...
      border-color: #D23C26;
      border-color: var(--btn-warning-normal-border-color, #D23C26); }
      .next-btn-warning.next-btn-normal, .next-btn-warning.next-btn-normal:link, .next-btn-warning.next-btn-normal:visited, .next-btn-warning.next-btn-normal.visited {
        color: #D23C26;
        color: var(--btn-warning-normal-color, #D23C26); }
      .next-btn-warning.next-btn-normal:focus, .next-btn-warning.next-btn-normal:hover, .next-btn-warning.next-btn-normal.hover {
        ...
        background: #B7321E;
        background: var(--btn-warning-normal-bg-hover, #B7321E);
        border-color: #B7321E;
        border-color: var(--btn-warning-normal-border-color-hover, #B7321E);
        text-decoration: none; }
      .next-btn-warning.next-btn-normal:active, .next-btn-warning.next-btn-normal.active {
        ...
        background: #B7321E;
        background: var(--btn-warning-normal-bg-active, #B7321E);
        border-color: #B7321E;
        border-color: var(--btn-warning-normal-border-color-active, #B7321E);
        text-decoration: none; }
      .next-btn-warning.next-btn-normal.disabled, .next-btn-warning.next-btn-normal[disabled] {
        ...
        border-color: #EEEEEE;
        border-color: var(--btn-warning-normal-border-color-disabled, #EEEEEE); }
  ...
  .next-btn-text {
    ...
    .next-btn-text.next-btn-secondary {
      ...
      .next-btn-text.next-btn-secondary:focus, .next-btn-text.next-btn-secondary:hover, .next-btn-text.next-btn-secondary.hover {
        color: #209BFA;
        color: var(--btn-text-secondary-color-hover, #209BFA);
        background: transparent;
        border-color: transparent;
        text-decoration: none; }
    ...
    .next-btn-text.next-btn-normal {
      ...
      .next-btn-text.next-btn-normal:focus, .next-btn-text.next-btn-normal:hover, .next-btn-text.next-btn-normal.hover {
        color: #209BFA;
        color: var(--btn-text-normal-color-hover, #209BFA);
        background: transparent;
        border-color: transparent;
        text-decoration: none; }
  ...
  .next-btn-group {
    ...
    .next-btn-group > .next-btn-primary:not(:first-child) {
      ...
      .next-btn-group > .next-btn-primary:not(:first-child).disabled, .next-btn-group > .next-btn-primary:not(:first-child)[disabled] {
        ...
        border-left-color: var(--color-line1-1, #EEEEEE); }
...
.next-btn-group[dir="rtl"] > .next-btn-primary:not(:first-child) {
  ...
  .next-btn-group[dir="rtl"] > .next-btn-primary:not(:first-child).disabled, .next-btn-group[dir="rtl"] > .next-btn-primary:not(:first-child)[disabled] {
    ...
    border-right-color: var(--color-line1-1, #EEEEEE); }
...
.next-btn.next-small[dir="rtl"] {
  ...
  .next-btn.next-small[dir="rtl"].next-btn-loading {
    padding-left: 16px;
    padding-left: var(--btn-size-s-padding, 16px);
    padding-right: calc(16px + 16px);
    padding-right: calc(var(--btn-size-s-padding, 16px) + 16px); }
    .next-btn.next-small[dir="rtl"].next-btn-loading:after {
      right: 16px;
      right: var(--btn-size-s-padding, 16px);
      top: 50%;
      margin-right: 0;
      margin-left: 4px; }
...
.next-btn.next-medium[dir="rtl"] {
  ...
  .next-btn.next-medium[dir="rtl"].next-btn-loading {
    ...
    padding-right: calc(var(--btn-size-m-padding, 20px) + 24px); }
...
.next-btn.next-large[dir="rtl"] {
  ...
  .next-btn.next-large[dir="rtl"].next-btn-loading {
    ...
    padding-right: calc(var(--btn-size-l-padding, 24px) + 24px); }
...
.next-input {
  ...
  .next-input.next-warning {
    border-color: #F1C826;
    border-color: var(--input-feedback-warning-border-color, #F1C826);
    background-color: #FFFFFF;
    ...
    .next-input.next-warning.next-focus {
      -webkit-box-shadow: 0 0 0 2px rgba(241, 200, 38, 0.2);
              box-shadow: 0 0 0 2px rgba(241, 200, 38, 0.2); }
  .next-input.next-error {
    border-color: #D23C26;
    border-color: var(--input-feedback-error-border-color, #D23C26);
    background-color: #FFFFFF;
    ...
    .next-input.next-error.next-focus {
      -webkit-box-shadow: 0 0 0 2px rgba(210, 60, 38, 0.2);
              box-shadow: 0 0 0 2px rgba(210, 60, 38, 0.2); }
  ...
  .next-input-control .next-input-len {
    ...
    .next-input-control .next-input-len.next-error {
      color: #D23C26;
      color: var(--input-maxlen-error-color, #D23C26); }
    .next-input-control .next-input-len.next-warning {
      color: #F1C826;
      color: var(--input-maxlen-warning-color, #F1C826); }
  .next-input-control > * {
    display: table-cell;
    width: 1%;
    top: 0; }
  ...
  .next-input-control .next-input-warning-icon {
    color: #F1C826;
    color: var(--input-feedback-warning-color, #F1C826); }
  ...
  .next-input-control .next-input-loading-icon {
    color: #298DFF;
    color: var(--input-feedback-loading-color, #298DFF); }
  ...
  .next-input textarea::-moz-placeholder {
    color: #CCCCCC;
    color: var(--input-placeholder-color, #CCCCCC);
    opacity: 1; }
  ...
  .next-input-group-text {
    ...
    background-color: #F9F9F9;
    background-color: var(--input-addon-bg-color, #F9F9F9);
    text-align: center;
    border: 1px solid #DDDDDD;
    border: var(--input-border-width, 1px) solid var(--input-border-color, #DDDDDD);
    padding: 0 8px;
...
.next-calendar-panel-header {
  position: relative;
  background: #FFFFFF;
  background: var(--calendar-panel-header-background, #FFFFFF);
  margin-bottom: 8px;
  ...
  .next-calendar-panel-header-left, .next-calendar-panel-header-right, .next-calendar-panel-header-full {
    ...
    .next-calendar-panel-header-left .next-calendar-btn, .next-calendar-panel-header-right .next-calendar-btn, .next-calendar-panel-header-full .next-calendar-btn {
      ...
      .next-calendar-panel-header-left .next-calendar-btn, .next-calendar-panel-header-left .next-calendar-btn:link, .next-calendar-panel-header-left .next-calendar-btn:visited, .next-calendar-panel-header-left .next-calendar-btn.visited, .next-calendar-panel-header-right .next-calendar-btn, .next-calendar-panel-header-right .next-calendar-btn:link, .next-calendar-panel-header-right .next-calendar-btn:visited, .next-calendar-panel-header-right .next-calendar-btn.visited, .next-calendar-panel-header-full .next-calendar-btn, .next-calendar-panel-header-full .next-calendar-btn:link, .next-calendar-panel-header-full .next-calendar-btn:visited, .next-calendar-panel-header-full .next-calendar-btn.visited {
        color: #000000;
        color: var(--calendar-btn-date-color, #000000); }
...
.next-calendar-btn-prev-year, .next-calendar-btn-prev-month, .next-calendar-btn-prev-decade, .next-calendar-btn-next-month, .next-calendar-btn-next-year, .next-calendar-btn-next-decade {
  ...
  .next-calendar-btn-prev-year:focus, .next-calendar-btn-prev-year:hover, .next-calendar-btn-prev-year.hover, .next-calendar-btn-prev-month:focus, .next-calendar-btn-prev-month:hover, .next-calendar-btn-prev-month.hover, .next-calendar-btn-prev-decade:focus, .next-calendar-btn-prev-decade:hover, .next-calendar-btn-prev-decade.hover, .next-calendar-btn-next-month:focus, .next-calendar-btn-next-month:hover, .next-calendar-btn-next-month.hover, .next-calendar-btn-next-year:focus, .next-calendar-btn-next-year:hover, .next-calendar-btn-next-year.hover, .next-calendar-btn-next-decade:focus, .next-calendar-btn-next-decade:hover, .next-calendar-btn-next-decade.hover {
    color: #209BFA;
    color: var(--calendar-btn-arrow-color-hover, #209BFA);
    background: transparent;
    border-color: transparent;
    text-decoration: none; }
...
.next-calendar-fullscreen .next-calendar-cell {
  ...
  .next-calendar-fullscreen .next-calendar-cell.next-selected .next-calendar-month {
    ...
    background: #ADD9FF;
    background: var(--calendar-fullscreen-table-cell-select-background, #ADD9FF);
    color: #209BFA;
    color: var(--calendar-fullscreen-table-cell-select-color, #209BFA);
    border-color: #209BFA;
    border-color: var(--calendar-fullscreen-table-cell-select-border-color, #209BFA); }
  ...
  .next-calendar-fullscreen .next-calendar-cell.next-disabled .next-calendar-month {
    ...
    border-color: #EEEEEE;
    border-color: var(--calendar-fullscreen-table-cell-disabled-border-color, #EEEEEE); }
...
.next-calendar-fullscreen .next-calendar-date, .next-calendar-fullscreen .next-calendar-month {
  ...
  .next-calendar-fullscreen .next-calendar-date:hover, .next-calendar-fullscreen .next-calendar-month:hover {
    background: #ADD9FF;
    background: var(--calendar-fullscreen-table-cell-hover-background, #ADD9FF);
    color: #209BFA;
    color: var(--calendar-fullscreen-table-cell-hover-color, #209BFA);
    border-color: #209BFA;
    border-color: var(--calendar-fullscreen-table-cell-hover-border-color, #209BFA); }
...
.next-calendar-fullscreen .next-calendar-cell-current .next-calendar-month {
  ...
  color: #209BFA;
  color: var(--calendar-fullscreen-table-cell-current-color, #209BFA);
  border-color: #209BFA;
  border-color: var(--calendar-fullscreen-table-cell-current-border-color, #209BFA); }
...
.next-calendar-range .next-calendar-cell {
  ...
  .next-calendar-range .next-calendar-cell.next-selected .next-calendar-year {
    ...
    background: #209BFA;
    background: var(--calendar-card-table-cell-select-background, #209BFA);
    color: #FFFFFF;
    color: var(--calendar-card-table-cell-select-color, #FFFFFF);
    border-color: #209BFA;
    border-color: var(--calendar-card-table-cell-select-border-color, #209BFA); }
  ...
  .next-calendar-range .next-calendar-cell.next-inrange .next-calendar-date {
    background: #E4F3FE;
    background: var(--calendar-card-table-cell-inrange-background, #E4F3FE);
    color: #209BFA;
    color: var(--calendar-card-table-cell-inrange-color, #209BFA);
    border-color: #E4F3FE;
    border-color: var(--calendar-card-table-cell-inrange-border-color, #E4F3FE); }
...
.next-calendar-range .next-calendar-year {
  ...
  .next-calendar-range .next-calendar-year:hover {
    background: #E4F3FE;
    background: var(--calendar-card-table-cell-hover-background, #E4F3FE);
    color: #209BFA;
    color: var(--calendar-card-table-cell-hover-color, #209BFA);
    border-color: #E4F3FE;
    border-color: var(--calendar-card-table-cell-hover-border-color, #E4F3FE); }
...
.next-calendar-range .next-calendar-cell-current .next-calendar-year {
  ...
  color: #209BFA;
  color: var(--calendar-card-table-cell-current-color, #209BFA);
  border-color: transparent;
...
.next-card {
  ...
  .next-card {
    ...
    border: var(--card-border-width, 0px) var(--card-border-style, solid) var(--card-border-color, #E6E6E6);
    border-radius: 3px;
  ...
  .next-card-head {
    ...
    .next-card-head-show-bullet .next-card-title:before {
      ...
      background: #209BFA;
      background: var(--card-title-bullet-color, #209BFA);
      position: absolute;
      left: 0;
      top: calc(50% - 16px/2);
    ...
    .next-card-head-main {
      position: relative;
      margin-top: 0px;
      margin-top: var(--card-head-main-margin-top, 0px);
      margin-bottom: 0px;
      margin-bottom: var(--card-head-main-margin-bottom, 0px);
      height: 64px;
      height: var(--card-head-main-height, 64px);
      line-height: 64px;
      line-height: var(--card-head-main-height, 64px); }
  .next-card-title {
    display: inline-block;
    overflow: hidden;
    text-overflow: ellipsis;
  ...
  .next-card-extra {
    ...
    color: #298DFF;
    color: var(--card-title-extra-color, #298DFF); }
  .next-card-body {
    padding-bottom: 20px;
  ...
  .next-card-show-divider .next-card-head-main {
    border-bottom: 1px solid #EEEEEE;
    border-bottom: var(--card-head-bottom-border-width, 1px) var(--card-border-style, solid) var(--card-head-bottom-border-color, #EEEEEE); }
...
.next-cascader {
  ...
  .next-cascader-menu {
    ...
    .next-cascader-menu-item.next-expanded {
      ...
      background-color: #F9F9F9;
      background-color: var(--cascader-menu-item-expanded-background-color, #F9F9F9); }
    ...
    .next-cascader-menu-icon-expand.next-icon .next-icon-remote {
      width: 20px;
      width: var(--cascader-menu-icon-expand-size, 20px);
      font-size: 20px;
      font-size: var(--cascader-menu-icon-expand-size, 20px);
      line-height: inherit; }
...
.next-checkbox-wrapper {
  ...
  .next-checkbox-wrapper .next-checkbox-inner {
    ...
    border: 1px solid #DDDDDD;
    border: var(--checkbox-border-width, 1px) solid var(--checkbox-border-color, #DDDDDD);
    -webkit-transition: all 100ms linear;
    transition: all 100ms linear;
    text-align: left;
    /* 防止继承父级 */
  ...
  .next-checkbox-wrapper.checked > .next-checkbox > .next-checkbox-inner, .next-checkbox-wrapper.checked.focused > .next-checkbox > .next-checkbox-inner {
    ...
    background-color: var(--checkbox-checked-bg-color, #209BFA); }
  ...
  .next-checkbox-wrapper:not(.disabled):hover > .next-checkbox > .next-checkbox-inner, .next-checkbox-wrapper.hovered > .next-checkbox > .next-checkbox-inner, .next-checkbox-wrapper.focused > .next-checkbox > .next-checkbox-inner {
    border-color: #209BFA;
    border-color: var(--checkbox-hovered-border-color, #209BFA);
    background-color: #ADD9FF;
    background-color: var(--checkbox-hovered-bg-color, #ADD9FF); }
  ...
  .next-checkbox-wrapper.indeterminate:not(.disabled):hover > .next-checkbox .next-checkbox-inner, .next-checkbox-wrapper.indeterminate:not(.disabled).hovered > .next-checkbox .next-checkbox-inner, .next-checkbox-wrapper.checked:not(.disabled):hover > .next-checkbox .next-checkbox-inner, .next-checkbox-wrapper.checked:not(.disabled).hovered > .next-checkbox .next-checkbox-inner {
    ...
    background-color: var(--checkbox-checked-hovered-bg-color, #1274E7); }
  ...
  .next-checkbox-wrapper.disabled .next-checkbox-inner {
    border-color: #EEEEEE;
    border-color: var(--checkbox-disabled-border-color, #EEEEEE);
    background: #FAFAFA;
...
.next-collapse {
  ...
  .next-collapse-panel-title {
    ...
    background: #F9F9F9;
    background: var(--collapse-title-bg-color, #F9F9F9);
    font-size: 14px;
    ...
    .next-collapse-panel-title:hover {
      background: #F5F5F5;
      background: var(--collapse-title-hover-bg-color, #F5F5F5);
      color: #333333;
  ...
  .next-collapse-disabled {
    border-color: #EEEEEE;
    border-color: var(--collapse-disabled-border-color, #EEEEEE); }
  ...
  .next-collapse-panel-disabled > .next-collapse-panel-title {
    ...
    background: #F9F9F9;
    background: var(--collapse-title-disabled-bg-color, #F9F9F9); }
...
.next-time-picker-menu {
  ...
  .next-time-picker-menu:not(:last-child) {
    ...
    border-right: var(--time-picker-menu-border-width, 1px) var(--line-solid, solid) var(--time-picker-menu-border-color, #DDDDDD); }
  ...
  .next-time-picker-menu-item {
    ...
    .next-time-picker-menu-item:hover {
      ...
      background: #F9F9F9;
      background: var(--time-picker-menu-item-background-hover, #F9F9F9); }
    .next-time-picker-menu-item.next-selected {
      ...
      background: #F9F9F9;
      background: var(--time-picker-menu-item-background-selected, #F9F9F9); }
...
.next-time-picker-body[dir="rtl"] .next-time-picker-menu {
  ...
  .next-time-picker-body[dir="rtl"] .next-time-picker-menu:not(:last-child) {
    ...
    border-left: var(--time-picker-menu-border-width, 1px) var(--line-solid, solid) var(--time-picker-menu-border-color, #DDDDDD); }
...
.next-week-picker {
  ...
  .next-week-picker-panel-time {
    border-top: 1px solid #E6E6E6;
    border-top: var(--popup-local-border-width, 1px) var(--popup-local-border-style, solid) var(--popup-local-border-color, #E6E6E6); }
...
.next-message {
  ...
  .next-message.next-message-success.next-inline {
    ...
    background-color: var(--message-success-color-bg-inline, #E5FFF5);
    border-color: #E5FFF5;
    border-color: var(--message-success-color-border-inline, #E5FFF5);
    -webkit-box-shadow: none;
            box-shadow: none;
    border-style: solid;
    ...
    .next-message.next-message-success.next-inline .next-message-symbol {
      color: #1AD78C;
      color: var(--message-success-color-icon-inline, #1AD78C); }
  ...
  .next-message.next-message-success.next-addon {
    ...
    .next-message.next-message-success.next-addon .next-message-symbol {
      color: #1AD78C;
      color: var(--message-success-color-icon-addon, #1AD78C); }
  ...
  .next-message.next-message-success.next-toast {
    ...
    .next-message.next-message-success.next-toast .next-message-symbol {
      color: #1AD78C;
      color: var(--message-success-color-icon-toast, #1AD78C); }
  ...
  .next-message.next-message-warning.next-inline {
    ...
    background-color: var(--message-warning-color-bg-inline, #FFF9E0);
    border-color: #FFF9E0;
    border-color: var(--message-warning-color-border-inline, #FFF9E0);
    -webkit-box-shadow: none;
            box-shadow: none;
    border-style: solid;
    border-style: var(--message-border-style, solid); }
    ...
    .next-message.next-message-warning.next-inline .next-message-symbol {
      color: #F1C826;
      color: var(--message-warning-color-icon-inline, #F1C826); }
  ...
  .next-message.next-message-warning.next-addon {
    ...
    .next-message.next-message-warning.next-addon .next-message-symbol {
      color: #F1C826;
      color: var(--message-warning-color-icon-addon, #F1C826); }
  ...
  .next-message.next-message-warning.next-toast {
    ...
    .next-message.next-message-warning.next-toast .next-message-symbol {
      color: #F1C826;
      color: var(--message-warning-color-icon-toast, #F1C826); }
  ...
  .next-message.next-message-error.next-inline {
    ...
    .next-message.next-message-error.next-inline .next-message-symbol {
      color: #D23C26;
      color: var(--message-error-color-icon-inline, #D23C26); }
  ...
  .next-message.next-message-error.next-addon {
    ...
    .next-message.next-message-error.next-addon .next-message-symbol {
      color: #D23C26;
      color: var(--message-error-color-icon-addon, #D23C26); }
  ...
  .next-message.next-message-error.next-toast {
    ...
    .next-message.next-message-error.next-toast .next-message-symbol {
      color: #D23C26;
      color: var(--message-error-color-icon-toast, #D23C26); }
  ...
  .next-message.next-message-notice.next-inline {
    ...
    background-color: var(--message-notice-color-bg-inline, #E4F3FE);
    border-color: #E4F3FE;
    border-color: var(--message-notice-color-border-inline, #E4F3FE);
    -webkit-box-shadow: none;
            box-shadow: none;
    border-style: solid;
    border-style: var(--message-border-style, solid); }
    ...
    .next-message.next-message-notice.next-inline .next-message-symbol {
      color: #298DFF;
      color: var(--message-notice-color-icon-inline, #298DFF); }
  ...
  .next-message.next-message-notice.next-addon {
    ...
    .next-message.next-message-notice.next-addon .next-message-symbol {
      color: #298DFF;
      color: var(--message-notice-color-icon-addon, #298DFF); }
  ...
  .next-message.next-message-notice.next-toast {
    ...
    .next-message.next-message-notice.next-toast .next-message-symbol {
      color: #298DFF;
      color: var(--message-notice-color-icon-toast, #298DFF); }
    .next-message.next-message-notice.next-toast .next-message-symbol-icon::before {
      content: "\E60C";
      content: var(--message-notice-icon-content, "\E60C"); }
  .next-message.next-message-help.next-inline {
    background-color: #FFF9E0;
    background-color: var(--message-help-color-bg-inline, #FFF9E0);
    border-color: #FFF9E0;
    border-color: var(--message-help-color-border-inline, #FFF9E0);
    -webkit-box-shadow: none;
            box-shadow: none;
    border-style: solid;
    border-style: var(--message-border-style, solid); }
    ...
    .next-message.next-message-help.next-inline .next-message-symbol {
      color: #F1C826;
      color: var(--message-help-color-icon-inline, #F1C826); }
  ...
  .next-message.next-message-help.next-addon {
    ...
    .next-message.next-message-help.next-addon .next-message-symbol {
      color: #F1C826;
      color: var(--message-help-color-icon-addon, #F1C826); }
  ...
  .next-message.next-message-help.next-toast {
    ...
    .next-message.next-message-help.next-toast .next-message-symbol {
      color: #F1C826;
      color: var(--message-help-color-icon-toast, #F1C826); }
  ...
  .next-message.next-message-loading.next-inline {
    ...
    .next-message.next-message-loading.next-inline .next-message-symbol {
      color: #209BFA;
      color: var(--message-loading-color-icon-inline, #209BFA); }
  ...
  .next-message.next-message-loading.next-addon {
    ...
    .next-message.next-message-loading.next-addon .next-message-symbol {
      color: #209BFA;
      color: var(--message-loading-color-icon-addon, #209BFA); }
  ...
  .next-message.next-message-loading.next-toast {
    ...
    .next-message.next-message-loading.next-toast .next-message-symbol {
      color: #209BFA;
      color: var(--message-loading-color-icon-toast, #209BFA); }
  ...
  .next-message.next-large {
    ...
    .next-message.next-large .next-message-title {
      padding: 0 20px 0 calc(12px + 24px);
...
.next-message[dir="rtl"].next-medium .next-message-title {
  padding: 0 calc(8px + 16px) 0 20px;
...
.next-message[dir="rtl"].next-large .next-message-title {
  padding: 0 calc(12px + 24px) 0 20px;
...
.next-dialog {
  ...
  border: 1px solid #E6E6E6;
  border: var(--dialog-border-width, 1px) var(--dialog-border-style, solid) var(--dialog-border-color, #E6E6E6);
  border-radius: 6px;
  border-radius: var(--dialog-corner, 6px);
  -webkit-box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.12);
  -webkit-box-shadow: var(--dialog-shadow, 0px 4px 8px 0px rgba(0, 0, 0, 0.12));
          box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.12);
          box-shadow: var(--dialog-shadow, 0px 4px 8px 0px rgba(0, 0, 0, 0.12));
  text-align: left;
  overflow: hidden;
  max-width: 90%;
  /* 让用户自己设置 */
...
.next-drawer {
  ...
  -webkit-box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.12);
  -webkit-box-shadow: var(--drawer-shadow, 0px 4px 8px 0px rgba(0, 0, 0, 0.12));
          box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.12);
          box-shadow: var(--drawer-shadow, 0px 4px 8px 0px rgba(0, 0, 0, 0.12));
  overflow: auto;
  -webkit-animation-duration: 300ms;
          animation-duration: 300ms;
  -webkit-animation-timing-function: ease-in-out;
...
.next-form {
  ...
  .next-form-responsive-grid.next-medium .next-form-item.next-left .next-form-item-label {
    ...
    margin-bottom: calc(32px/2 - 14px/2);
  ...
  .next-form-item {
    ...
    .next-form-item .next-form-preview {
      ...
      .next-form-item .next-form-preview.next-input-textarea > p {
        ...
        line-height: 1.4;
        margin-top: calc(28px/2 - 14px*1.4/2);
    ...
    .next-form-item.next-large {
      ...
      .next-form-item.next-large .next-form-preview {
        ...
        .next-form-item.next-large .next-form-preview.next-input-textarea > p {
          ...
          line-height: 1.4;
          margin-top: calc(40px/2 - 16px*1.4/2);
...
.next-avatar {
  ...
  vertical-align: middle;
  background: #F2F2F2;
  background: var(--color-fill1-4, #F2F2F2);
  width: 40px;
...
.next-select {
  ...
  .next-select-multiple, .next-select-tag {
    ...
    .next-select-multiple.next-small .next-select-values, .next-select-tag.next-small .next-select-values {
      ...
      padding-bottom: calc(24px/2 - 14px/2 - 1px);
    ...
    .next-select-multiple.next-small .next-tag, .next-select-tag.next-small .next-tag {
      border: 0;
      padding-top: calc(14px/2 - 7px);
      padding-top: calc(var(--select-s-lineheight, 14px)/2 - 7px);
      padding-bottom: calc(14px/2 - 7px);
      ...
      .next-select-multiple.next-small .next-tag .next-tag-body, .next-select-multiple.next-small .next-tag .next-tag-close-btn, .next-select-tag.next-small .next-tag .next-tag-body, .next-select-tag.next-small .next-tag .next-tag-close-btn {
        line-height: calc(14px - 14px/2*2 + 14px);
    ...
    .next-select-multiple.next-medium .next-tag, .next-select-tag.next-medium .next-tag {
      padding-top: calc(20px/2 - 9px);
      padding-top: calc(var(--select-m-lineheight, 20px)/2 - 9px);
      padding-bottom: calc(20px/2 - 9px);
      ...
      .next-select-multiple.next-medium .next-tag .next-tag-body, .next-select-multiple.next-medium .next-tag .next-tag-close-btn, .next-select-tag.next-medium .next-tag .next-tag-body, .next-select-tag.next-medium .next-tag .next-tag-close-btn {
        line-height: calc(20px - 20px/2*2 + 18px);
    ...
    .next-select-multiple.next-large .next-tag, .next-select-tag.next-large .next-tag {
      padding-top: calc(24px/2 - 9px);
      padding-top: calc(var(--select-l-lineheight, 24px)/2 - 9px);
      padding-bottom: calc(24px/2 - 9px);
      ...
      .next-select-multiple.next-large .next-tag .next-tag-body, .next-select-multiple.next-large .next-tag .next-tag-close-btn, .next-select-tag.next-large .next-tag .next-tag-body, .next-select-tag.next-large .next-tag .next-tag-close-btn {
        line-height: calc(24px - 24px/2*2 + 18px);
  ...
  .next-select-highlight {
    color: #209BFA;
    color: var(--select-highlight-color, #209BFA);
    font-size: 14px;
...
@media screen and (-webkit-min-device-pixel-ratio: 0) {
  ...
  .next-select-multiple .next-disabled .next-select-tag-compact {
    background: linear-gradient(90deg, rgba(255, 255, 255, 0), #FAFAFA 10px);
    background: linear-gradient(90deg, rgba(255, 255, 255, 0), var(--input-disabled-bg-color, #FAFAFA) 10px); } }
...
.next-list-empty {
  ...
  color: #CCCCCC;
  color: var(--color-line1-4, #CCCCCC);
  padding: 32px 0;
  text-align: center; }
...
.next-menu-btn {
  ...
  .next-menu-btn.next-btn-secondary .next-menu-btn-arrow {
    color: #209BFA;
    color: var(--menu-btn-pure-text-secondary-icon-color, #209BFA); }
  ...
  .next-menu-btn.next-btn-text.next-btn-primary .next-menu-btn-arrow {
    color: #298DFF;
    color: var(--menu-btn-text-text-primary-icon-color, #298DFF); }
...
.next-nav {
  ...
  .next-nav.next-ver {
    ...
    line-height: 52px;
    line-height: var(--nav-ver-height, 52px);
    font-size: 14px;
    ...
    .next-nav.next-ver .next-menu-item.next-nav-item {
      ...
      padding: 0 16px;
      padding: 0 var(--nav-ver-item-padding-lr, 16px);
      border-radius: 0;
    ...
    .next-nav.next-ver .next-menu-item-inner {
      height: 52px;
      height: var(--nav-ver-height, 52px);
      font-size: 14px;
      font-size: var(--nav-ver-font-size, 14px); }
    ...
    .next-nav.next-ver .next-menu-sub-menu {
      line-height: 52px;
      line-height: var(--nav-ver-sub-nav-height, 52px); }
    .next-nav.next-ver .next-menu-sub-menu .next-menu-item-inner {
      height: 52px;
      height: var(--nav-ver-sub-nav-height, 52px);
      font-size: 14px;
  ...
  .next-nav.next-primary {
    ...
    background: #222222;
    background: var(--nav-primary-bg-color, #222222);
    border-color: #222222;
    border-color: var(--nav-primary-border-color, #222222);
    color: #DDDDDD;
    color: var(--nav-primary-text-color, #DDDDDD);
    font-weight: normal;
    font-weight: var(--nav-primary-text-style, normal);
    -webkit-box-shadow: 4px 4px 8px 0px rgba(0, 0, 0, 0.12);
    -webkit-box-shadow: var(--nav-primary-shadow, 4px 4px 8px 0px rgba(0, 0, 0, 0.12));
            box-shadow: 4px 4px 8px 0px rgba(0, 0, 0, 0.12);
            box-shadow: var(--nav-primary-shadow, 4px 4px 8px 0px rgba(0, 0, 0, 0.12)); }
    ...
    .next-nav.next-primary .next-nav-item.next-menu-item {
      ...
      .next-nav.next-primary .next-nav-item.next-menu-item.next-focused, .next-nav.next-primary .next-nav-item.next-menu-item:hover {
        background: #333333;
        background: var(--nav-primary-item-hover-bg-color, #333333);
        color: #FFFFFF;
      ...
      .next-nav.next-primary .next-nav-item.next-menu-item.next-selected {
        background: #333333;
        background: var(--nav-primary-item-selected-bg-color, #333333);
        color: #FFFFFF;
      ...
      .next-nav.next-primary .next-nav-item.next-menu-item.next-opened {
        background: #222222;
        background: var(--nav-primary-item-opened-bg-color, #222222);
        color: #FFFFFF;
      ...
      .next-nav.next-primary .next-nav-item.next-menu-item:before {
        background: #209BFA;
        background: var(--nav-primary-item-selected-active-color, #209BFA); }
      .next-nav.next-primary .next-nav-item.next-menu-item:hover:before {
        background: #209BFA;
        background: var(--nav-primary-item-hover-active-color, #209BFA); }
    ...
    .next-nav.next-primary .next-menu-sub-menu .next-menu-item {
      background: #151515;
      background: var(--nav-primary-sub-nav-bg-color, #151515);
      color: #DDDDDD;
      color: var(--nav-primary-sub-nav-text-color, #DDDDDD);
      font-weight: normal;
      ...
      .next-nav.next-primary .next-menu-sub-menu .next-menu-item.next-focused, .next-nav.next-primary .next-menu-sub-menu .next-menu-item:hover {
        background: #333333;
        background: var(--nav-primary-sub-nav-hover-bg-color, #333333);
        color: #DDDDDD;
        color: var(--nav-primary-sub-nav-hover-text-color, #DDDDDD); }
      .next-nav.next-primary .next-menu-sub-menu .next-menu-item.next-selected {
        background: #333333;
        background: var(--nav-primary-sub-nav-selected-bg-color, #333333);
        color: #FFFFFF;
  ...
  .next-nav.next-secondary {
    ...
    background: #209BFA;
    background: var(--nav-secondary-bg-color, #209BFA);
    border-color: #209BFA;
    border-color: var(--nav-secondary-border-color, #209BFA);
    color: #FFFFFF;
    color: var(--nav-secondary-text-color, #FFFFFF);
    font-weight: normal;
    font-weight: var(--nav-secondary-text-style, normal);
    -webkit-box-shadow: 4px 4px 8px 0px rgba(0, 0, 0, 0.12);
    -webkit-box-shadow: var(--nav-secondary-shadow, 4px 4px 8px 0px rgba(0, 0, 0, 0.12));
            box-shadow: 4px 4px 8px 0px rgba(0, 0, 0, 0.12);
            box-shadow: var(--nav-secondary-shadow, 4px 4px 8px 0px rgba(0, 0, 0, 0.12)); }
    ...
    .next-nav.next-secondary .next-nav-item.next-menu-item {
      ...
      .next-nav.next-secondary .next-nav-item.next-menu-item.next-focused, .next-nav.next-secondary .next-nav-item.next-menu-item:hover {
        background: #1274E7;
        background: var(--nav-secondary-item-hover-bg-color, #1274E7);
        color: #FFFFFF;
      ...
      .next-nav.next-secondary .next-nav-item.next-menu-item.next-selected {
        background: #1274E7;
        background: var(--nav-secondary-item-selected-bg-color, #1274E7);
        color: #FFFFFF;
      ...
      .next-nav.next-secondary .next-nav-item.next-menu-item:before {
        background: #1274E7;
        background: var(--nav-secondary-item-selected-active-color, #1274E7); }
      .next-nav.next-secondary .next-nav-item.next-menu-item:hover:before {
        background: #1274E7;
        background: var(--nav-secondary-item-hover-active-color, #1274E7); }
    ...
    .next-nav.next-secondary .next-menu-sub-menu .next-menu-item {
      background: #209BFA;
      background: var(--nav-secondary-sub-nav-bg-color, #209BFA);
      color: #FFFFFF;
      ...
      .next-nav.next-secondary .next-menu-sub-menu .next-menu-item.next-focused, .next-nav.next-secondary .next-menu-sub-menu .next-menu-item:hover {
        background: #1274E7;
        background: var(--nav-secondary-sub-nav-hover-bg-color, #1274E7);
        color: #FFFFFF;
      ...
      .next-nav.next-secondary .next-menu-sub-menu .next-menu-item.next-selected {
        background: #1274E7;
        background: var(--nav-secondary-sub-nav-selected-bg-color, #1274E7);
        color: #FFFFFF;
    ...
    .next-nav.next-secondary .next-nav-item.next-menu-item.next-disabled .next-menu-item-text > a {
      color: #ADD9FF;
      color: var(--nav-secondary-item-disabled-text-color, #ADD9FF);
      cursor: not-allowed; }
  ...
  .next-nav.next-normal {
    ...
    border-color: #EEEEEE;
    border-color: var(--nav-normal-border-color, #EEEEEE);
    color: #666666;
    color: var(--nav-normal-text-color, #666666);
    font-weight: normal;
    font-weight: var(--nav-normal-text-style, normal);
    -webkit-box-shadow: 4px 4px 8px 0px rgba(0, 0, 0, 0.12);
    -webkit-box-shadow: var(--nav-normal-shadow, 4px 4px 8px 0px rgba(0, 0, 0, 0.12));
            box-shadow: 4px 4px 8px 0px rgba(0, 0, 0, 0.12);
            box-shadow: var(--nav-normal-shadow, 4px 4px 8px 0px rgba(0, 0, 0, 0.12)); }
    .next-nav.next-normal .next-nav-item.next-menu-item {
      ...
      .next-nav.next-normal .next-nav-item.next-menu-item.next-focused, .next-nav.next-normal .next-nav-item.next-menu-item:hover {
        ...
        color: #333333;
        color: var(--nav-normal-item-hover-text-color, #333333);
        font-weight: 500;
        font-weight: var(--nav-normal-item-hover-text-style, 500); }
      .next-nav.next-normal .next-nav-item.next-menu-item.next-selected {
        background: #E4F3FE;
        background: var(--nav-normal-item-selected-bg-color, #E4F3FE);
        color: #209BFA;
        color: var(--nav-normal-item-selected-text-color, #209BFA);
        font-weight: bold;
      ...
      .next-nav.next-normal .next-nav-item.next-menu-item.next-opened {
        ...
        color: #333333;
        color: var(--nav-normal-item-opened-text-color, #333333); }
      .next-nav.next-normal .next-nav-item.next-menu-item.next-child-selected {
        ...
        color: #209BFA;
        color: var(--nav-normal-item-childselected-text-color, #209BFA); }
      ...
      .next-nav.next-normal .next-nav-item.next-menu-item:before {
        background: #209BFA;
        background: var(--nav-normal-item-selected-active-color, #209BFA); }
      .next-nav.next-normal .next-nav-item.next-menu-item:hover:before {
        background: #1B84E0;
        background: var(--nav-normal-item-hover-active-color, #1B84E0); }
    ...
    .next-nav.next-normal .next-menu-sub-menu .next-menu-item {
      background: #FAFAFA;
      background: var(--nav-normal-sub-nav-bg-color, #FAFAFA);
      color: #666666;
      color: var(--nav-normal-sub-nav-text-color, #666666);
      font-weight: normal;
      ...
      .next-nav.next-normal .next-menu-sub-menu .next-menu-item.next-focused, .next-nav.next-normal .next-menu-sub-menu .next-menu-item:hover {
        background: #F9F9F9;
        background: var(--nav-normal-sub-nav-hover-bg-color, #F9F9F9);
        color: #298DFF;
        color: var(--nav-normal-sub-nav-hover-text-color, #298DFF); }
