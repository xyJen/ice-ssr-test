 ...
 */
      ...
      .next-nav.next-normal .next-menu-sub-menu .next-menu-item.next-selected {
        background: #E4F3FE;
        background: var(--nav-normal-sub-nav-selected-bg-color, #E4F3FE);
        color: #209BFA;
        color: var(--nav-normal-sub-nav-selected-text-color, #209BFA); }
  ...
  .next-nav.next-line {
    ...
    .next-nav.next-line .next-nav-item.next-menu-item {
      ...
      .next-nav.next-line .next-nav-item.next-menu-item.next-focused, .next-nav.next-line .next-nav-item.next-menu-item:hover {
        ...
        color: #209BFA;
        color: var(--nav-line-item-hover-text-color, #209BFA);
        font-weight: normal;
      ...
      .next-nav.next-line .next-nav-item.next-menu-item.next-selected {
        ...
        color: #209BFA;
        color: var(--nav-line-item-selected-text-color, #209BFA);
        font-weight: bold;
      ...
      .next-nav.next-line .next-nav-item.next-menu-item.next-opened {
        ...
        color: #209BFA;
        color: var(--nav-line-item-opened-text-color, #209BFA); }
      .next-nav.next-line .next-nav-item.next-menu-item.next-child-selected {
        ...
        color: #209BFA;
        color: var(--nav-line-item-childselected-text-color, #209BFA); }
      ...
      .next-nav.next-line .next-nav-item.next-menu-item:before {
        background: #209BFA;
        background: var(--nav-line-item-selected-active-color, #209BFA); }
      .next-nav.next-line .next-nav-item.next-menu-item:hover:before {
        background: #209BFA;
        background: var(--nav-line-item-hover-active-color, #209BFA); }
    ...
    .next-nav.next-line .next-menu-sub-menu .next-menu-item {
      ...
      .next-nav.next-line .next-menu-sub-menu .next-menu-item.next-focused, .next-nav.next-line .next-menu-sub-menu .next-menu-item:hover {
        ...
        color: #209BFA;
        color: var(--nav-line-sub-nav-hover-text-color, #209BFA); }
      .next-nav.next-line .next-menu-sub-menu .next-menu-item.next-selected {
        ...
        color: #209BFA;
        color: var(--nav-line-sub-nav-selected-text-color, #209BFA); }
  ...
  .next-nav.next-icon-only.next-normal .next-nav-icon.next-icon {
    margin-left: calc(29px - 20px/2 - 16px);
    margin-left: calc(29px - var(--nav-icon-only-font-size, 20px)/2 - var(--nav-ver-item-padding-lr, 16px));
    margin-right: calc(29px - 20px/2 - 16px);
    margin-right: calc(29px - var(--nav-icon-only-font-size, 20px)/2 - var(--nav-ver-item-padding-lr, 16px));
    margin-left: calc(29px - 20px/2 - 16px - 1px);
    margin-left: calc(29px - var(--nav-icon-only-font-size, 20px)/2 - var(--nav-ver-item-padding-lr, 16px) - var(--popup-local-border-width, 1px));
    margin-right: calc(29px - 20px/2 - 16px - 1px);
    margin-right: calc(29px - var(--nav-icon-only-font-size, 20px)/2 - var(--nav-ver-item-padding-lr, 16px) - var(--popup-local-border-width, 1px)); }
    ...
    .next-nav.next-icon-only.next-normal .next-nav-icon.next-icon .next-icon-remote {
      width: 20px;
      width: var(--nav-icon-only-font-size, 20px);
      font-size: 20px;
      font-size: var(--nav-icon-only-font-size, 20px);
      line-height: inherit; }
    .next-nav.next-icon-only.next-normal .next-nav-icon.next-icon:before,
    .next-nav.next-icon-only.next-normal .next-nav-icon.next-icon .next-icon-remote {
      width: 20px;
  ...
  .next-nav.next-icon-only.next-primary .next-nav-icon.next-icon {
    ...
    margin-right: calc(29px - 20px/2 - 16px);
    margin-right: calc(29px - var(--nav-icon-only-font-size, 20px)/2 - var(--nav-ver-item-padding-lr, 16px));
    margin-left: calc(29px - 20px/2 - 16px - 0px);
    margin-left: calc(29px - var(--nav-icon-only-font-size, 20px)/2 - var(--nav-ver-item-padding-lr, 16px) - var(--nav-primary-border-width, 0px));
    margin-right: calc(29px - 20px/2 - 16px - 0px);
    margin-right: calc(29px - var(--nav-icon-only-font-size, 20px)/2 - var(--nav-ver-item-padding-lr, 16px) - var(--nav-primary-border-width, 0px)); }
  ...
  .next-nav.next-icon-only.next-secondary .next-nav-icon.next-icon {
    ...
    margin-right: calc(29px - var(--nav-icon-only-font-size, 20px)/2 - var(--nav-ver-item-padding-lr, 16px));
    margin-left: calc(29px - 20px/2 - 16px - 0px);
    margin-left: calc(29px - var(--nav-icon-only-font-size, 20px)/2 - var(--nav-ver-item-padding-lr, 16px) - var(--nav-secondary-border-width, 0px));
    margin-right: calc(29px - 20px/2 - 16px - 0px);
    margin-right: calc(29px - var(--nav-icon-only-font-size, 20px)/2 - var(--nav-ver-item-padding-lr, 16px) - var(--nav-secondary-border-width, 0px)); }
...
.next-nav[dir="rtl"].next-icon-only .next-nav-item.next-opened .next-nav-icon-only-arrow.next-icon-arrow-down {
  margin-left: 0;
  margin-right: calc(9px - 20px/2);
  margin-right: calc(9px - var(--nav-icon-only-font-size, 20px)/2); }
...
.next-number-picker-normal[dir="rtl"] .next-btn:first-child {
  ...
  border-right: 1px solid var(--color-line1-3, #DDDDDD);
  border-left: 0;
  border-top-right-radius: 0; }
...
.next-pagination {
  ...
  .next-pagination .next-pagination-item:not([disabled]) {
    ...
    border-color: #DDDDDD;
    border-color: var(--pagination-item-border-color, #DDDDDD);
    background: #FFFFFF;
  ...
  .next-pagination .next-pagination-item {
    ...
    .next-pagination .next-pagination-item.next-current {
      border-color: #209BFA;
      border-color: var(--pagination-item-current-border-color, #209BFA);
      background: #209BFA;
      background: var(--pagination-item-current-bg, #209BFA);
      color: #FFFFFF;
    ...
    .next-pagination .next-pagination-item.next-current:hover, .next-pagination .next-pagination-item.next-current:focus {
      border-color: #209BFA;
      border-color: var(--pagination-item-current-hover-border-color, #209BFA);
      background: #FFFFFF;
      background: var(--pagination-item-current-hover-bg, #FFFFFF);
      color: #209BFA;
      color: var(--pagination-item-current-hover-color, #209BFA);
      -webkit-box-shadow: none;
  ...
  .next-pagination-display {
    ...
    .next-pagination-display em {
      font-style: normal;
      color: #209BFA;
      color: var(--pagination-current-color, #209BFA); }
  ...
  .next-pagination-size-selector {
    ...
    .next-pagination-size-selector-btn.next-btn-text {
      ...
      .next-pagination-size-selector-btn.next-btn-text.next-current {
        color: #209BFA;
        color: var(--pagination-size-selector-filter-current-color, #209BFA); }
  ...
  .next-pagination.next-small.next-no-border .next-pagination-item.next-next:not([disabled]):hover i {
    color: #209BFA;
    color: var(--pagination-arrow-hover-color-noboder, #209BFA); }
...
.next-progress-line {
  ...
  .next-progress-line {
    ...
    .next-progress-line-underlay {
      ...
      width: 100%;
      background: #F5F5F5;
      background: var(--progress-line-underlay-color, #F5F5F5); }
    .next-progress-line-overlay {
      ...
      .next-progress-line-overlay-normal {
        background: #209BFA;
        background: var(--progress-line-normal-color, #209BFA); }
      .next-progress-line-overlay-success {
        background: #1AD78C;
        background: var(--progress-line-success-color, #1AD78C); }
      .next-progress-line-overlay-error {
        background: #D23C26;
        background: var(--progress-line-error-color, #D23C26); }
      .next-progress-line-overlay-started {
        background: #D23C26;
        background: var(--progress-line-started-color, #D23C26); }
      .next-progress-line-overlay-middle {
        background: #F1C826;
        background: var(--progress-line-middle-color, #F1C826); }
      .next-progress-line-overlay-finishing {
        background: #1AD78C;
        background: var(--progress-line-finishing-color, #1AD78C); }
  .next-progress-line.next-small .next-progress-line-underlay {
    border-radius: 12px;
    border-radius: var(--progress-line-radius-s, 12px);
    height: 4px;
  ...
  .next-progress-line.next-medium .next-progress-line-underlay {
    border-radius: 12px;
    border-radius: var(--progress-line-radius-m, 12px);
    height: 8px;
  ...
  .next-progress-line.next-large .next-progress-line-underlay {
    border-radius: 12px;
    border-radius: var(--progress-line-radius-l, 12px);
    height: 12px;
...
.next-progress-circle {
  ...
  .next-progress-circle {
    ...
    .next-progress-circle-underlay {
      ...
      stroke: #F5F5F5;
      stroke: var(--progress-circle-underlay-color, #F5F5F5); }
    .next-progress-circle-overlay {
      ...
      .next-progress-circle-overlay-normal {
        stroke: #209BFA;
        stroke: var(--progress-circle-normal-color, #209BFA); }
      .next-progress-circle-overlay-success {
        stroke: #1AD78C;
        stroke: var(--progress-circle-success-color, #1AD78C); }
      .next-progress-circle-overlay-error {
        stroke: #D23C26;
        stroke: var(--progress-circle-error-color, #D23C26); }
      .next-progress-circle-overlay-started {
        stroke: #D23C26;
        stroke: var(--progress-circle-started-color, #D23C26); }
      .next-progress-circle-overlay-middle {
        stroke: #F1C826;
        stroke: var(--progress-circle-middle-color, #F1C826); }
      .next-progress-circle-overlay-finishing {
        stroke: #1AD78C;
        stroke: var(--progress-circle-finishing-color, #1AD78C); }
...
.next-range {
  ...
  .next-range .next-range-slider-inner {
    ...
    border-color: #DDDDDD;
    border-color: var(--range-normal-slider-border-color, #DDDDDD);
    border-radius: 50%;
  ...
  .next-range .next-range-slider.next-range-slider-moving .next-range-slider-inner {
    border: 2px solid #209BFA;
    border: var(--line-2, 2px) var(--line-solid, solid) var(--range-normal-selected-color, #209BFA);
  ...
  .next-range .next-range-track {
    background: #DDDDDD;
    background: var(--range-normal-unselected-color, #DDDDDD); }
    .next-range .next-range-track:hover {
      background: #DDDDDD;
      background: var(--range-normal-unselected-color-hover, #DDDDDD); }
  .next-range .next-range-selected {
    background: #209BFA;
    background: var(--range-normal-selected-color, #209BFA); }
    .next-range .next-range-selected:hover {
      background: #209BFA;
      background: var(--range-normal-selected-color-hover, #209BFA); }
  .next-range .next-range-scale .next-range-scale-item {
    border-color: #DDDDDD;
    border-color: var(--range-normal-unselected-color, #DDDDDD);
    background: #DDDDDD;
    background: var(--range-normal-unselected-color, #DDDDDD); }
    .next-range .next-range-scale .next-range-scale-item:hover {
      border-color: #DDDDDD;
      border-color: var(--range-normal-unselected-color-hover, #DDDDDD); }
    .next-range .next-range-scale .next-range-scale-item.activated {
      border-color: #209BFA;
      border-color: var(--range-normal-selected-color, #209BFA);
      background: #209BFA;
      background: var(--range-normal-selected-color, #209BFA); }
      .next-range .next-range-scale .next-range-scale-item.activated:hover {
        border-color: #209BFA;
        border-color: var(--range-normal-selected-color-hover, #209BFA); }
  .next-range .next-range-slider-inner {
    background: #FFFFFF;
  ...
  .next-range.disabled .next-range-track {
    background: #DDDDDD;
    background: var(--range-normal-unselected-color-disabled, #DDDDDD); }
  .next-range.disabled .next-range-selected {
    background: #CCCCCC;
    background: var(--range-normal-selected-color-disabled, #CCCCCC); }
  .next-range.disabled .next-range-scale-item {
    border-color: #DDDDDD;
    border-color: var(--range-normal-unselected-color-disabled, #DDDDDD); }
    .next-range.disabled .next-range-scale-item.activated {
      border-color: #CCCCCC;
      border-color: var(--range-normal-selected-color-disabled, #CCCCCC); }
  .next-range.disabled .next-range-slider-inner {
    background: #EEEEEE;
    background: var(--range-normal-slider-bg-color-disabled, #EEEEEE);
    border-color: #EEEEEE;
    border-color: var(--range-normal-slider-border-color-disabled, #EEEEEE);
  ...
  .next-range .next-range-slider {
    ...
    -webkit-box-shadow: var(--range-size-m-slider-shadow, 1px 1px 3px 0px rgba(0, 0, 0, 0.12));
  ...
  .next-range.simulation-click > .next-range-slider-inner {
    border: 2px solid #209BFA;
    border: 2px solid var(--range-normal-selected-color, #209BFA);
    -webkit-box-shadow: 4px 4px 8px 0px rgba(0, 0, 0, 0.12);
            box-shadow: 4px 4px 8px 0px rgba(0, 0, 0, 0.12);
    -webkit-transform: scale(1.2);
        -ms-transform: scale(1.2);
...
.next-rating {
  ...
  .next-rating-underlay {
    ...
    .next-rating-underlay .next-icon {
      color: #F2F2F2;
      color: var(--rating-normal-underlay-color, #F2F2F2); }
  .next-rating-stroke-mode .next-rating-underlay .next-icon {
    color: transparent;
    -webkit-text-stroke: 1px #209BFA;
    -webkit-text-stroke: 1px var(--rating-normal-overlay-color, #209BFA); }
  .next-rating-overlay {
    white-space: nowrap;
    overflow: hidden;
    position: absolute;
    ...
    .next-rating-overlay .next-icon {
      color: #209BFA;
      color: var(--rating-normal-overlay-color, #209BFA); }
  ...
  .next-rating-info {
    ...
    border: 1px solid var(--color-fill1-4, #F2F2F2);
    background: #FFFFFF;
    padding: 4px 8px 3px;
    font-size: 12px;
    white-space: nowrap; }
  ...
  .next-rating:focus .next-rating-base:not(.next-rating-base-disabled), .next-rating.hover {
    ...
    .next-rating:focus .next-rating-base:not(.next-rating-base-disabled) .next-rating-overlay .next-icon, .next-rating.hover .next-rating-overlay .next-icon {
      color: #209BFA;
      color: var(--rating-normal-overlay-hover-color, #209BFA); }
...
.next-rating-grade-high .next-rating-overlay .next-icon {
  color: #209BFA;
  color: var(--rating-grade-high-overlay-color, #209BFA); }

.next-rating-grade-high.hover .next-rating-overlay .next-icon {
  color: #209BFA;
  color: var(--rating-grade-high-overlay-hover-color, #209BFA); }
...
.next-search-simple[dir=rtl].next-normal .next-search-left .next-search-left-addon {
  ...
  border-left: 1px solid var(--search-simple-normal-split-color, #DDDDDD);
  border-right: none; }

.next-search-simple[dir=rtl].next-dark .next-search-left {
  border-color: #666666;
  border-color: var(--search-simple-dark-color, #666666); }
  .next-search-simple[dir=rtl].next-dark .next-search-left .next-search-left-addon {
    border-right: 1px solid #DDDDDD;
    border-right: 1px solid var(--search-simple-dark-split-color, #DDDDDD); }

.next-search-simple[dir=rtl].next-dark:hover .next-search-left {
  border-color: #999999;
  border-color: var(--search-simple-dark-hover-color, #999999); }

.next-search-simple[dir=rtl].next-dark .next-search-icon {
  color: #666666;
  color: var(--search-simple-dark-icon-text-color, #666666); }
  .next-search-simple[dir=rtl].next-dark .next-search-icon:hover {
    color: #999999;
    color: var(--search-simple-dark-icon-hover-text-color, #999999); }
...
.next-search-normal[dir=rtl].next-primary .next-input {
  ...
  border-top-right-radius: calc(var(--search-normal-corner, 3px) - var(--search-normal-primary-border-width, 1px));
  border-bottom-right-radius: calc(3px - 1px);
  border-bottom-right-radius: calc(var(--search-normal-corner, 3px) - var(--search-normal-primary-border-width, 1px)); }

.next-search-normal[dir=rtl].next-primary .next-search-left .next-search-left-addon {
  border-left: 1px solid #EEEEEE;
  border-left: 1px solid var(--search-normal-primary-split-color, #EEEEEE);
  border-right: none; }
...
.next-search-normal[dir=rtl].next-secondary .next-search-left .next-search-left-addon {
  border-left: 1px solid #EEEEEE;
  border-left: 1px solid var(--search-normal-secondary-split-color, #EEEEEE);
  border-right: none; }
...
.next-search-normal[dir=rtl].next-normal .next-search-left .next-search-left-addon {
  border-left: 1px solid #EEEEEE;
  border-left: 1px solid var(--search-normal-normal-split-color, #EEEEEE);
  border-right: none; }

.next-search-normal[dir=rtl].next-dark .next-search-left .next-search-left-addon {
  border-left: 1px solid #209BFA;
  border-left: 1px solid var(--search-normal-dark-color, #209BFA);
  border-right: none; }
...
.next-search {
  ...
  .next-search-normal {
    ...
    .next-search-normal.next-primary .next-search-left {
      border-color: #209BFA;
      border-color: var(--search-normal-primary-color, #209BFA); }
      .next-search-normal.next-primary .next-search-left .next-search-left-addon {
        border-right: 1px solid #EEEEEE;
        border-right: 1px solid var(--search-normal-primary-split-color, #EEEEEE); }
    .next-search-normal.next-primary:hover .next-search-left,
    .next-search-normal.next-primary:hover .next-btn {
      border-color: #209BFA;
      border-color: var(--search-normal-primary-hover-color, #209BFA); }
    .next-search-normal.next-primary .next-search-btn {
      background: #209BFA;
      background: var(--search-normal-primary-color, #209BFA);
      border-color: #209BFA;
      border-color: var(--search-normal-primary-color, #209BFA);
      color: #FFFFFF;
      ...
      .next-search-normal.next-primary .next-search-btn:hover {
        background: #1274E7;
        background: var(--search-normal-primary-btn-hover-bg-color, #1274E7);
        border-color: #209BFA;
        border-color: var(--search-normal-primary-hover-color, #209BFA);
        color: #FFFFFF;
    ...
    .next-search-normal.next-primary.next-large {
      ...
      .next-search-normal.next-primary.next-large .next-search-left, .next-search-normal.next-primary.next-large .next-search-btn {
        ...
        height: 40px;
        height: var(--search-normal-primary-l-height, 40px); }
      .next-search-normal.next-primary.next-large .next-search-input {
        ...
        .next-search-normal.next-primary.next-large .next-search-input input {
          ...
          line-height: calc(var(--search-normal-primary-l-height, 40px) - var(--search-normal-primary-border-width, 1px)*2) \0; }
    ...
    .next-search-normal.next-primary .next-input {
      ...
      border-top-left-radius: calc(var(--search-normal-corner, 3px) - var(--search-normal-primary-border-width, 1px));
      border-bottom-left-radius: calc(3px - 1px);
      border-bottom-left-radius: calc(var(--search-normal-corner, 3px) - var(--search-normal-primary-border-width, 1px)); }
    .next-search-normal.next-secondary .next-search-left {
      border-color: #DDDDDD;
      border-color: var(--search-normal-secondary-color, #DDDDDD); }
      .next-search-normal.next-secondary .next-search-left .next-search-left-addon {
        border-right: 1px solid #EEEEEE;
        border-right: 1px solid var(--search-normal-secondary-split-color, #EEEEEE); }
    .next-search-normal.next-secondary:hover .next-search-left,
    .next-search-normal.next-secondary:hover .next-btn {
      border-color: #209BFA;
      border-color: var(--search-normal-secondary-hover-color, #209BFA); }
    .next-search-normal.next-secondary .next-search-btn {
      background: #209BFA;
      background: var(--search-normal-secondary-btn-bg-color, #209BFA);
      border-color: #209BFA;
      border-color: var(--search-normal-secondary-btn-bg-color, #209BFA);
      color: #FFFFFF;
      color: var(--search-normal-secondary-btn-text-color, #FFFFFF); }
      .next-search-normal.next-secondary .next-search-btn:hover {
        background: #1274E7;
        background: var(--search-normal-secondary-btn-hover-bg-color, #1274E7);
        border-color: #209BFA;
        border-color: var(--search-normal-secondary-hover-color, #209BFA);
        color: #FFFFFF;
    ...
    .next-search-normal.next-secondary.next-large {
      ...
      .next-search-normal.next-secondary.next-large .next-search-left, .next-search-normal.next-secondary.next-large .next-search-btn {
        ...
        height: 40px;
        height: var(--search-normal-secondary-l-height, 40px); }
      .next-search-normal.next-secondary.next-large .next-search-input {
        ...
        .next-search-normal.next-secondary.next-large .next-search-input input {
          ...
          height: calc(var(--search-normal-secondary-l-height, 40px) - var(--search-normal-secondary-border-width, 1px)*2);
          line-height: calc(40px - 1px*2) \0;
          line-height: calc(var(--search-normal-secondary-l-height, 40px) - var(--search-normal-secondary-border-width, 1px)*2) \0; }
    ...
    .next-search-normal.next-normal .next-search-left {
      border-color: #DDDDDD;
      border-color: var(--search-normal-normal-color, #DDDDDD); }
      .next-search-normal.next-normal .next-search-left .next-search-left-addon {
        border-right: 1px solid #EEEEEE;
        border-right: 1px solid var(--search-normal-normal-split-color, #EEEEEE); }
    .next-search-normal.next-normal:hover .next-search-left,
    .next-search-normal.next-normal:hover .next-btn {
      border-color: #CCCCCC;
      border-color: var(--search-normal-normal-hover-color, #CCCCCC); }
    .next-search-normal.next-normal .next-search-btn {
      ...
      .next-search-normal.next-normal .next-search-btn:hover {
        background: #F5F5F5;
        background: var(--search-normal-normal-btn-hover-bg-color, #F5F5F5);
        border-color: #CCCCCC;
        border-color: var(--search-normal-normal-hover-color, #CCCCCC);
        color: #333333;
    ...
    .next-search-normal.next-normal.next-large {
      ...
      .next-search-normal.next-normal.next-large .next-search-left, .next-search-normal.next-normal.next-large .next-search-btn {
        ...
        height: 40px;
        height: var(--search-normal-normal-l-height, 40px); }
      .next-search-normal.next-normal.next-large .next-search-input {
        ...
        .next-search-normal.next-normal.next-large .next-search-input input {
          ...
          height: calc(var(--search-normal-normal-l-height, 40px) - var(--search-normal-normal-border-width, 1px)*2);
          line-height: calc(40px - 1px*2) \0;
          line-height: calc(var(--search-normal-normal-l-height, 40px) - var(--search-normal-normal-border-width, 1px)*2) \0; }
    ...
    .next-search-normal.next-dark .next-search-left {
      border-color: #209BFA;
      border-color: var(--search-normal-dark-color, #209BFA); }
      .next-search-normal.next-dark .next-search-left .next-search-left-addon {
        border-right: 1px solid #209BFA;
        border-right: 1px solid var(--search-normal-dark-color, #209BFA); }
    .next-search-normal.next-dark:hover .next-search-left,
    .next-search-normal.next-dark:hover .next-btn {
      border-color: #209BFA;
      border-color: var(--search-normal-dark-hover-color, #209BFA); }
    .next-search-normal.next-dark .next-search-btn {
      background: #209BFA;
      background: var(--search-normal-dark-color, #209BFA);
      border-color: #209BFA;
      border-color: var(--search-normal-dark-color, #209BFA);
      color: #FFFFFF;
      ...
      .next-search-normal.next-dark .next-search-btn:hover {
        background: #1274E7;
        background: var(--search-normal-dark-btn-hover-bg-color, #1274E7);
        border-color: #209BFA;
        border-color: var(--search-normal-dark-hover-color, #209BFA);
        color: #FFFFFF;
    ...
    .next-search-normal.next-dark.next-large {
      ...
      .next-search-normal.next-dark.next-large .next-search-left, .next-search-normal.next-dark.next-large .next-search-btn {
        ...
        height: 40px;
        height: var(--search-normal-dark-l-height, 40px); }
      .next-search-normal.next-dark.next-large .next-search-input {
        ...
        .next-search-normal.next-dark.next-large .next-search-input input {
          ...
          height: calc(var(--search-normal-dark-l-height, 40px) - var(--search-normal-dark-border-width, 1px)*2);
          line-height: calc(40px - 1px*2) \0;
          line-height: calc(var(--search-normal-dark-l-height, 40px) - var(--search-normal-dark-border-width, 1px)*2) \0; }
  ...
  .next-search-simple {
    ...
    .next-search-simple.next-normal .next-search-left {
      border-color: #DDDDDD;
      border-color: var(--search-simple-normal-color, #DDDDDD); }
      .next-search-simple.next-normal .next-search-left .next-search-left-addon {
        border-right: 1px solid #DDDDDD;
        border-right: 1px solid var(--search-simple-normal-split-color, #DDDDDD); }
...
.next-step-arrow {
  ...
  .next-step-arrow .next-step-item {
    ...
    .next-step-arrow .next-step-item:after {
      ...
      border-left: calc(32px/2) solid transparent;
  ...
  .next-step-arrow > .next-step-item-wait {
    background: #F5F5F5;
    background: var(--step-arrow-item-wait-background, #F5F5F5); }
    ...
    .next-step-arrow > .next-step-item-wait:before {
      border: calc(32px/2) solid #F5F5F5;
      border: calc(var(--step-arrow-item-height, 32px)/2) solid var(--step-arrow-item-wait-background, #F5F5F5);
      border-left-color: transparent; }
    .next-step-arrow > .next-step-item-wait:after {
      border-left-color: #F5F5F5;
      border-left-color: var(--step-arrow-item-wait-background, #F5F5F5); }
  .next-step-arrow > .next-step-item-process {
    background: #209BFA;
    background: var(--step-arrow-item-process-background, #209BFA); }
    ...
    .next-step-arrow > .next-step-item-process:before {
      border: calc(32px/2) solid #209BFA;
      border: calc(var(--step-arrow-item-height, 32px)/2) solid var(--step-arrow-item-process-background, #209BFA);
      border-left-color: transparent; }
    .next-step-arrow > .next-step-item-process:after {
      border-left-color: #209BFA;
      border-left-color: var(--step-arrow-item-process-background, #209BFA); }
  .next-step-arrow > .next-step-item-finish {
    background: #ADD9FF;
    background: var(--step-arrow-item-finish-background, #ADD9FF); }
    ...
    .next-step-arrow > .next-step-item-finish .next-step-item-title {
      color: #209BFA;
      color: var(--step-arrow-item-title-finish-color, #209BFA);
      word-break: break-word; }
    ...
    .next-step-arrow > .next-step-item-finish:before {
      border: calc(32px/2) solid #ADD9FF;
      border: calc(var(--step-arrow-item-height, 32px)/2) solid var(--step-arrow-item-finish-background, #ADD9FF);
      border-left-color: transparent; }
    .next-step-arrow > .next-step-item-finish:after {
      border-left-color: #ADD9FF;
      border-left-color: var(--step-arrow-item-finish-background, #ADD9FF); }
  .next-step-arrow .next-step-item-disabled {
    ...
    .next-step-arrow .next-step-item-disabled:before {
      border: calc(32px/2) solid #FAFAFA;
...
.next-step-circle .next-step-item-container {
  ...
  .next-step-circle .next-step-item-container .next-step-item-progress .next-progress-circle-text {
    color: #209BFA;
    color: var(--step-circle-item-node-process-percent-color, #209BFA);
    font-size: 14px;
  ...
  .next-step-circle .next-step-item-container .next-step-item-progress .next-progress-circle-underlay {
    stroke: #CCCCCC;
    stroke: var(--step-circle-item-node-wait-border-color, #CCCCCC);
    stroke-width: calc(1px*3);
  ...
  .next-step-circle .next-step-item-container .next-step-item-progress .next-progress-circle-overlay-normal {
    stroke: #209BFA;
    stroke: var(--step-circle-item-node-finish-border-color, #209BFA);
    stroke-width: calc(1px*3);
    stroke-width: calc(var(--step-circle-item-node-border-width, 1px)*3); }
...
.next-step-circle > .next-step-item-wait .next-step-item-tail-overlay {
  background: #DDDDDD;
  background: var(--step-circle-item-tail-wait-color, #DDDDDD); }

.next-step-circle > .next-step-item-wait .next-step-item-tail-underlay {
  background: #EEEEEE;
  background: var(--step-circle-item-tail-bg-color, #EEEEEE); }
...
.next-step-circle > .next-step-item-wait > .next-step-item-container .next-step-item-node-circle {
  ...
  border-color: #CCCCCC;
  border-color: var(--step-circle-item-node-wait-border-color, #CCCCCC); }
...
.next-step-circle > .next-step-item-process .next-step-item-tail-overlay {
  background: #DDDDDD;
  background: var(--step-circle-item-tail-process-color, #DDDDDD); }
...
.next-step-circle > .next-step-item-process > .next-step-item-container .next-step-item-node-circle {
  background: #209BFA;
  background: var(--step-circle-item-node-process-background, #209BFA);
  border-color: #209BFA;
  border-color: var(--step-circle-item-node-process-border-color, #209BFA); }
...
.next-step-circle > .next-step-item-finish .next-step-item-tail-overlay {
  background: #209BFA;
  background: var(--step-circle-item-tail-finish-color, #209BFA); }
...
.next-step-circle > .next-step-item-finish > .next-step-item-container .next-step-item-node {
  color: #209BFA;
  color: var(--step-circle-item-node-finish-color, #209BFA); }
...
.next-step-circle > .next-step-item-finish > .next-step-item-container .next-step-item-node-circle {
  ...
  border-color: #209BFA;
  border-color: var(--step-circle-item-node-finish-border-color, #209BFA); }
...
.next-step-circle .next-step-item-disabled .next-step-item-tail-overlay {
  background: #EEEEEE;
  background: var(--step-circle-item-tail-disabled-color, #EEEEEE); }
...
.next-step-circle .next-step-item-disabled > .next-step-item-container .next-step-item-node-circle {
  ...
  border-color: #EEEEEE;
  border-color: var(--step-circle-item-node-disabled-border-color, #EEEEEE); }
...
.next-step-circle.next-step-horizontal {
  ...
  .next-step-circle.next-step-horizontal > .next-step-item-wait > .next-step-item-body {
    ...
    left: calc(0px - 100px/2 + 32px/2 + 8px*2/2);
...
.next-step-circle.next-step-horizontal.next-step-label-horizontal > .next-step-item-wait .next-step-item-tail {
  width: calc(100% - 32px - 8px*2 - 100px);
...
.next-step-dot > .next-step-item-wait .next-step-item-tail-overlay {
  background: #DDDDDD;
  background: var(--step-dot-item-tail-wait-color, #DDDDDD); }

.next-step-dot > .next-step-item-wait .next-step-item-tail-underlay {
  background: #EEEEEE;
  background: var(--step-dot-item-tail-bg-color, #EEEEEE); }
...
.next-step-dot > .next-step-item-wait > .next-step-item-container .next-step-item-node-circle {
  ...
  border-color: #CCCCCC;
  border-color: var(--step-dot-item-node-wait-border-color, #CCCCCC); }
...
.next-step-dot > .next-step-item-process .next-step-item-tail-overlay {
  background: #DDDDDD;
  background: var(--step-dot-item-tail-process-color, #DDDDDD); }
...
.next-step-dot > .next-step-item-process > .next-step-item-container .next-step-item-node {
  color: #209BFA;
  color: var(--step-dot-item-node-process-color, #209BFA); }

.next-step-dot > .next-step-item-process > .next-step-item-container .next-step-item-node-circle {
  background: #209BFA;
  background: var(--step-dot-item-node-process-background, #209BFA);
  border-color: #209BFA;
  border-color: var(--step-dot-item-node-process-border-color, #209BFA); }
...
.next-step-dot > .next-step-item-finish .next-step-item-tail-overlay {
  background: #209BFA;
  background: var(--step-dot-item-tail-finish-color, #209BFA); }
...
.next-step-dot > .next-step-item-finish > .next-step-item-container .next-step-item-node {
  color: #209BFA;
  color: var(--step-dot-item-node-finish-color, #209BFA); }
...
.next-step-dot > .next-step-item-finish > .next-step-item-container .next-step-item-node-circle {
  ...
  border-color: #209BFA;
  border-color: var(--step-dot-item-node-finish-border-color, #209BFA); }
...
.next-step-dot .next-step-item-disabled .next-step-item-tail-overlay {
  background: #EEEEEE;
  background: var(--step-dot-item-tail-disabled-color, #EEEEEE); }
...
.next-step-dot .next-step-item-disabled > .next-step-item-container .next-step-item-node {
  color: #EEEEEE;
  color: var(--step-dot-item-node-disabled-color, #EEEEEE); }
...
.next-step-dot.next-step-horizontal {
  ...
  .next-step-dot.next-step-horizontal > .next-step-item-wait > .next-step-item-body {
    ...
    left: calc(0px - 100px/2 + 12px/2 + 8px*2/2);
...
.next-step-arrow[dir="rtl"] .next-step-item {
  ...
  .next-step-arrow[dir="rtl"] .next-step-item:after {
    ...
    border-bottom: calc(32px/2) solid transparent;
    border-bottom: calc(var(--step-arrow-item-height, 32px)/2) solid transparent;
    border-right: calc(32px/2) solid transparent;
...
.next-step-arrow[dir="rtl"] > .next-step-item-wait {
  ...
  .next-step-arrow[dir="rtl"] > .next-step-item-wait:after {
    ...
    border-right-color: var(--step-arrow-item-wait-background, #F5F5F5);
    border-left-color: transparent; }
...
.next-step-arrow[dir="rtl"] > .next-step-item-process {
  ...
  .next-step-arrow[dir="rtl"] > .next-step-item-process:after {
    border-right-color: #209BFA;
    border-right-color: var(--step-arrow-item-process-background, #209BFA);
    border-left-color: transparent; }
...
.next-step-arrow[dir="rtl"] > .next-step-item-finish {
  ...
  .next-step-arrow[dir="rtl"] > .next-step-item-finish:after {
    border-right-color: #ADD9FF;
    border-right-color: var(--step-arrow-item-finish-background, #ADD9FF);
    border-left-color: transparent; }
...
.next-step-circle[dir="rtl"].next-step-horizontal > .next-step-item-wait > .next-step-item-body {
  right: calc(0px - 100px/2 + 32px/2 + 8px*2/2);
...
.next-step-dot[dir="rtl"].next-step-horizontal > .next-step-item-wait > .next-step-item-body {
  right: calc(0px - 100px/2 + 12px/2 + 8px*2/2);
...
.next-switch-on[disabled][dir="rtl"]:after {
  ...
  right: 100%;
  -webkit-box-shadow: 1px 1px 3px 0px rgba(0, 0, 0, 0.12);
  -webkit-box-shadow: var(--switch-on-shadow, 1px 1px 3px 0px rgba(0, 0, 0, 0.12));
          box-shadow: 1px 1px 3px 0px rgba(0, 0, 0, 0.12);
...
.next-switch-off[dir="rtl"]:after {
  ...
  -webkit-box-shadow: var(--switch-rtl-on-shadow, -1px 0px 3px 0px rgba(0, 0, 0, 0.12));
...
.next-switch {
  ...
  .next-switch-medium {
    ...
    .next-switch-medium > .next-switch-btn {
      ...
      border-radius: 12px;
      border-radius: var(--switch-size-m-radius-trigger, 12px);
      -webkit-box-sizing: border-box;
              box-sizing: border-box; }
  ...
  .next-switch-small {
    ...
    .next-switch-small > .next-switch-btn {
      ...
      border-radius: 12px;
      border-radius: var(--switch-size-s-radius-trigger, 12px);
      -webkit-box-sizing: border-box;
              box-sizing: border-box; }
  ...
  .next-switch-on {
    ...
    background-color: var(--switch-normal-on-bg-color, #209BFA); }
    ...
    .next-switch-on:focus, .next-switch-on.hover, .next-switch-on:hover {
      ...
      background-color: var(--switch-hover-on-bg-color, #1274E7); }
  ...
  .next-switch-on[disabled] {
    ...
    background-color: var(--switch-disabled-on-bg-color, #F5F5F5);
    cursor: not-allowed; }
  ...
  .next-switch-off {
    background-color: #F5F5F5;
    background-color: var(--switch-normal-off-bg-color, #F5F5F5);
    border-color: #F5F5F5;
    border-color: var(--switch-normal-off-border-color, #F5F5F5); }
    .next-switch-off:focus, .next-switch-off.hover, .next-switch-off:hover {
      background-color: #F5F5F5;
      background-color: var(--switch-hover-off-bg-color, #F5F5F5);
      border-color: #F5F5F5;
      border-color: var(--switch-hover-off-border-color, #F5F5F5); }
  ...
  .next-switch-off[disabled] {
    background-color: #F5F5F5;
    background-color: var(--switch-disabled-off-bg-color, #F5F5F5);
    cursor: not-allowed; }
    .next-switch-off[disabled] .next-switch-btn {
      -webkit-box-shadow: 1px 1px 3px 0px rgba(0, 0, 0, 0.12);
      -webkit-box-shadow: var(--switch-off-shadow, 1px 1px 3px 0px rgba(0, 0, 0, 0.12));
              box-shadow: 1px 1px 3px 0px rgba(0, 0, 0, 0.12);
    ...
    .next-switch-off[disabled] > .next-switch-children {
      color: #DDDDDD;
      color: var(--switch-disabled-off-color-font, #DDDDDD); }
...
.next-tabs {
  ...
  .next-tabs-tab {
    ...
    .next-tabs-tab.active .next-tabs-tab-close {
      color: #209BFA;
      color: var(--tab-close-icon-color-selected, #209BFA); }
    ...
    .next-tabs-pure > .next-tabs-bar .next-tabs-nav-container {
      ...
      .next-tabs-pure > .next-tabs-bar .next-tabs-nav-container .next-tabs-tab {
        ...
        .next-tabs-pure > .next-tabs-bar .next-tabs-nav-container .next-tabs-tab.active {
          z-index: 1;
          color: #209BFA;
          color: var(--tab-pure-text-color-selected, #209BFA);
          background-color: transparent; }
        ...
        .next-tabs-pure > .next-tabs-bar .next-tabs-nav-container .next-tabs-tab:before {
          ...
          border-bottom: var(--tab-pure-ink-bar-width, 2px) solid var(--tab-pure-ink-bar-color, #209BFA);
          left: 50%;
          bottom: 0%; }
  ...
  .next-tabs-wrapped > .next-tabs-bar {
    ...
    .next-tabs-wrapped > .next-tabs-bar .next-tabs-tab {
      ...
      background-color: var(--tab-wrapped-bg-color, #F9F9F9); }
      .next-tabs-wrapped > .next-tabs-bar .next-tabs-tab:hover {
        cursor: pointer;
        color: #333333;
        color: var(--tab-wrapped-text-color-hover, #333333);
        background-color: #F5F5F5;
        background-color: var(--tab-wrapped-bg-color-hover, #F5F5F5); }
      .next-tabs-wrapped > .next-tabs-bar .next-tabs-tab.active {
        z-index: 1;
        color: #209BFA;
        color: var(--tab-wrapped-text-color-selected, #209BFA);
        background-color: #FFFFFF;
  ...
  .next-tabs-wrapped.next-tabs-top > .next-tabs-bar {
    ...
    .next-tabs-wrapped.next-tabs-top > .next-tabs-bar .next-tabs-tab {
      ...
      border-radius: var(--tab-wrapped-tab-corner-radius, 3px) var(--tab-wrapped-tab-corner-radius, 3px) 0 0;
      ...
      .next-tabs-wrapped.next-tabs-top > .next-tabs-bar .next-tabs-tab:hover {
        border-color: #DDDDDD;
        border-color: var(--tab-wrapped-border-line-color-hover, #DDDDDD); }
      .next-tabs-wrapped.next-tabs-top > .next-tabs-bar .next-tabs-tab.active {
        border-color: #E6E6E6 #E6E6E6 #FFFFFF #E6E6E6;
        border-color: var(--tab-wrapped-border-line-color, #E6E6E6) var(--tab-wrapped-border-line-color, #E6E6E6) var(--tab-wrapped-bg-color-selected, #FFFFFF) var(--tab-wrapped-border-line-color, #E6E6E6); }
      .next-tabs-wrapped.next-tabs-top > .next-tabs-bar .next-tabs-tab:before {
        ...
        border-top: var(--tab-wrapped-ink-bar-width, 2px) solid var(--tab-wrapped-ink-bar-color, #209BFA);
        left: 50%;
        top: calc(0px - 1px);
  ...
  .next-tabs-wrapped.next-tabs-bottom > .next-tabs-bar {
    ...
    .next-tabs-wrapped.next-tabs-bottom > .next-tabs-bar .next-tabs-tab {
      ...
      border-radius: 0 0 var(--tab-wrapped-tab-corner-radius, 3px) var(--tab-wrapped-tab-corner-radius, 3px); }
      ...
      .next-tabs-wrapped.next-tabs-bottom > .next-tabs-bar .next-tabs-tab.active {
        border-color: #FFFFFF #E6E6E6 #E6E6E6 #E6E6E6;
        border-color: var(--tab-wrapped-bg-color-selected, #FFFFFF) var(--tab-wrapped-border-line-color, #E6E6E6) var(--tab-wrapped-border-line-color, #E6E6E6) var(--tab-wrapped-border-line-color, #E6E6E6); }
      .next-tabs-wrapped.next-tabs-bottom > .next-tabs-bar .next-tabs-tab:before {
        border-radius: 3px;
        border-radius: var(--tab-wrapped-tab-corner-radius, 3px);
        width: 0;
        border-bottom: 2px solid #209BFA;
        border-bottom: var(--tab-wrapped-ink-bar-width, 2px) solid var(--tab-wrapped-ink-bar-color, #209BFA);
        left: 50%;
        bottom: calc(0px - 1px);
  ...
  .next-tabs-wrapped.next-tabs-left > .next-tabs-bar {
    ...
    .next-tabs-wrapped.next-tabs-left > .next-tabs-bar .next-tabs-tab {
      ...
      border: var(--tab-wrapped-border-line-style, solid) var(--tab-wrapped-border-line-width, 1px) var(--tab-wrapped-border-line-color, #E6E6E6);
      border-radius: 3px 0 0 3px;
      border-radius: var(--tab-wrapped-tab-corner-radius, 3px) 0 0 var(--tab-wrapped-tab-corner-radius, 3px);
      border-width: 1px 1px 1px 1px;
      ...
      .next-tabs-wrapped.next-tabs-left > .next-tabs-bar .next-tabs-tab.active {
        border-color: #E6E6E6 #FFFFFF #E6E6E6 #E6E6E6;
        border-color: var(--tab-wrapped-border-line-color, #E6E6E6) var(--tab-wrapped-bg-color-selected, #FFFFFF) var(--tab-wrapped-border-line-color, #E6E6E6) var(--tab-wrapped-border-line-color, #E6E6E6); }
      .next-tabs-wrapped.next-tabs-left > .next-tabs-bar .next-tabs-tab:before {
        border-radius: 3px;
        border-radius: var(--tab-wrapped-tab-corner-radius, 3px);
        height: 0;
        border-left: 2px solid #209BFA;
        border-left: var(--tab-wrapped-ink-bar-width, 2px) solid var(--tab-wrapped-ink-bar-color, #209BFA);
        top: 50%;
        left: calc(0px - 1px);
  ...
  .next-tabs-wrapped.next-tabs-right > .next-tabs-bar {
    ...
    .next-tabs-wrapped.next-tabs-right > .next-tabs-bar .next-tabs-tab {
      ...
      border: var(--tab-wrapped-border-line-style, solid) var(--tab-wrapped-border-line-width, 1px) var(--tab-wrapped-border-line-color, #E6E6E6);
      border-radius: 0 3px 3px 0;
      border-radius: 0 var(--tab-wrapped-tab-corner-radius, 3px) var(--tab-wrapped-tab-corner-radius, 3px) 0;
      border-width: 1px 1px 1px 1px;
      ...
      .next-tabs-wrapped.next-tabs-right > .next-tabs-bar .next-tabs-tab.active {
        border-color: #E6E6E6 #E6E6E6 #E6E6E6 #FFFFFF;
        border-color: var(--tab-wrapped-border-line-color, #E6E6E6) var(--tab-wrapped-border-line-color, #E6E6E6) var(--tab-wrapped-border-line-color, #E6E6E6) var(--tab-wrapped-bg-color-selected, #FFFFFF); }
      .next-tabs-wrapped.next-tabs-right > .next-tabs-bar .next-tabs-tab:before {
        border-radius: 3px;
        border-radius: var(--tab-wrapped-tab-corner-radius, 3px);
        height: 0;
        border-right: 2px solid #209BFA;
        border-right: var(--tab-wrapped-ink-bar-width, 2px) solid var(--tab-wrapped-ink-bar-color, #209BFA);
        top: 50%;
        right: calc(0px - 1px);
  ...
  .next-tabs-capsule > .next-tabs-bar .next-tabs-tab {
    ...
    border: var(--tab-capsule-tab-border-line-width, 1px) var(--tab-capsule-tab-border-line-style, solid) var(--tab-capsule-tab-border-line-color, #DDDDDD);
    border-right-color: transparent;
    ...
    background-color: #F9F9F9;
    background-color: var(--tab-capsule-bg-color, #F9F9F9); }
    ...
    .next-tabs-capsule > .next-tabs-bar .next-tabs-tab:last-child {
      ...
      border-right: 1px solid #DDDDDD;
      border-right: var(--tab-capsule-tab-border-line-width, 1px) var(--tab-capsule-tab-border-line-style, solid) var(--tab-capsule-tab-border-line-color, #DDDDDD); }
    .next-tabs-capsule > .next-tabs-bar .next-tabs-tab.active {
      border-right: 1px solid #DDDDDD;
      border-right: var(--tab-capsule-tab-border-line-width, 1px) var(--tab-capsule-tab-border-line-style, solid) var(--tab-capsule-tab-border-line-color, #DDDDDD);
      border-color: #209BFA;
      border-color: var(--tab-capsule-tab-border-line-color-active, #209BFA); }
    .next-tabs-capsule > .next-tabs-bar .next-tabs-tab.disabled {
      border-color: #EEEEEE;
      border-color: var(--tab-capsule-tab-border-line-color-disabled, #EEEEEE); }
    .next-tabs-capsule > .next-tabs-bar .next-tabs-tab:hover {
      z-index: 2;
      border-right: 1px solid #DDDDDD;
      border-right: var(--tab-capsule-tab-border-line-width, 1px) var(--tab-capsule-tab-border-line-style, solid) var(--tab-capsule-tab-border-line-color, #DDDDDD);
      border-color: #DDDDDD;
      border-color: var(--tab-capsule-tab-border-line-color-hover, #DDDDDD); }
    .next-tabs-capsule > .next-tabs-bar .next-tabs-tab:hover {
      cursor: pointer;
      color: #333333;
      color: var(--tab-capsule-text-color-hover, #333333);
      background-color: #F5F5F5;
      background-color: var(--tab-capsule-bg-color-hover, #F5F5F5); }
    .next-tabs-capsule > .next-tabs-bar .next-tabs-tab.active {
      z-index: 1;
      color: #FFFFFF;
      color: var(--tab-capsule-text-color-selected, #FFFFFF);
      background-color: #209BFA;
      background-color: var(--tab-capsule-bg-color-selected, #209BFA); }
    .next-tabs-capsule > .next-tabs-bar .next-tabs-tab.disabled {
      pointer-events: none;
      cursor: default;
      color: #CCCCCC;
  ...
  .next-tabs-text > .next-tabs-bar .next-tabs-tab {
    ...
    .next-tabs-text > .next-tabs-bar .next-tabs-tab.active {
      z-index: 1;
      color: #209BFA;
      color: var(--tab-text-text-color-selected, #209BFA);
      background-color: transparent; }
...
.next-tabs[dir='rtl'].next-tabs-capsule > .next-tabs-bar .next-tabs-tab {
  ...
  border-top: var(--tab-capsule-tab-border-line-width, 1px) var(--tab-capsule-tab-border-line-style, solid) var(--tab-capsule-tab-border-line-color, #DDDDDD);
  border-bottom: 1px solid #DDDDDD;
  border-bottom: var(--tab-capsule-tab-border-line-width, 1px) var(--tab-capsule-tab-border-line-style, solid) var(--tab-capsule-tab-border-line-color, #DDDDDD);
  border-right: 1px solid #DDDDDD;
  border-right: var(--tab-capsule-tab-border-line-width, 1px) var(--tab-capsule-tab-border-line-style, solid) var(--tab-capsule-tab-border-line-color, #DDDDDD);
  border-left: 0; }
  ...
  .next-tabs[dir='rtl'].next-tabs-capsule > .next-tabs-bar .next-tabs-tab:last-child {
    ...
    border-radius: var(--tab-capsule-corner-radius, 3px) 0 0 var(--tab-capsule-corner-radius, 3px);
    border-left: 1px solid #DDDDDD;
    border-left: var(--tab-capsule-tab-border-line-width, 1px) var(--tab-capsule-tab-border-line-style, solid) var(--tab-capsule-tab-border-line-color, #DDDDDD); }
...
.next-tag-checkable.next-tag-level-secondary {
  ...
  .next-tag-checkable.next-tag-level-secondary:not(.disabled):not([disabled]):hover, .next-tag-checkable.next-tag-level-secondary:not(.disabled):not([disabled]).hover {
    color: #209BFA;
    color: var(--tag-normal-text-color-hover, #209BFA); }

.next-tag-default.next-tag-level-primary {
  color: #666666;
  color: var(--tag-fill-text-color, #666666);
  border-color: #F5F5F5;
  border-color: var(--tag-fill-border-color, #F5F5F5);
  background-color: #F5F5F5;
  background-color: var(--tag-fill-bg-color, #F5F5F5); }
  .next-tag-default.next-tag-level-primary:not(.disabled):not([disabled]):hover, .next-tag-default.next-tag-level-primary:not(.disabled):not([disabled]).hover {
    ...
    border-color: #F2F2F2;
    border-color: var(--tag-fill-border-color-hover, #F2F2F2);
    background-color: #F2F2F2;
    background-color: var(--tag-fill-bg-color-hover, #F2F2F2); }
...
.next-tag-closable.next-tag-level-primary {
  ...
  border-color: #F5F5F5;
  border-color: var(--tag-closable-primary-fill-border-color, #F5F5F5);
  background-color: #F5F5F5;
  background-color: var(--tag-closable-primary-fill-bg-color, #F5F5F5); }
  .next-tag-closable.next-tag-level-primary:not(.disabled):not([disabled]):hover, .next-tag-closable.next-tag-level-primary:not(.disabled):not([disabled]).hover {
    ...
    border-color: #F2F2F2;
    border-color: var(--tag-closable-primary-fill-border-color-hover, #F2F2F2);
    background-color: #F2F2F2;
    background-color: var(--tag-closable-primary-fill-bg-color-hover, #F2F2F2); }
...
.next-tag-checkable.next-tag-level-primary {
  ...
  border-color: #F5F5F5;
  border-color: var(--tag-checkable-fill-border-color, #F5F5F5);
  background-color: #F5F5F5;
  background-color: var(--tag-checkable-fill-bg-color, #F5F5F5); }
  .next-tag-checkable.next-tag-level-primary:not(.disabled):not([disabled]):hover, .next-tag-checkable.next-tag-level-primary:not(.disabled):not([disabled]).hover {
    ...
    border-color: #F2F2F2;
    border-color: var(--tag-checkable-fill-border-color-hover, #F2F2F2);
    background-color: #F2F2F2;
    background-color: var(--tag-checkable-fill-bg-color-hover, #F2F2F2); }
...
.next-tag-checkable.next-tag-level-primary.checked {
  ...
  border-color: #209BFA;
  border-color: var(--tag-checkable-primary-border-color, #209BFA);
  background-color: #209BFA;
  background-color: var(--tag-checkable-primary-bg-color, #209BFA); }
  .next-tag-checkable.next-tag-level-primary.checked:not(.disabled):not([disabled]):hover, .next-tag-checkable.next-tag-level-primary.checked:not(.disabled):not([disabled]).hover {
    ...
    border-color: #1274E7;
    border-color: var(--tag-checkable-primary-border-color-hover, #1274E7);
    background-color: #1274E7;
    background-color: var(--tag-checkable-primary-bg-color-hover, #1274E7); }
  ...
  .next-tag-checkable.next-tag-level-primary.checked[disabled], .disabled.next-tag-checkable.next-tag-level-primary.checked {
    ...
    border-color: #FAFAFA;
    border-color: var(--tag-checkable-primary-border-color-disabled, #FAFAFA);
    background-color: #FAFAFA;
    background-color: var(--tag-checkable-primary-bg-color-disabled, #FAFAFA); }
...
.next-tag-default.next-tag-level-normal {
  ...
  border-color: #DDDDDD;
  border-color: var(--tag-bordered-border-color, #DDDDDD);
  background-color: transparent;
  ...
  .next-tag-default.next-tag-level-normal:not(.disabled):not([disabled]):hover, .next-tag-default.next-tag-level-normal:not(.disabled):not([disabled]).hover {
    ...
    border-color: #CCCCCC;
    border-color: var(--tag-bordered-border-color-hover, #CCCCCC);
    background-color: transparent;
  ...
  .next-tag-default.next-tag-level-normal[disabled], .disabled.next-tag-default.next-tag-level-normal {
    ...
    border-color: #EEEEEE;
    border-color: var(--tag-bordered-border-color-disabled, #EEEEEE);
    background-color: #FAFAFA;
...
.next-tag-closable.next-tag-level-normal {
  ...
  border-color: #DDDDDD;
  border-color: var(--tag-closable-bordered-border-color, #DDDDDD);
  background-color: transparent;
  ...
  .next-tag-closable.next-tag-level-normal:not(.disabled):not([disabled]):hover, .next-tag-closable.next-tag-level-normal:not(.disabled):not([disabled]).hover {
    ...
    border-color: #CCCCCC;
    border-color: var(--tag-closable-bordered-border-color-hover, #CCCCCC);
    background-color: transparent;
  ...
  .next-tag-closable.next-tag-level-normal[disabled], .disabled.next-tag-closable.next-tag-level-normal {
    ...
    border-color: #EEEEEE;
    border-color: var(--tag-closable-bordered-border-color-disabled, #EEEEEE);
    background-color: transparent;
...
.next-tag-checkable.next-tag-level-normal.checked {
  color: #209BFA;
  color: var(--tag-secondary-text-color, #209BFA);
  border-color: #209BFA;
  border-color: var(--tag-secondary-border-color, #209BFA);
  background-color: transparent;
  ...
  .next-tag-checkable.next-tag-level-normal.checked:not(.disabled):not([disabled]):hover, .next-tag-checkable.next-tag-level-normal.checked:not(.disabled):not([disabled]).hover {
    color: #1274E7;
    color: var(--tag-secondary-text-color-hover, #1274E7);
    border-color: #1274E7;
    border-color: var(--tag-secondary-border-color-hover, #1274E7);
    background-color: transparent;
...
.next-tag-checkable.next-tag-level-secondary.checked:before {
  ...
  background-color: #209BFA;
  background-color: var(--tag-checkable-secondary-bg-selected, #209BFA);
  -webkit-transform: rotate(45deg);
      -ms-transform: rotate(45deg);
          transform: rotate(45deg); }
...
.next-tag-checkable.next-tag-level-secondary.checked:not(.disabled):not([disabled]):hover:before, .next-tag-checkable.next-tag-level-secondary.checked:not(.disabled):not([disabled]).hover:before {
  background-color: #1274E7;
  background-color: var(--tag-checkable-secondary-bg-selected-hover, #1274E7); }
...
.next-tag-checkable.next-tag-level-secondary.checked[disabled]:before, .next-tag-checkable.next-tag-level-secondary.checked:disabled:before {
  ...
  background-color: var(--tag-checkable-secondary-bg-selected-disabled, #EEEEEE); }
...
.next-tag-checkable.next-tag-level-normal {
  ...
  border-color: #DDDDDD;
  border-color: var(--tag-checkable-normal-border-color, #DDDDDD);
  background-color: transparent;
  ...
  .next-tag-checkable.next-tag-level-normal:not(.disabled):not([disabled]):hover, .next-tag-checkable.next-tag-level-normal:not(.disabled):not([disabled]).hover {
    ...
    border-color: #DDDDDD;
    border-color: var(--tag-checkable-normal-border-color-hover, #DDDDDD);
    background-color: transparent;
  ...
  .next-tag-checkable.next-tag-level-normal[disabled], .disabled.next-tag-checkable.next-tag-level-normal {
    ...
    border-color: #EEEEEE;
    border-color: var(--tag-checkable-normal-border-selected-disabled, #EEEEEE);
    background-color: #FAFAFA;
...
.next-tag-checkable.next-tag-level-normal.checked:before {
  ...
  -webkit-font-smoothing: antialiased;
  background-color: #209BFA;
  background-color: var(--tag-checkable-normal-bg-selected, #209BFA);
  -webkit-transform: rotate(45deg);
      -ms-transform: rotate(45deg);
          transform: rotate(45deg); }
...
.next-tag-checkable.next-tag-level-normal.checked:not(.disabled):not([disabled]):hover:before, .next-tag-checkable.next-tag-level-normal.checked:not(.disabled):not([disabled]).hover:before {
  background-color: #1274E7;
  background-color: var(--tag-checkable-normal-bg-selected-hover, #1274E7); }
...
.next-tag-checkable.next-tag-level-normal.checked[disabled]:before, .next-tag-checkable.next-tag-level-normal.checked:disabled:before {
  background-color: #EEEEEE;
  background-color: var(--tag-checkable-normal-tick-bg-selected-disabled, #EEEEEE); }
...
.next-tag-closable.next-tag-level-normal:before {
  ...
  background-color: var(--tag-closable-normal-bg, #DDDDDD);
  -webkit-transform: rotate(45deg);
      -ms-transform: rotate(45deg);
          transform: rotate(45deg); }
...
.next-tag-closable.next-tag-level-normal:not(.disabled):not([disabled]):hover:before, .next-tag-closable.next-tag-level-normal:not(.disabled):not([disabled]).hover:before {
  ...
  background-color: var(--tag-closable-normal-bg-hover, #CCCCCC); }
...
.next-tag-closable.next-tag-level-normal[disabled]:before, .next-tag-closable.next-tag-level-normal:disabled:before {
  background-color: #EEEEEE;
  background-color: var(--tag-closable-normal-bg-disabled, #EEEEEE); }
...
.next- {
  ...
  .next-tag-large {
    ...
    .next-tag-large.next-tag-closable > .next-tag-body {
      ...
      max-width: calc(100% - var(--tag-size-l-spacing, 16px) - var(--tag-size-l-icon-font, 16px) - var(--tag-size-l-padding-lr, 16px)); }
  ...
  .next-tag-medium {
    height: 32px;
    height: var(--tag-size-m-height, 32px);
    padding: 0;
    line-height: calc(32px - 1px*2);
    line-height: calc(var(--tag-size-m-height, 32px) - var(--tag-border-width, 1px)*2);
    font-size: 0; }
    ...
    .next-tag-medium.next-tag-closable > .next-tag-body {
      ...
      max-width: calc(100% - 12px - 12px - 12px);
      max-width: calc(100% - var(--tag-size-m-spacing, 12px) - var(--tag-size-m-icon-font, 12px) - var(--tag-size-m-padding-lr, 12px)); }
      ...
      @media all and (-webkit-min-device-pixel-ratio: 0) and (min-resolution: 0.001dpcm) {
        .next-tag-small.next-tag-closable > .next-tag-close-btn .next-icon {
          -webkit-transform: scale(0.5);
              -ms-transform: scale(0.5);
                  transform: scale(0.5);
          margin-left: calc(-8px + 8px/2);
          margin-left: calc(-8px + var(--tag-size-s-icon-font, 8px)/2);
          margin-right: calc(-8px + 8px/2);
          margin-right: calc(-8px + var(--tag-size-s-icon-font, 8px)/2); }
          .next-tag-small.next-tag-closable > .next-tag-close-btn .next-icon:before {
            width: 16px;
            font-size: 16px; } }
  ...
  .next-tag-checkable {
    ...
    .next-tag-checkable.next-tag-level-secondary[disabled], .next-tag-checkable.next-tag-level-secondary.disabled {
      ...
      border-color: #EEEEEE;
      border-color: var(--tag-border-color-disabled, #EEEEEE);
      background-color: #FAFAFA;
      background-color: var(--tag-fill-bg-color-disabled, #FAFAFA); }
...
.next-timeline[dir='rtl'] .next-timeline-item-done {
  ...
  .next-timeline[dir='rtl'] .next-timeline-item-done.next-timeline-item-has-left-content > .next-timeline-item-content {
    margin-right: calc(80px + 12px + 16px);
  ...
  .next-timeline[dir='rtl'] .next-timeline-item-done .next-timeline-item-dot {
    background: #DDDDDD;
    background: var(--timeline-item-done-background, #DDDDDD); }
...
.next-timeline[dir='rtl'] .next-timeline-item-process {
  ...
  .next-timeline[dir='rtl'] .next-timeline-item-process .next-timeline-item-dot {
    background: #209BFA;
    background: var(--timeline-item-process-background, #209BFA); }
...
.next-timeline[dir='rtl'] .next-timeline-item-success {
  ...
  .next-timeline[dir='rtl'] .next-timeline-item-success .next-timeline-item-dot {
    background: #1AD78C;
    background: var(--timeline-item-success-background, #1AD78C); }
...
.next-timeline[dir='rtl'] .next-timeline-item-error {
  ...
  .next-timeline[dir='rtl'] .next-timeline-item-error .next-timeline-item-dot {
    background: #D23C26;
    background: var(--timeline-item-error-background, #D23C26); }
...
.next-timeline-item-done {
  ...
  .next-timeline-item-done.next-timeline-item-has-left-content > .next-timeline-item-content {
    margin-left: calc(80px + 12px + 16px);
...
.next-timeline[dir='rtl'].next-alternate .next-timeline-item-left .next-timeline-item-content, .next-timeline[dir='rtl'].next-alternate .next-timeline-item-right .next-timeline-item-content {
  width: 50%;
  margin-right: calc(50% + 12px + 16px);
...
.next-transfer {
  ...
  .next-transfer-panel-item:not(.next-disabled).next-simple:hover {
    color: #209BFA;
    color: var(--transfer-simple-panel-item-hover-text-color, #209BFA); }
  .next-transfer-panel-item.next-insert-before:before {
    ...
    content: '';
    width: 100%;
    border-top: 1px solid #209BFA;
    border-top: var(--line-1, 1px) solid var(--color-brand1-6, #209BFA); }
  .next-transfer-panel-item.next-insert-after:after {
    ...
    border-bottom: var(--line-1, 1px) solid var(--color-brand1-6, #209BFA); }
  ...
  .next-transfer-panel-move-all {
    ...
    font-size: var(--font-size-body-1, 14px);
    color: #209BFA;
    color: var(--transfer-simple-panel-footer-text-color, #209BFA);
    cursor: pointer; }
  ...
  .next-transfer-move.next-icon {
    color: #DDDDDD;
    color: var(--transfer-simple-move-icon-color, #DDDDDD); }
...
.next-tree {
  ...
  .next-tree-node-indent-unit {
    ...
    .next-tree-node-indent-unit.next-line::before {
      ...
      display: inline-block;
      border-left: 1px solid #DDDDDD;
      border-left: var(--tree-line-width, 1px) var(--tree-line-style, solid) var(--tree-line-color, #DDDDDD);
      height: calc(4px + 2px*2 + 20px);
      height: calc(var(--tree-node-padding, 4px) + var(--line-2, 2px)*2 + 20px);
      left: calc(16px/2 - 1px/2);
  ...
  .next-tree-switcher.next-noline {
    width: 20px;
    width: var(--tree-switch-arrow-size, 20px);
    height: 20px;
    height: var(--tree-switch-arrow-size, 20px);
    line-height: 20px;
    line-height: var(--tree-switch-arrow-size, 20px);
    cursor: pointer; }
    .next-tree-switcher.next-noline .next-tree-switcher-icon {
      ...
      .next-tree-switcher.next-noline .next-tree-switcher-icon .next-icon-remote {
        ...
        width: var(--tree-switch-arrow-size, 20px);
        font-size: 20px;
        font-size: var(--tree-switch-arrow-size, 20px);
        line-height: inherit; }
  ...
  .next-tree-switcher.next-line {
    ...
    border: 1px solid #DDDDDD;
    border: var(--tree-switch-border-width, 1px) var(--line-solid, solid) var(--tree-switch-border-color, #DDDDDD);
    border-radius: 3px;
    ...
    .next-tree-switcher.next-line .next-tree-switcher-icon {
      margin-left: calc(16px/2 - 4px - 1px*2/2);
      ...
      @media all and (-webkit-min-device-pixel-ratio: 0) and (min-resolution: 0.001dpcm) {
        .next-tree-switcher.next-line .next-tree-switcher-icon {
          -webkit-transform: scale(0.5);
              -ms-transform: scale(0.5);
                  transform: scale(0.5);
          margin-left: calc(16px/2 - 8px - 1px*2/2);
          margin-left: calc(var(--tree-switch-size, 16px)/2 - 8px - var(--tree-switch-border-width, 1px)*2/2);
          margin-right: -4px; }
          .next-tree-switcher.next-line .next-tree-switcher-icon:before {
            width: 16px;
            font-size: 16px; } }
    ...
    .next-tree-switcher.next-line:not(.next-disabled):hover {
      border-color: #CCCCCC;
      border-color: var(--tree-switch-hover-border-color, #CCCCCC);
      background-color: #F9F9F9;
      background-color: var(--tree-switch-hover-bg-color, #F9F9F9); }
    ...
    .next-tree-switcher.next-line.next-disabled {
      border-color: #EEEEEE;
      border-color: var(--color-line1-1, #EEEEEE);
      background-color: #FFFFFF;
      cursor: not-allowed; }
  ...
  .next-tree-switcher.next-noop-line-noroot {
    height: 0;
    border-left: 1px solid #DDDDDD;
    border-left: var(--tree-switch-border-width, 1px) var(--line-solid, solid) var(--tree-line-color, #DDDDDD);
    border-bottom: 1px solid #DDDDDD;
    border-bottom: var(--tree-line-width, 1px) var(--tree-line-style, solid) var(--tree-line-color, #DDDDDD); }
  ...
  .next-tree.next-node-indent .next-tree-node-inner {
    ...
    .next-tree.next-node-indent .next-tree-node-inner:focus .next-tree-node-label {
      ...
      background-color: #F9F9F9;
      background-color: var(--tree-node-hover-bg-color, #F9F9F9); }
  ...
  .next-tree.next-node-indent .next-tree-node-inner.next-selected .next-tree-node-label {
    ...
    background-color: var(--tree-node-selected-background, #ADD9FF); }
...
.next-tree-select {
  ...
  .next-tree-select-dropdown {
    ...
    border: 1px solid #E6E6E6;
    border: var(--popup-local-border-width, 1px) var(--popup-local-border-style, solid) var(--popup-local-border-color, #E6E6E6);
    border-radius: 3px;
...
.next-upload {
  ...
  .next-upload.next-disabled {
    ...
    border-color: var(--color-line1-1, #EEEEEE) !important;
...
.next-upload-list-text .next-upload-list-item {
  background-color: #F9F9F9;
  background-color: var(--upload-text-list-bg-color, #F9F9F9);
  padding: 4px 8px;
  padding: 4px var(--upload-text-list-padding-left-right, 8px);
  ...
  .next-upload-list-text .next-upload-list-item:hover {
    background-color: #F9F9F9;
    background-color: var(--upload-text-list-bg-color-hover, #F9F9F9); }
  ...
  .next-upload-list-text .next-upload-list-item-done:hover .next-upload-list-item-name {
    color: #209BFA;
    color: var(--upload-text-list-name-font-color-hover, #209BFA); }
  .next-upload-list-text .next-upload-list-item-done:hover .next-upload-list-item-size {
    color: #209BFA;
    color: var(--upload-text-list-size-font-color-hover, #209BFA); }
  .next-upload-list-text .next-upload-list-item-error {
    ...
    .next-upload-list-text .next-upload-list-item-error-msg {
      ...
      overflow: hidden;
      color: #D23C26;
      color: var(--upload-text-list-error-text-color, #D23C26); }
...
.next-upload-list-image .next-upload-list-item {
  ...
  .next-upload-list-image .next-upload-list-item:hover {
    border-color: #209BFA;
    border-color: var(--upload-image-list-item-border-color-hover, #209BFA); }
  ...
  .next-upload-list-image .next-upload-list-item-thumbnail {
    ...
    background-color: #F9F9F9;
    background-color: var(--upload-image-list-item-picture-background-color, #F9F9F9);
    margin-right: 8px;
    vertical-align: middle;
    text-align: center;
    overflow: hidden;
  ...
  .next-upload-list-image .next-upload-list-item-error {
    border-color: #D23C26 !important;
    border-color: var(--upload-image-list-item-border-color-error, #D23C26) !important;
    background-color: #FFFFFF;
...
.next-upload-list-card {
  ...
  .next-upload-list-card .next-upload-list-item {
    ...
    .next-upload-list-card .next-upload-list-item-wrapper {
      position: relative;
      border: 1px solid #DDDDDD;
      border: 1px solid var(--upload-card-list-border-color, #DDDDDD);
      width: 100px;
    ...
    .next-upload-list-card .next-upload-list-item-error .next-upload-list-item-wrapper {
      border-color: #D23C26;
      border-color: var(--upload-card-list-border-color-error, #D23C26); }
...
.next-upload-card {
  ...
  border: 1px var(--upload-card-border-style, dashed) var(--upload-card-border-color, #DDDDDD);
  width: 100px;
  width: var(--upload-card-size, 100px);
  height: 100px;
  height: var(--upload-card-size, 100px);
  ...
  .next-upload-card .next-icon {
    color: #DDDDDD;
    color: var(--upload-card-icon-color, #DDDDDD); }
  ...
  .next-upload-card:hover {
    border-color: #209BFA;
    border-color: var(--upload-card-hover-border-color, #209BFA); }
    .next-upload-card:hover .next-icon {
      color: #209BFA;
      color: var(--upload-card-hover-font-color, #209BFA); }
...
.next-upload-dragable .next-upload-drag {
  border: 1px dashed #DDDDDD;
  border: 1px dashed var(--upload-drag-zone-border-color, #DDDDDD);
  -webkit-transition: border-color 100ms linear;
  transition: border-color 100ms linear;
  cursor: pointer;
  border-radius: 3px;
  ...
  .next-upload-dragable .next-upload-drag-over {
    border-color: #209BFA;
    border-color: var(--upload-drag-zone-over-border-color, #209BFA); }
...
.next-shell {
  ...
  .next-shell-light .next-shell-aside .local-nav-trigger {
    background: #F2F2F2;
    background: var(--shell-light-local-navigation-background, #F2F2F2); }
  ...
  .next-shell-light .next-shell-header {
    ...
    border-bottom: var(--shell-light-header-divider-size, 1px) var(--shell-light-header-divider-style, solid) var(--shell-light-header-divider-color, #EEEEEE);
    -webkit-box-shadow: none;
  ...
  .next-shell-light .next-shell-task-header {
    ...
    border-bottom: 1px solid #EEEEEE;
    border-bottom: var(--shell-light-multitask-divider-size, 1px) var(--shell-light-multitask-divider-style, solid) var(--shell-light-multitask-divider-color, #EEEEEE);
    -webkit-box-shadow: none;
  ...
  .next-shell-light .next-shell-main {
    background: #F5F5F5;
    background: var(--shell-light-content-background, #F5F5F5); }
    .next-shell-light .next-shell-main .next-shell-appbar {
      ...
      border-bottom: 1px solid #EEEEEE;
      border-bottom: var(--shell-light-appbar-divider-size, 1px) var(--shell-light-appbar-divider-style, solid) var(--shell-light-appbar-divider-color, #EEEEEE);
      -webkit-box-shadow: none;
  ...
  .next-shell-light .next-shell-aside.next-shell-navigation {
    ...
    border-right: 1px solid #EEEEEE;
    border-right: var(--shell-light-navigation-ver-divider-size, 1px) var(--shell-light-navigation-ver-divider-style, solid) var(--shell-light-navigation-ver-divider-color, #EEEEEE);
    -webkit-box-shadow: none;
  ...
  .next-shell-light .next-shell-aside.next-shell-tooldock {
    ...
    background: #F2F2F2;
    background: var(--shell-light-tooldock-background, #F2F2F2);
    border-left: 1px solid #EEEEEE;
    border-left: var(--shell-light-tooldock-divider-size, 1px) var(--shell-light-tooldock-divider-style, solid) var(--shell-light-tooldock-divider-color, #EEEEEE);
    -webkit-box-shadow: none;
  ...
  .next-shell-light .next-shell-aside .next-shell-tooldockitem {
    ...
    .next-shell-light .next-shell-aside .next-shell-tooldockitem:hover {
      ...
      background: #F5F5F5;
      background: var(--shell-light-tooldock-item-background-hover, #F5F5F5); }
  .next-shell-light .next-shell-aside .next-shell-localnavigation {
    ...
    background: var(--shell-light-local-navigation-background, #F2F2F2);
    border-right: 1px solid #EEEEEE;
    border-right: var(--shell-light-local-navigation-divider-size, 1px) var(--shell-light-local-navigation-divider-style, solid) var(--shell-light-local-navigation-divider-color, #EEEEEE);
    -webkit-box-shadow: none;
  ...
  .next-shell-light .next-shell-aside .next-shell-ancillary {
    ...
    background: var(--shell-light-ancillary-background, #FFFFFF);
    border-left: 1px solid #EEEEEE;
    border-left: var(--shell-light-ancillary-divider-size, 1px) var(--shell-light-ancillary-divider-style, solid) var(--shell-light-ancillary-divider-color, #EEEEEE);
    -webkit-box-shadow: none;
  ...
  .next-shell-dark .next-shell-header .nav-trigger {
    background: #222222;
    background: var(--shell-dark-header-background, #222222); }
  .next-shell-dark .next-shell-aside .local-nav-trigger {
    background: #F2F2F2;
    background: var(--shell-dark-local-navigation-background, #F2F2F2); }
  ...
  .next-shell-dark .next-shell-header {
    ...
    -webkit-box-shadow: var(--shell-dark-header-shadow, 0px 1px 3px 0px rgba(0, 0, 0, 0.12));
  ...
  .next-shell-dark .next-shell-task-header {
    ...
    border-bottom: 1px solid #EEEEEE;
    border-bottom: var(--shell-dark-multitask-divider-size, 1px) var(--shell-dark-multitask-divider-style, solid) var(--shell-dark-multitask-divider-color, #EEEEEE);
    -webkit-box-shadow: none;
  ...
  .next-shell-dark .next-shell-main {
    background: #F5F5F5;
    background: var(--shell-dark-content-background, #F5F5F5); }
    .next-shell-dark .next-shell-main .next-shell-appbar {
      ...
      border-bottom: 1px solid #EEEEEE;
      border-bottom: var(--shell-dark-appbar-divider-size, 1px) var(--shell-dark-appbar-divider-style, solid) var(--shell-dark-appbar-divider-color, #EEEEEE);
      -webkit-box-shadow: none;
  ...
  .next-shell-dark .next-shell-aside.next-shell-navigation {
    width: 200px;
    width: var(--shell-dark-navigation-ver-width, 200px);
    background: #222222;
    background: var(--shell-dark-navigation-ver-background, #222222);
    border-right: 1px solid #EEEEEE;
    border-right: var(--shell-dark-navigation-ver-divider-size, 1px) var(--shell-dark-navigation-ver-divider-style, solid) var(--shell-dark-navigation-ver-divider-color, #EEEEEE);
    -webkit-box-shadow: none;
  ...
  .next-shell-dark .next-shell-aside.next-shell-tooldock {
    ...
    background: #F2F2F2;
    background: var(--shell-dark-tooldock-background, #F2F2F2);
    border-left: 1px solid #EEEEEE;
    border-left: var(--shell-dark-tooldock-divider-size, 1px) var(--shell-dark-tooldock-divider-style, solid) var(--shell-dark-tooldock-divider-color, #EEEEEE);
    -webkit-box-shadow: none;
  ...
  .next-shell-dark .next-shell-aside .next-shell-tooldockitem {
    ...
    .next-shell-dark .next-shell-aside .next-shell-tooldockitem:hover {
      ...
      background: #F5F5F5;
      background: var(--shell-dark-tooldock-item-background-hover, #F5F5F5); }
  .next-shell-dark .next-shell-aside .next-shell-localnavigation {
    ...
    background: var(--shell-dark-local-navigation-background, #F2F2F2);
    border-right: 1px solid #EEEEEE;
    border-right: var(--shell-dark-local-navigation-divider-size, 1px) var(--shell-dark-local-navigation-divider-style, solid) var(--shell-dark-local-navigation-divider-color, #EEEEEE);
    -webkit-box-shadow: none;
  ...
  .next-shell-dark .next-shell-aside .next-shell-ancillary {
    ...
    background: var(--shell-dark-ancillary-background, #FFFFFF);
    border-left: 1px solid #EEEEEE;
    border-left: var(--shell-dark-ancillary-divider-size, 1px) var(--shell-dark-ancillary-divider-style, solid) var(--shell-dark-ancillary-divider-color, #EEEEEE);
    -webkit-box-shadow: none;
  ...
  .next-shell-brand .next-shell-header .nav-trigger {
    background: #18263C;
    background: var(--shell-brand-header-background, #18263C); }
  .next-shell-brand .next-shell-aside .local-nav-trigger {
    background: #F2F2F2;
    background: var(--shell-brand-local-navigation-background, #F2F2F2); }
  ...
  .next-shell-brand .next-shell-header {
    ...
    background: var(--shell-brand-header-background, #18263C);
    border-bottom: 1px solid #EEEEEE;
    border-bottom: var(--shell-brand-header-divider-size, 1px) var(--shell-brand-header-divider-style, solid) var(--shell-brand-header-divider-color, #EEEEEE);
    -webkit-box-shadow: 0px 1px 3px 0px rgba(0, 0, 0, 0.12);
    -webkit-box-shadow: var(--shell-brand-header-shadow, 0px 1px 3px 0px rgba(0, 0, 0, 0.12));
            box-shadow: 0px 1px 3px 0px rgba(0, 0, 0, 0.12);
  ...
  .next-shell-brand .next-shell-task-header {
    ...
    border-bottom: 1px solid #EEEEEE;
    border-bottom: var(--shell-brand-multitask-divider-size, 1px) var(--shell-brand-multitask-divider-style, solid) var(--shell-brand-multitask-divider-color, #EEEEEE);
    -webkit-box-shadow: none;
  ...
  .next-shell-brand .next-shell-main {
    background: #F5F5F5;
    background: var(--shell-brand-content-background, #F5F5F5); }
    .next-shell-brand .next-shell-main .next-shell-appbar {
      ...
      border-bottom: 1px solid #EEEEEE;
      border-bottom: var(--shell-brand-appbar-divider-size, 1px) var(--shell-brand-appbar-divider-style, solid) var(--shell-brand-appbar-divider-color, #EEEEEE);
      -webkit-box-shadow: none;
  ...
  .next-shell-brand .next-shell-aside.next-shell-navigation {
    width: 200px;
    width: var(--shell-brand-navigation-ver-width, 200px);
    background: #FFFFFF;
    background: var(--shell-brand-navigation-ver-background, #FFFFFF);
    border-right: 1px solid #EEEEEE;
    border-right: var(--shell-brand-navigation-ver-divider-size, 1px) var(--shell-brand-navigation-ver-divider-style, solid) var(--shell-brand-navigation-ver-divider-color, #EEEEEE);
    -webkit-box-shadow: none;
  ...
  .next-shell-brand .next-shell-aside.next-shell-tooldock {
    ...
    background: #F2F2F2;
    background: var(--shell-brand-tooldock-background, #F2F2F2);
    border-left: 1px solid #EEEEEE;
    border-left: var(--shell-brand-tooldock-divider-size, 1px) var(--shell-brand-tooldock-divider-style, solid) var(--shell-brand-tooldock-divider-color, #EEEEEE);
    -webkit-box-shadow: none;
  ...
  .next-shell-brand .next-shell-aside .next-shell-tooldockitem {
    ...
    .next-shell-brand .next-shell-aside .next-shell-tooldockitem:hover {
      ...
      background: #F5F5F5;
      background: var(--shell-brand-tooldock-item-background-hover, #F5F5F5); }
  .next-shell-brand .next-shell-aside .next-shell-localnavigation {
    ...
    background: var(--shell-brand-local-navigation-background, #F2F2F2);
    border-right: 1px solid #EEEEEE;
    border-right: var(--shell-brand-local-navigation-divider-size, 1px) var(--shell-brand-local-navigation-divider-style, solid) var(--shell-brand-local-navigation-divider-color, #EEEEEE);
    -webkit-box-shadow: none;
  ...
  .next-shell-brand .next-shell-aside .next-shell-ancillary {
    ...
    background: var(--shell-brand-ancillary-background, #FFFFFF);
    border-left: 1px solid #EEEEEE;
    border-left: var(--shell-brand-ancillary-divider-size, 1px) var(--shell-brand-ancillary-divider-style, solid) var(--shell-brand-ancillary-divider-color, #EEEEEE);
    -webkit-box-shadow: none;
...
.next-typography {
  ...
  .next-typography mark {
    padding: 0;
    background: #FFE98F;
    background: var(--typography-text-mark-background, #FFE98F);
    color: #333333;
  ...
  .next-typography code {
    background-color: #F9F9F9;
    background-color: var(--typography-text-code-background, #F9F9F9);
    color: #333333;
    color: var(--typography-text-code-color, #333333);
    border: 1px solid #EEEEEE;
    border: 1px solid var(--typography-text-code-border-color, #EEEEEE);
    margin: 0 .2em;
    padding: .2em .4em .1em;
    font-size: 85%;
    border-radius: 3px;
  ...
  .next-typography a {
    ...
    .next-typography a:visited {
      color: #4A83C5;
      color: var(--color-link-2, #4A83C5); }
    .next-typography a:hover {
      color: #2580E7;
      color: var(--color-link-3, #2580E7); }
...
.next-table {
  ...
  .next-table-header-resizable {
    ...
    .next-table-header-resizable .next-table-resize-handler {
      ...
      .next-table-header-resizable .next-table-resize-handler:hover::after {
        z-index: 1;
        background: #209BFA;
        background: var(--color-brand1-6, #209BFA); }
  ...
  .next-table.zebra .next-table-row.selected td {
    background: #F9F9F9;
    background: var(--table-row-selected-bg, #F9F9F9);
    color: #333333;
    color: var(--table-row-selected-color, #333333); }
  .next-table-empty {
    color: #CCCCCC;
    color: var(--table-empty-color, #CCCCCC);
    padding: 32px 0;
...
.next-table-column-resize-proxy {
  ...
  width: 0;
  border-left: 2px solid #209BFA;
  border-left: var(--line-2, 2px) solid var(--color-brand1-6, #209BFA);
  z-index: 10;
  display: none; }
...
.next-table-group {
  ...
  .next-table-group .next-table-group-header td {
    background: #F5F5F5;
    background: var(--table-group-th-bg, #F5F5F5);
    color: #333333;
  ...
  .next-table-group .next-table-group-footer td {
    background: #F5F5F5;
    background: var(--table-group-footer-bg, #F5F5F5);
    color: #333333;
...
.next-table-sort {
  ...
  .next-table-sort .current .next-icon {
    color: #209BFA;
    color: var(--table-sort-color-current, #209BFA); }
...
.next-calendar2 {
  ...
  .next-calendar2-card .next-calendar2-cell-current:not(.next-calendar2-cell-disabled):not(.next-calendar2-cell-selected):not(.next-calendar2-cell-today):hover:not(.next-calendar2-cell-hover) .next-calendar2-cell-inner, .next-calendar2-panel .next-calendar2-cell-current:not(.next-calendar2-cell-disabled):not(.next-calendar2-cell-selected):not(.next-calendar2-cell-today):hover:not(.next-calendar2-cell-hover) .next-calendar2-cell-inner {
    background: #F9F9F9;
    background: var(--color-fill1-2, #F9F9F9); }
  ...
  .next-calendar2-fullscreen .next-calendar2-cell-inner {
    ...
    border-top: 2px solid var(--color-line1-1, #EEEEEE);
    margin: 0 4px;
    padding: 4px 8px 0; }
  ...
  .next-calendar2-fullscreen .next-calendar2-cell-current:not(.next-calendar2-cell-disabled):not(.next-calendar2-cell-selected):not(.next-calendar2-cell-today):hover .next-calendar2-cell-inner {
    background-color: #F9F9F9;
    background-color: var(--color-fill1-2, #F9F9F9); }
  ...
  .next-calendar2-fullscreen .next-calendar2-cell-current.next-calendar2-cell-selected:not(.next-calendar2-cell-disabled) .next-calendar2-cell-inner {
    ...
    color: var(--color-brand1-6, #209BFA);
    background: #ADD9FF;
    background: var(--color-brand1-1, #ADD9FF); }
  .next-calendar2-card .next-calendar2-header {
    padding: 8px 8px;
    border-bottom: 1px solid #EEEEEE;
    border-bottom: 1px solid var(--color-line1-1, #EEEEEE); }
...
.next-date-picker2-footer {
  ...
  border-top: 1px solid var(--color-line1-1, #EEEEEE);
  padding: 4px 12px;
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
...
.next-time-picker2-panel {
  ...
  .next-time-picker2-panel-header {
    border-bottom: 1px solid #E6E6E6;
    border-bottom: var(--line-1, 1px) var(--line-solid, solid) var(--popup-local-border-color, #E6E6E6); }
...
.next-time-picker2 {
  ...
  .next-time-picker2-input {
    ...
    .next-time-picker2-input.next-time-picker2-input-focus {
      border-color: #209BFA;
      border-color: var(--input-focus-border-color, #209BFA);
      background-color: #FFFFFF;
      background-color: var(--input-focus-bg-color, #FFFFFF);
      -webkit-box-shadow: 0 0 0 2px rgba(32, 155, 250, 0.2);
              box-shadow: 0 0 0 2px rgba(32, 155, 250, 0.2); }
    ...
    .next-time-picker2-input.next-time-picker2-input-disabled {
      ...
      border-color: #EEEEEE;
      border-color: var(--input-disabled-border-color, #EEEEEE);
      background-color: #FAFAFA;
  ...
  .next-time-picker2-input-separator {
    color: #DDDDDD;
    color: var(--input-border-color, #DDDDDD);
    font-size: 12px;
    display: inline-block;
    min-width: 16px;
    text-align: center; }
...
div[dir="rtl"] .next-date-time-picker-wrapper {
  border-right: 1px solid #EEEEEE;
  border-right: 1px solid var(--color-line1-1, #EEEEEE);
  border-left: node; }
...
div[dir="rtl"] .next-range-picker2-panel:not(.next-range-picker2-panel-single) .next-calendar2-cell-current:not(.next-calendar2-cell-disabled).next-calendar2-cell-hover:first-of-type::after {
  ...
  border-top-right-radius: 2px;
  border-bottom-right-radius: 2px;
  border-right: 1px dashed #1274E7;
  border-right: 1px dashed var(--color-brand1-9, #1274E7); }
...
div[dir="rtl"] .next-range-picker2-panel:not(.next-range-picker2-panel-single) .next-calendar2-cell-current:not(.next-calendar2-cell-disabled).next-calendar2-cell-hover:last-of-type::after {
  ...
  border-top-left-radius: 2px;
  border-bottom-left-radius: 2px;
  border-left: 1px dashed #1274E7;
  border-left: 1px dashed var(--color-brand1-9, #1274E7); }
...
.next-date-picker2 {
  ...
  .next-date-picker2-wrapper {
    ...
    background-color: #FFFFFF;
    border: 1px solid #EEEEEE;
    border: 1px solid var(--color-line1-1, #EEEEEE);
    border-radius: 3px;
...
.next-range-picker2-arrow {
  ...
  border-color: var(--color-line1-1, #EEEEEE) var(--color-line1-1, #EEEEEE) transparent transparent;
  border-style: solid;
  border-width: 1px;
...
.next-date-time-picker-wrapper {
  border-left: 1px solid #EEEEEE;
  border-left: 1px solid var(--color-line1-1, #EEEEEE); }
...
.next-range-picker2-panel:not(.next-range-picker2-panel-single) .next-calendar2-cell-current.next-calendar2-cell-hover::after {
  ...
  -webkit-transform: translateY(-50%);
      -ms-transform: translateY(-50%);
          transform: translateY(-50%);
  border-color: #1274E7 transparent;
  border-color: var(--color-brand1-9, #1274E7) transparent;
  border-style: dashed;
  border-width: 1px; }
...
.next-range-picker2-panel:not(.next-range-picker2-panel-single) .next-calendar2-cell-current.next-calendar2-cell-hover-begin::after {
  border-top: 1px dashed #1274E7;
  border-top: 1px dashed var(--color-brand1-9, #1274E7);
  border-left: 1px dashed #1274E7;
  border-left: 1px dashed var(--color-brand1-9, #1274E7);
  border-top-left-radius: 2px;
  border-bottom-left-radius: 2px; }
...
.next-calendar2-table-week .next-calendar2-week-current .next-calendar2-cell.next-calendar2-cell-selected .next-calendar2-cell-inner {
  ...
  color: var(--color-text1-3, #666666);
  background-color: #ADD9FF;
  background-color: var(--color-brand1-1, #ADD9FF); }
...
.next-icon-ic_yusuanguanli::before {
  content: "\E745";
  content: var(--icon-content-ic_yusuanguanli, "\E745"); }

.next-icon-ic_formbeifen::before {
  content: "\E7E0";
  content: var(--icon-content-ic_formbeifen, "\E7E0"); }

.next-icon-ic_form::before {
  content: "\E7E1";
  content: var(--icon-content-ic_form, "\E7E1"); }

.next-icon-ic_dashboard::before {
  content: "\E7E2";
  content: var(--icon-content-ic_dashboard, "\E7E2"); }

.next-icon-ic_tongzhi::before {
  content: "\E749";
  content: var(--icon-content-ic_tongzhi, "\E749"); }

.next-icon-ic_logo::before {
  content: "\E79D";
  content: var(--icon-content-ic_logo, "\E79D"); }

.next-icon-taobao::before {
  content: "\E7BE";
  content: var(--icon-content-taobao, "\E7BE"); }

.next-icon-alibaba::before {
  content: "\E7BF";
  content: var(--icon-content-alibaba, "\E7BF"); }

.next-icon-ic_language::before {
  content: "\E7DA";
  content: var(--icon-content-ic_language, "\E7DA"); }
