...
module.exports = function (wpo, root, conf) {
  ...
  var _send = function _send() {
    ...
    while (params = core.dequeue()) {
      ...
      if (wpo.debug && (typeof window === "undefined" ? "undefined" : (0, _typeof2["default"])(window)) === 'object' && window.console) {
        console.log(obj);
      }
  ...
  var core = {
    ...
    setConfig: function setConfig(conf) {
      if (conf && (0, _typeof2["default"])(conf) !== 'object') {
