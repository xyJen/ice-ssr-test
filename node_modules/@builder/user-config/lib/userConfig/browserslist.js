...
var getTargetStr = function (browserslist) {
    if (typeof browserslist === 'string') {
        ...
        return Object.keys(browserslist).map(function (browserKey) { return "".concat(browserKey, " >= ").concat(browserslist[browserKey]); }).join(',');
    }
    return '';
};
exports.default = (function (config, browserslist, _a) {
    ...
    if (browserslist) {
        ...
        config.target("browserslist:".concat(getTargetStr(browserslist)));
    }
    if (userConfig.swc) {
