...
const fs = require("@builder/pack/deps/graceful-fs");
const ipaddr = require("@builder/pack/deps/ipaddr.js");
const defaultGateway = require("@builder/pack/deps/default-gateway");
const express = require("@builder/pack/deps/express");
const { validate } = require("@builder/pack/deps/schema-utils4");
...
class Server {
  ...
  static async getFreePort(port) {
    ...
    const pRetry = require("@builder/pack/deps/p-retry");
    const portfinder = require("@builder/pack/deps/portfinder");
      ...
      if (
        ...
        if (certificateExists) {
          ...
          if ((now - Number(certificateStat.ctime)) / certificateTtl > 30) {
            const del = require("@builder/pack/deps/del");
        ...
        if (!certificateExists) {
          ...
          // @ts-ignore
          const selfsigned = require("@builder/pack/deps/selfsigned");
   ...
   */
  setupDevMiddleware() {
    const webpackDevMiddleware = require("@builder/pack/deps/webpack-dev-middleware");
  ...
  setupMiddlewares() {
    ...
    if (this.options.compress) {
      const compression = require("@builder/pack/deps/compression");
    ...
    if (this.options.proxy) {
      const { createProxyMiddleware } = require("@builder/pack/deps/http-proxy-middleware");
    ...
    if (this.options.historyApiFallback) {
      const connectHistoryApiFallback = require("@builder/pack/deps/connect-history-api-fallback");
    ...
    if (/** @type {NormalizedStatic[]} */ (this.options.static).length > 0) {
      const serveIndex = require("@builder/pack/deps/serve-index");
  ...
  openBrowser(defaultOpenTarget) {
    const open = require("@builder/pack/deps/open");
  ...
  runBonjour() {
     ...
     */
    this.bonjour = require("@builder/pack/deps/bonjour")();
   ...
   */
  logStatus() {
    const { isColorSupported, cyan, red } = require("@builder/pack/deps/colorette");
