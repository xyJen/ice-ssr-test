...
exports.default = (function (api) {
    ...
    var srcDir = userConfig.sourceDir || (0, getSourceDir_1.default)(userConfig.entry);
    var tsEntryFiles = globby.sync(["".concat(srcDir, "/app.@(ts?(x))"), "".concat(srcDir, "/pages/*/app.@(ts?(x))")], {
        cwd: rootDir
    });
    var projectType = tsEntryFiles.length ? 'ts' : 'js';
    setValue(constant_1.PROJECT_TYPE, projectType);
});
//# sourceMappingURL=setProjectType.js.map