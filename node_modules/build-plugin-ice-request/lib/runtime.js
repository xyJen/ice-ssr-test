...
function setAxiosInstance(requestConfig, axiosInstance) {
    ...
    function isExist(handlers, _a) {
        var fulfilled = _a[0], rejected = _a[1];
        return handlers.some(function (item) { return item.fulfilled === fulfilled && item.rejected === rejected; });
    }
