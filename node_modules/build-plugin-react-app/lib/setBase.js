...
module.exports = function (api, _a) {
    ...
    var context = api.context, modifyUserConfig = api.modifyUserConfig, getValue = api.getValue;
    var rootDir = context.rootDir, userConfig = context.userConfig;
    var outputPath = getWebOutputPath(context, { target: target });
    var clientEnv = getValue('CLIENT_ENV');
    webpackConfig
        ...
        .use(HtmlWebpackPlugin, [{
            inject: true,
            templateParameters: __assign({ NODE_ENV: process.env.NODE_ENV }, (clientEnv || {})),
            favicon: getFilePath([
