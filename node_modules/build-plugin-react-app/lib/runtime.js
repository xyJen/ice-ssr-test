...
exports.default = (function (_a) {
    var _b, _c;
    var appConfig = _a.appConfig, wrapperPageComponent = _a.wrapperPageComponent, buildConfig = _a.buildConfig, context = _a.context, applyRuntimeAPI = _a.applyRuntimeAPI, getRuntimeValue = _a.getRuntimeValue, addProvider = _a.addProvider;
    var _d = appConfig.app, app = _d === void 0 ? {} : _d;
    var ErrorBoundaryFallback = app.ErrorBoundaryFallback, onErrorBoundaryHandler = app.onErrorBoundaryHandler, renderComponent = app.renderComponent, customAddProvider = app.addProvider;
    if (customAddProvider) {
        addProvider(customAddProvider);
    }
    var _e = app.parseSearchParams, parseSearchParams = _e === void 0 ? true : _e;
    ...
    var enableRouter = getRuntimeValue('enableRouter');
    if (process.env.NODE_ENV !== 'production') {
        if (buildConfig.mpa) {
            if (enableRouter) {
                ...
                if (!((_b = appConfig.router) === null || _b === void 0 ? void 0 : _b.routes)) {
            ...
            if (enableRouter) {
                ...
                if ((_c = appConfig.router) === null || _c === void 0 ? void 0 : _c.routes) {
                    // 手动配置了 routes 字段
...
function wrapperPageWithProps(applyRuntimeAPI) {
    var WrapperPageFn = function (PageComponent) {
        var pageConfig = PageComponent.pageConfig;
        var PagePropsWrapper = function (props) {
            var searchParams = applyRuntimeAPI('getSearchParams');
            return React.createElement(PageComponent, __assign({}, Object.assign({}, props, { searchParams: searchParams, pageConfig: pageConfig })));
        };
...
function wrapperPageWithErrorBoundary(ErrorBoundaryFallback, onErrorBoundaryHandler) {
    var WrapperPageFn = function (PageComponent) {
        ...
        var ErrorBoundaryWrapper = function (props) {
            if (pageConfig.errorBoundary) {
                return (React.createElement(ErrorBoundary_1.default, { Fallback: ErrorBoundaryFallback, onError: onErrorBoundaryHandler },
...
function wrapperPageWithSSR(context) {
    var pageInitialProps = __assign({}, context.pageInitialProps);
    var WrapperPageFn = function (PageComponent) {
        var ServerWrapper = function (props) {
            return React.createElement(PageComponent, __assign({}, Object.assign({}, props, pageInitialProps)));
        };
...
function wrapperPageWithCSR() {
    var _this = this;
    var wrapperPage = function (PageComponent) {
        var pageConfig = PageComponent.pageConfig;
        var _a = pageConfig || {}, title = _a.title, scrollToTop = _a.scrollToTop;
        var ClientWrapper = function (props) {
            var _a = (0, react_1.useState)(window.__ICE_PAGE_PROPS__), data = _a[0], setData = _a[1];
            (0, react_1.useEffect)(function () {
                ...
                if (window.__ICE_PAGE_PROPS__) {
                    ...
                    (function () { return __awaiter(_this, void 0, void 0, function () {
                        var _a, href, origin, pathname, search, curPath, query, ssrError, initialContext, result;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    _a = window.location, href = _a.href, origin = _a.origin, pathname = _a.pathname, search = _a.search;
                                    curPath = href.replace(origin, '');
                                    ...
                                    return [4 /*yield*/, PageComponent.getInitialProps(initialContext)];
                                case 1:
                                    result = _b.sent();
                                    setData(result);
                                    return [2 /*return*/];
            ...
            return React.createElement(PageComponent, __assign({}, Object.assign({}, props, data)));
        };
