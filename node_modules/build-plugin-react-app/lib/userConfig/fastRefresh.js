...
var ReactRefreshWebpackPlugin = require('@builder/pack/deps/@pmmmwh/react-refresh-webpack-plugin');
var deepmerge = require('deepmerge');
module.exports = function (config, value, context) {
    var command = context.command, userConfig = context.userConfig;
    if (command === 'start' && value && process.env.NODE_ENV !== 'test') {
        ...
        if (userConfig.swc) {
            ...
            ['jsx', 'tsx'].forEach(function (ruleName) {
                config.module.rule("swc-".concat(ruleName)).use('swc-loader').tap(function (options) { return deepmerge(options || {}, refreshOptions_1); });
            });
        }
    }
};
//# sourceMappingURL=fastRefresh.js.map