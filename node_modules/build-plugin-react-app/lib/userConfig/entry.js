...
module.exports = function (config, value, context) {
    ...
    entryNames.forEach(function (entryName) {
        ...
        if (isMultiEntry && !ignoreHtmlTemplate) {
            var pluginKey = "HtmlWebpackPlugin_".concat(entryName);
            var filename = "".concat(entryName, ".html");
    ...
    if (config.plugins.get('CopyWebpackPlugin')) {
        config.plugin('CopyWebpackPlugin').tap(function (_a) {
            ...
            firstPattern.globOptions = __assign(__assign({}, (firstPattern.globOptions || {})), { ignore: ignoreFiles.map(function (ignoreFile) { return "**/public/".concat(ignoreFile); }) });
