...
export declare type Optionalize<T extends K, K> = Omit<T, keyof K>;
declare type PropType<Obj, Prop extends keyof Obj> = Obj[Prop];
interface EffectState {
    isLoading: boolean;
    error: Error;
}
declare type EffectsState<Effects> = {
    [K in keyof Effects]: EffectState;
};
declare type EffectsLoading<Effects> = {
    [K in keyof Effects]: boolean;
};
declare type EffectsError<Effects> = {
    [K in keyof Effects]: {
        error: Error;
        value: number;
    };
};
export declare type ExtractIcestoreStateFromModels<M extends Models> = {
    [modelKey in keyof M]: M[modelKey]['state'];
};
export interface IcestoreModels extends Models {
}
export declare type IcestoreRootState<M extends Models = IcestoreModels> = ExtractIcestoreStateFromModels<M>;
declare type ExtractIModelDispatcherAsyncFromEffect<E> = E extends () => Promise<infer R> ? IcestoreDispatcherAsync<void, void, R> : E extends (payload: infer P) => Promise<infer R> ? IcestoreDispatcherAsync<P, void, R> : E extends (payload: infer P, rootState: any) => Promise<infer R> ? IcestoreDispatcherAsync<P, void, R> : E extends (payload: infer P, rootState: any, meta: infer M) => Promise<infer R> ? IcestoreDispatcherAsync<P, M, R> : IcestoreDispatcherAsync<any, any, any>;
declare type ExtractIModelDispatchersFromEffectsObject<effects extends ModelEffects<any>> = {
    [effectKey in keyof effects]: ExtractIModelDispatcherAsyncFromEffect<effects[effectKey]>;
};
export declare type ExtractIModelDispatchersFromEffects<effects extends ModelConfig['effects']> = effects extends ((...args: any[]) => infer R) ? R extends ModelEffects<any> ? ExtractIModelDispatchersFromEffectsObject<R> : {} : effects extends ModelEffects<any> ? ExtractIModelDispatchersFromEffectsObject<effects> : {};
declare type ExtractIModelDispatcherFromReducer<R> = R extends () => any ? IcestoreDispatcher<void, void> : R extends (state: infer S) => infer S ? IcestoreDispatcher<void, void> : R extends (state: infer S, payload: infer P) => (infer S | void) ? IcestoreDispatcher<P, void> : R extends (state: infer S, payload: infer P, meta: infer M) => (infer S | void) ? IcestoreDispatcher<P, M> : IcestoreDispatcher<any, any>;
interface DefaultIModelDispatchersFromReducersObject {
    setState: IcestoreDispatcher<any, any>;
}
declare type ExtractIModelDispatchersFromReducersObject<reducers extends ModelReducers<any>> = {
    [reducerKey in keyof reducers]: ExtractIModelDispatcherFromReducer<reducers[reducerKey]>;
} & DefaultIModelDispatchersFromReducersObject;
export declare type ExtractIModelDispatchersFromReducers<reducers extends ModelConfig['reducers']> = ExtractIModelDispatchersFromReducersObject<reducers & {}>;
export declare type ExtractIModelStateFromModelConfig<M extends ModelConfig> = PropType<M, 'state'>;
export declare type ExtractIModelEffectsFromModelConfig<M extends ModelConfig> = PropType<M, 'effects'>;
export declare type ExtractIModelReducersFromModelConfig<M extends ModelConfig> = PropType<M, 'reducers'>;
export declare type ExtractIModelFromModelConfig<M extends ModelConfig> = [ExtractIModelStateFromModelConfig<M>, ExtractIModelDispatchersFromModelConfig<M>];
export declare type ExtractIModelEffectsErrorFromModelConfig<M extends ModelConfig> = EffectsError<ExtractIModelDispatchersFromEffects<ExtractIModelEffectsFromModelConfig<M>>>;
export declare type ExtractIModelEffectsLoadingFromModelConfig<M extends ModelConfig> = EffectsLoading<ExtractIModelDispatchersFromEffects<ExtractIModelEffectsFromModelConfig<M>>>;
export declare type ExtractIModelEffectsStateFromModelConfig<M extends ModelConfig> = EffectsState<ExtractIModelDispatchersFromEffects<ExtractIModelEffectsFromModelConfig<M>>>;
export declare type ExtractIModelDispatchersFromModelConfig<M extends ModelConfig> = ExtractIModelDispatchersFromReducers<ExtractIModelReducersFromModelConfig<M>> & ExtractIModelDispatchersFromEffects<ExtractIModelEffectsFromModelConfig<M>>;
export declare type ExtractIcestoreDispatchersFromModels<M extends Models> = {
    [modelKey in keyof M]: ExtractIModelDispatchersFromModelConfig<M[modelKey]>;
};
declare type IcestoreDispatcher<P = void, M = void> = ([P] extends [void] ? ((...args: any[]) => Action<any, any>) : [M] extends [void] ? ((payload: P) => Action<P, void>) : (payload: P, meta: M) => Action<P, M>) & ((action: Action<P, M>) => Redux.Dispatch<Action<P, M>>) & ((action: Action<P, void>) => Redux.Dispatch<Action<P, void>>);
declare type IcestoreDispatcherAsync<P = void, M = void, R = void> = ([P] extends [void] ? ((...args: any[]) => Promise<R>) : [M] extends [void] ? ((payload: P) => Promise<R>) : (payload: P, meta: M) => Promise<R>) & ((action: Action<P, M>) => Promise<R>) & ((action: Action<P, void>) => Promise<R>);
export declare type IcestoreDispatch<M extends Models | void = IcestoreModels> = (M extends Models ? ExtractIcestoreDispatchersFromModels<M> : {
    [key: string]: {
        [key: string]: IcestoreDispatcher | IcestoreDispatcherAsync;
    };
}) & (IcestoreDispatcher | IcestoreDispatcherAsync) & (Redux.Dispatch<any>);
export interface Icestore<M extends Models = Models, A extends Action = Action> extends Redux.Store<IcestoreRootState<M>, A> {
    name: string;
...
interface WithModelEffectsError<M extends Models = Models, F extends MapModelEffectsErrorToProps<M> = MapModelEffectsErrorToProps<M>> {
    <K extends keyof M>(name: K, mapModelEffectsErrorToProps?: F): <R extends ReturnType<F>, P extends R>(Component: React.ComponentType<P>) => (props: Optionalize<P, R>) => React.ReactElement;
}
...
interface WithModelEffectsLoading<M extends Models = Models, F extends MapModelEffectsLoadingToProps<M> = MapModelEffectsLoadingToProps<M>> {
    <K extends keyof M>(name: K, mapModelEffectsLoadingToProps?: F): <R extends ReturnType<F>, P extends R>(Component: React.ComponentType<P>) => (props: Optionalize<P, R>) => React.ReactElement;
}
...
interface WithModelEffectsState<M extends Models = Models, F extends MapModelEffectsStateToProps<M> = MapModelEffectsStateToProps<M>> {
    <K extends keyof M>(name: K, mapModelEffectsStateToProps?: F): <R extends ReturnType<F>, P extends R>(Component: React.ComponentType<P>) => (props: Optionalize<P, R>) => React.ReactElement;
}
...
interface WithModelDispatchers<M extends Models = Models, F extends MapModelDispatchersToProps<M> = MapModelDispatchersToProps<M>> {
    <K extends keyof M>(name: K, mapModelDispatchersToProps?: F): <R extends ReturnType<F>, P extends R>(Component: React.ComponentType<P>) => (props: Optionalize<P, R>) => React.ReactElement;
}
...
interface WithModel<M extends Models = Models, F extends MapModelToProps<M> = MapModelToProps<M>> {
    <K extends keyof M>(name: K, mapModelToProps?: F): <R extends ReturnType<F>, P extends R>(Component: React.ComponentType<P>) => (props: Optionalize<P, R>) => React.ReactElement;
}
...
declare type ModelAPI<M extends Models = Models> = {
    getModelAPIs: GetModelAPIs<M>;
} & ModelValueAPI<M> & ModelStateAPI<M> & ModelDispathersAPI<M> & ModelEffectsLoadingAPI<M> & ModelEffectsErrorAPI<M> & ModelEffectsStateAPI<M>;
...
interface ProviderPluginAPI {
    ...
    context: React.Context<{
        store: PresetIcestore;
    }>;
}
export declare type ExtractIModelAPIsFromModelConfig<M extends ModelConfig> = ReturnType<GetModelAPIs<{
    model: M;
}, 'model'>>;
export declare type PresetIcestore<M extends Models = Models, A extends Action = Action> = Icestore<M, A> & ModelAPI<M> & ProviderPluginAPI;
...
export interface ModelEffects<S> {
    [key: string]: (payload: any, rootState?: S, meta?: any) => void;
}
export interface Models {
    [key: string]: ModelConfig;
}
export declare type ModelHook = (model: Model) => void;
...
export interface ModelConfig<S = any, SS = S> {
    ...
    reducers?: ModelReducers<S>;
    effects?: ModelEffects<any> | ((dispatch: IcestoreDispatch) => ModelEffects<any>);
}
...
export declare type CreateStoreConfig<M extends Models = Models> = InitConfig<M> & PrsetConfig;
...
export interface ThisModelConfig<S, R extends ModelReducers<S> = {}, E extends ModelEffects<S> | ((dispatch: IcestoreDispatch) => ModelEffects<S>) = {}, SS = S> {
    name?: string;
    state: S;
    baseReducer?: (state: SS, action: Action) => SS;
    reducers?: R;
    effects?: E extends ModelEffects<S> ? E & ThisType<ExtractIModelDispatchersFromReducersObject<R> & ExtractIModelDispatchersFromEffectsObject<E>> : (dispatch: IcestoreDispatch) => ModelEffects<S> & ThisType<ExtractIModelDispatchersFromReducersObject<R> & ExtractIModelDispatchersFromEffects<E>>;
}
interface ReturnModelConfig<S, R extends ModelReducers<S>, E extends ModelEffects<S> | ((dispatch: IcestoreDispatch) => ModelEffects<S>), SS> {
    name?: string;
    state: S;
    baseReducer?: (state: SS, action: Action) => SS;
    reducers?: R;
...
export declare function createModel<S, R extends ModelReducers<S>, E extends ModelEffects<S> | ((dispatch: IcestoreDispatch) => ModelEffects<S>), SS = S>(config: ThisModelConfig<S, R, E, SS>): ReturnModelConfig<S, R, E, SS>;
export {};
