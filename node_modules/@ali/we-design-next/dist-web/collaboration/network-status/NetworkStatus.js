...
var infoMap = {
  success: {
    ...
    icon: /*#__PURE__*/_createElement("svg", {
      width: "16",
      height: "16",
      fill: "currentColor",
      viewBox: "0 0 16 16",
  ...
  offline: {
    ...
    icon: /*#__PURE__*/_createElement("svg", {
      ...
      d: "M2.64648 3.35356L12.6465 13.3536L13.3536 12.6465L3.35359 2.64645L2.64648 3.35356ZM12.4001 9.19952L11.7839 9.66243L9.26847 7.14703C10.5399 7.44723 11.6407 8.18861 12.4001 9.19952ZM8.00009 4C7.41536 4 6.84442 4.05902 6.29289 4.17145L5.46384 3.34239C6.27121 3.11925 7.12173 3 8.00009 3C11.1083 3 13.8679 4.49325 15.6003 6.79938L14.8007 7.39999C13.2491 5.33447 10.7805 4 8.00009 4ZM3.29717 5.41837L2.57752 4.69872C1.74441 5.27885 1.00872 5.98892 0.399902 6.79938L1.19944 7.39999C1.78063 6.62631 2.49047 5.9552 3.29717 5.41837ZM6.23714 8.35834L5.48591 7.60711C4.74264 7.9898 4.09797 8.53673 3.60009 9.19952L4.39963 9.80013C4.87211 9.17116 5.50488 8.67041 6.23714 8.35834ZM6.80028 11.5997C7.07309 11.2365 7.50905 11 8.00009 11C8.49114 11 8.92709 11.2365 9.19991 11.5997L9.50045 11.9997L8.00009 13.125L6.49974 11.9997L6.80028 11.5997Z"
    }))
  }
};
export var NetworkStatus = /*#__PURE__*/React.memo(function (props) {
  var _props$status = props.status,
    status = _props$status === void 0 ? 'saved' : _props$status,
  ...
  var t = useTranslate();
  var render = function render(type, txt) {
    var _infoMap$type = infoMap[type],
      color = _infoMap$type.color,
      icon = _infoMap$type.icon;
    return /*#__PURE__*/_createElement(Box, {
      style: {
        color: color
      },
      onClick: onClick
    }, icon, !collapse ? /*#__PURE__*/_createElement(TextWrapper, {
      color: color
    }, txt) : null);
  };
  if (title) {
