 ...
 * 保证每次调用能拿到同一个值
 */
export var FontDetector = /*#__PURE__*/function () {
  function FontDetector(fonts) {
    var _this = this;
    this.css = void 0;
    this.timer = void 0;
    this.uuid = void 0;
    ...
    this.detect = function () {
      return new Promise(function (relove) {
        if (_this.detection) {
          relove(_this.detection);
          return;
        }
        var detection = [];
        _this.ready(function () {
          return _this.getResult(function (res) {
            _this.detection = res;
            relove(_this.detection);
            return;
          });
  ...
  _proto.inject = function inject() {
    var iframe = document.getElementById(this.iframeUuid);
    if (!iframe) {
  ...
  _proto.remove = function remove() {
    var elem = document.getElementById(this.iframeUuid);
    if (elem != null) {
      elem.remove();
    }
  };
  ...
  _proto.getResult = function getResult(callback) {
    var _this2 = this;
    var iframe = document.getElementById(this.iframeUuid);
    var iframeDoc = iframe.contentDocument;
    var elem = iframeDoc.getElementById(this.uuid);
    var fragment = iframeDoc.createDocumentFragment();
    // eslint-disable-next-line no-restricted-syntax
    for (var _iterator = _createForOfIteratorHelperLoose(this.fonts), _step; !(_step = _iterator()).done;) {
