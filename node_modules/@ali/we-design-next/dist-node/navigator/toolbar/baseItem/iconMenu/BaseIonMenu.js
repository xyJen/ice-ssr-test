...
const BaseIconMenu = /*#__PURE__*/_react.default.memo( /*#__PURE__*/_react.default.forwardRef((props, ref) => {
  const {
    icon,
    title,
    active,
  ...
  const cRef = (0, _react.useRef)(menuVisible);
  ...
  return /*#__PURE__*/_createElement(_styled.Wrapper, (0, _extends2.default)({
    ...
    className: (0, _common.mergeClassName)('wdn-toolbar-item', size, (menuVisible || active) && 'active', disabled && 'disabled'),
    "data-testid": testid,
    "data-role": role
  }, restProps), /*#__PURE__*/_createElement(_popover.Popover, {
    content: overlay,
...
exports.BaseIconMenu = BaseIconMenu;
