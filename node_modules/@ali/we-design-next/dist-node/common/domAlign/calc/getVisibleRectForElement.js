...
function getVisibleRectForElement(element, alwaysByViewport) {
  ...
  let el = (0, _getOffsetParent.default)(element);
  ...
  while (el) {
    ...
    el !== body && el !== documentElement && _utils.utils.css(el, 'overflow') !== 'visible') {
      const pos = _utils.utils.offset(el);
      // add border
  ...
  if (!_utils.utils.isWindow(element) && !_utils.utils.isDocument(element)) {
    ...
    const position = _utils.utils.css(element, 'position');
