...
exports.DEFAULT = exports.ART = void 0;
...
const artPresetColors = [['#222328', '#9B9A97', '#64473A', '#D9730D', '#DFAB01', '#0F7B6C', '#408BFB', '#6940A5', '#AD1A72', '#E03E3E'], [], ['#FFFFFF', '#F5F6F7', '#F5F1F0', '#FEF6E9', '#FFFAE5', '#ECF9F0', '#E8F2FE', '#F0EBF7', '#FCEFF3', '#FEF3F3'], ['#858689', '#E6E7E7', '#D7CCC8', '#F9DDB2', '#FFF8B9', '#D8ECE7', '#B7DCFB', '#D5C8EE', '#F4B9CD', '#F2BABA'], ['#646568', '#CBCCCD', '#C0A9A1', '#FFA726', '#FFEE58', '#B0D4CC', '#72B7EF', '#9C79D9', '#EB6793', '#EE7268'], ['#434448', '#B6B8B9', '#9F786B', '#FB8C00', '#FDD835', '#5DBEAC', '#0089FF', '#6C3BCF', '#D81B60', '#E53935'], ['#222328', '#979A9B', '#704F43', '#D16A15', '#DFB600', '#16816D', '#1564DC', '#44279B', '#A41D57', '#BB2626']];
const DEFAULT = {
  key: 'DEFAULT',
  title: 'wdn_color_picker_normal_mode',
  colors: defaultPresetColors
};
exports.DEFAULT = DEFAULT;
const ART = {
  key: 'ART',
  title: 'wdn_color_picker_art_mode',
  colors: artPresetColors
};
exports.ART = ART;
