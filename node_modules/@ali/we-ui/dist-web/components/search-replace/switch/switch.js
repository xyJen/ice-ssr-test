...
import { ArrowLeftNormal, ArrowRightNormal } from "../../icons";
import { Container, ModalText, SplitLine } from "./styled";

var _ref = /*#__PURE__*/_createElement(SplitLine, null);

var _ref2 = /*#__PURE__*/_createElement(SplitLine, null);
...
export var SearchSwitch = function SearchSwitch(props) {
  ...
  }), _ref, /*#__PURE__*/_createElement(ModalText, {
    style: {
      wordBreak: 'keep-all',
      whiteSpace: 'nowrap'
    }
  }, /*#__PURE__*/_createElement("span", null, focusIndex + "/" + count)), _ref2, /*#__PURE__*/_createElement(Button, {
    type: "text",
    size: "small",
