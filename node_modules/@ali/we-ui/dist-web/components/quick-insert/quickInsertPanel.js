...
import { QuickInsertItem, LoadingItem } from "./quickInsertItem";
...
var EMPTY_IMG = 'https://img.alicdn.com/tfs/TB1ko6CKG61gK0jSZFlXXXDKFXa-240-240.png';
...
var _ref2 = /*#__PURE__*/_createElement(ImageWrapper, {
  src: EMPTY_IMG
});
...
export var QuickInsertPanel = /*#__PURE__*/React.memo(function (props) {
  ...
  var handleKeyDown = function handleKeyDown(event) {
    ...
    if (isUpHotKey(event)) {
      ...
      var listHeight = getItemRelativeHeight(listData.length - 1);
      var relativeHeight = getItemRelativeHeight(newActiveIndex);
      var containerHeight = getListContainerHeight();
      ...
      var _relativeHeight = getItemRelativeHeight(_newActiveIndex);

      var _containerHeight = getListContainerHeight();

      if (refList.current && _relativeHeight > _containerHeight) {
        var _offset = _relativeHeight - _containerHeight;
  ...
  var _ref = /*#__PURE__*/_createElement(EmptyWrapper, null, _ref2, /*#__PURE__*/_createElement(EmptyText, null, /*#__PURE__*/_createElement(TranslateComp, {
    locale: locale,
  ...
  var renderList = function renderList() {
    ...
    return isEmpty ? _ref : /*#__PURE__*/_createElement(ListWrapper, {
  ...
  return /*#__PURE__*/_createElement(QuickInsertWrapper, null, renderHeader(), isLoading ? /*#__PURE__*/_createElement(LoadingItem, {
    locale: locale
