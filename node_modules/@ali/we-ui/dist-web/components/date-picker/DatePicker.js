...
import { CalendarNormal, RoundcloseThickNormal } from "../icons";
...
import { DatePickerTrigger, DatePickerTriggerWrap, DatePickerOverlay, DatePickerOverlayInputs, DatePickerOverlayPanel, DatePickerOverlayFooter } from "./styled";
import { DatePanel } from "./DatePanel";
import { MonthPanel } from "./MonthPanel";
import { YearPanel } from "./YearPanel";

var _ref = /*#__PURE__*/_createElement(CalendarNormal, {
...
var DatePicker = /*#__PURE__*/React.memo(function (props) {
  ...
  return /*#__PURE__*/_createElement(Dropdown, {
    ...
    overlay: /*#__PURE__*/_createElement(DatePickerOverlay, {
    ...
    }, /*#__PURE__*/_createElement(DatePickerOverlayInputs, null, /*#__PURE__*/_createElement(Input, {
      ...
      testid: testid
    })), !!showTime && /*#__PURE__*/_createElement(DatePickerOverlayFooter, null, /*#__PURE__*/_createElement("span", {
      className: classnames('time-button', {
        disabled: !value
      }),
      onClick: handleToggleTimeDatePanel,
      "data-testid": testid ? "time-button-" + testid : undefined
    }, panel === 'time' ? '选择日期' : '选择时间'), /*#__PURE__*/_createElement(Button, {
      shape: "round",
      disabled: !value,
      type: "primary",
    ...
    className: "text"
  }, value ? value.format(finalFormat) : placeholder), _ref, !disabled && allowClear && !visible && /*#__PURE__*/_createElement(RoundcloseThickNormal, {
