var util = require("./util"), Reporter = require("./reporter"), MiniProgramLogger = function(e) {
    ...
    var o = this;
    return Reporter.call(o, e), o.appBegin = Date.now(), o._health = {
        errcount: 0,
        apisucc: 0,
        apifail: 0
...
MiniProgramLogger.prototype = util.createObject(Reporter.prototype), util.ext(Reporter._root.dftCon, {
    ...
    hookApp: function(e) {
        var o = this, t = {
            onLaunch: function() {
                var t = 1 === arguments.length ? [ arguments[0] ] : Array.apply(null, arguments), n = e.onLaunch;
                try {
                    o.appLaunch();
                } catch (r) {
    ...
    sendHealth: function() {
        if (this.pvPage) {
            ...
            e.page = this.pvPage, e.stay = o, this._lg("health", e, 1), this._health = {
                errcount: 0,
                apisucc: 0,
                apifail: 0
            }, this.pvPage = null;
