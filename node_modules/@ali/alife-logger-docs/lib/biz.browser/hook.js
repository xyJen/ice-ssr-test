            ...
            return !e && n ? this : (n || (function() {
                if ("function" == typeof t[i]) {
                    ...
                    t[s] = e, t[i] = function(i, s) {
                        ...
                        if (f) {
                            ...
                            if (a.checkSameOrigin(u, v)) {
                                if (i && "string" != typeof i) try {
                                    if (p[0].headers && "function" == typeof p[0].headers.get && "function" == typeof p[0].headers.append) {
                                        var I = p[0].headers.get("EagleEye-TraceID"), D = p[0].headers.get("EagleEye-SessionID"), T = p[0].headers.get("EagleEye-pAppName");
                                        I ? y = I : (y = c.getTraceId()["EagleEye-TraceID"], p[0].headers.append("EagleEye-TraceID", y)), 
                                        D ? d = D : (d = c.getPageviewId()["EagleEye-SessionID"], p[0].headers.append("EagleEye-SessionID", d)), 
                                        T || p[0].headers.append("EagleEye-pAppName", E);
                                    }
                                } catch (m) {
                                ...
                                s.headers["EagleEye-TraceID"] = y), s.headers["EagleEye-SessionID"] ? d = s.headers["EagleEye-SessionID"] : (d = c.getPageviewId()["EagleEye-SessionID"], 
                        ...
                        return e.apply(t, p).then(function(e) {
                            ...
                            try {
                                ...
                                return a.warn("[ARMS] fetch response error :", S), e;
                            }
                        })["catch"](function(e) {
                            if (!c || !c.api) throw e;
                            var t = Date.now() - l;
                ...
                if ("function" == typeof t[c]) {
                    ...
                    t[p] = i, t[c] = function(t) {
                        ...
                        var c, l, g, h = s.send, u = s.open, f = s.setRequestHeader, y = p._conf, d = p.getConfig("enableLinkTrace"), E = "", v = "", I = "";
                        return s.open = function(t, n) {
                            ...
                            d) {
                                ...
                                f.apply(s, [ "EagleEye-TraceID", E ]), v = p.getPageviewId()["EagleEye-SessionID"], 
                                f.apply(s, [ "EagleEye-SessionID", v ]), I = p.getConfig("pid"), f.apply(s, [ "EagleEye-pAppName", I ]));
                            }
                        }, s.send = function() {
                            c = Date.now();
                            ...
                            if (l && 4 === s.readyState) {
                                ...
                                if (s.status >= 200 && s.status <= 299) {
                                    ...
                                    s.responseType && "text" !== s.responseType ? p.api(l, !0, t, i, "", c, E, v, {}, r) : o(p, y.parseResponse, l, g, s.responseText, i, t, c, E, v);
                                } else p.api(l, !1, t, s.status || "FAILED", s.statusText, c, E, v, n, r);
                            }
                        }), s;
