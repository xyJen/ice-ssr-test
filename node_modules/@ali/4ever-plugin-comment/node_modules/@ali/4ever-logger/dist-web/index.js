...
var debugAppender = new DebugAppender('EDITOR:LOGGER');
/**
 * 默认配置好一个 arms appender, 需要外层业务手动注入才能够生效
 * @see https://arms.console.aliyun.com/retcode?pid=en91t6prdd%4081db28b43ff68d6#/index
 */

var getArmsAppender = function getArmsAppender() {
  if (IS_TEST) {
    return null;
...
export { EnvEnum, debugAppender, getArmsAppender, getEnvironment };
