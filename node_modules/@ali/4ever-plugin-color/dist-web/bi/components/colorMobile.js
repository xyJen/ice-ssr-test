...
var defaultFontColorList = ['#171A1D', '#9B9A97', '#E03E3E', '#D9730D', '#DFAB01', '#0F7B6C', '#408BFB', '#64473A', '#6940A5', '#AD1A72'];
var defaultBackgroundColorList = ['#CBCCCD', '#EE7268', '#FFA726', '#FFEE58', '#4DAB9A', '#72B7EF', '#222328', '#C0A9A1', '#9C79D9', '#EB6793'];
...
var ColorBlockIcon = function ColorBlockIcon() {
  return _ref;
};
...
var ColorCheckIcon = function ColorCheckIcon() {
  return _ref2;
};

var HorizScroller = /*#__PURE__*/styled.div(["display:flex;flex-direction:row;align-items:center;justify-content:flex-start;margin:-2px -16px 0 -16px;padding:2px 0 12px 16px;overflow-x:scroll;-ms-overflow-style:none;scrollbar-width:none;&::-webkit-scrollbar{display:none;}"]);
var BlockBase = /*#__PURE__*/styled.div(["display:flex;align-items:center;justify-content:center;margin-right:8px;min-width:40px;width:40px;height:40px;border-radius:4px;@media only screen and (min-width:580px){min-width:80px;width:80px;}"]);
var FontIcon = /*#__PURE__*/styled(BlockBase)(["background:", ";"], function (props) {
  return props.isFocused ? '#E0F0FF' : 'rgba(126, 134, 142, 0.12)';
});
var BgIconClear = /*#__PURE__*/styled(BlockBase)(["box-shadow:0px 0px 1px rgba(0,0,0,0.5);background:", ";"], function (props) {
  return props.isFocused ? '#E0F0FF' : 'inherit';
}); // flex + 滚动似乎会触发某一些优化，在 Android、iOS 上 trim 掉无用的空间
// height 是 0 时，也会触发这个优化

var RightAlign = /*#__PURE__*/styled.div(["min-width:8px;width:8px;height:1px;"]);
var BgIcon = /*#__PURE__*/styled(BgIconClear)(["background:", ";"], function (props) {
  return props.color;
});

var AFont = function AFont(_ref3) {
...
var _ref4 = /*#__PURE__*/_createElement(RightAlign, null);
...
export function Fonts(props) {
  ...
  return /*#__PURE__*/_createElement(HorizScroller, null, defaultFontColorList.map(function (color) {
...
var _ref5 = /*#__PURE__*/_createElement(ColorBlockIcon, null);

var _ref6 = /*#__PURE__*/_createElement(ColorCheckIcon, null);

var _ref7 = /*#__PURE__*/_createElement(RightAlign, null);

export function Backgrounds(props) {
  var controller = props.controller;
  var currentHighlight = controller.query('getHighlight');
  var handleBgColorChange = React.useCallback(function (highlight) {
  ...
  return /*#__PURE__*/_createElement(HorizScroller, null, /*#__PURE__*/_createElement(BgIconClear, {
    ...
    onClick: function onClick() {
      return handleBgColorChange('');
    }
  }, _ref5), defaultBackgroundColorList.map(function (color) {
    return /*#__PURE__*/_createElement(BgIcon, {
      key: color,
      isFocused: false,
      onClick: function onClick() {
        return handleBgColorChange(color);
      },
      color: color
    }, currentHighlight === color && _ref6);
  }), _ref7);
}
