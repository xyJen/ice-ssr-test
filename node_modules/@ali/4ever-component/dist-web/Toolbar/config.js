import { ToolBoxLayoutMode, ToolbarMode } from "./interface";
var defaultInlineLayout = [];
var defaultDisableTargets = {
  hr: true,
  code: true
};
var singleLayout = [{
...
var ToolbarConfig = {
  defaultInlineLayout: defaultInlineLayout,
  defaultSingleLayout: singleLayout,
  defaultDoubleLayout: doubleLayout,
  defaultDisableTargets: defaultDisableTargets,
  mode: ToolbarMode,
  buttonLayout: ToolBoxLayoutMode
};
