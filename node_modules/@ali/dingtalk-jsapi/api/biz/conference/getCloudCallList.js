...
exports.getCloudCallList$ = void 0;
var ddSdk_1 = require("../../../lib/ddSdk");
var apiName = 'biz.conference.getCloudCallList';
ddSdk_1.ddSdk.setAPI(apiName, (_a = {},
    _a[ddSdk_1.ENV_ENUM.ios] = { vs: '6.0.0' },
    _a[ddSdk_1.ENV_ENUM.android] = { vs: '6.0.0' },
    _a[ddSdk_1.ENV_ENUM.pc] = { vs: '6.0.9' },
    _a));
/**
 * 办公电话话单查询
 ...
 */
function getCloudCallList$(params) {
    return ddSdk_1.ddSdk.invokeAPI(apiName, params);
}
exports.getCloudCallList$ = getCloudCallList$;
exports.default = getCloudCallList$;
