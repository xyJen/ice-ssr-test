...
describe('list', () => {
  describe('列表项目符号选区', () => {
    ...
    it('选中项目符号, 首次展开颜色选择器', async () => {
      ...
      clickToolbar(container, `[data-testid="${selector}"] .wdn-toolbar-split-btn-arrow`);
    });
    ...
    [{
      ...
      testId: 'bi-toolbar-highlight-color-picker',
      styleName: 'backgroundColor'
    }, {
      name: '符号颜色',
      selector: 'bi-toolbar-color',
      testId: 'bi-toolbar-color-color-picker',
      styleName: 'color'
    }].forEach(({
      name,
      selector,
...
//# sourceMappingURL=listSelection.test.js.map