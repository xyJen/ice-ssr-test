...
describe('Bi/indent/ui', () => {
  [{
    ...
    indentOperationByToolbar: async (container, _) => {
      ...
      await (0, _react.waitFor)(() => _dom.screen.queryByTestId('splite-overlay-bi-toolbar-indent'));
      const element = await (0, _react.waitFor)(() => _dom.screen.queryByTestId('menu-item-option-increase'));
    ...
    dedentOperationByToolbar: async (container, _) => {
      ...
      clickToolbar(container, '[data-testid="bi-toolbar-indent"] [data-testid="splitbutton-arrow-bi-toolbar-indent"]');
      await (0, _react.waitFor)(() => _dom.screen.queryByTestId('splite-overlay-bi-toolbar-indent'));
      const element = await (0, _react.waitFor)(() => _dom.screen.queryByTestId('menu-item-option-decrease'));
