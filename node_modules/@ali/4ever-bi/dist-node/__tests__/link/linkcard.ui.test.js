...
describe('bi/link/ui', () => {
  ...
  describe('插入链接', () => {
    ...
    test('选中 image 时，工具栏链接按钮展示为正常链接', async () => {
      ...
      const linkButton = container.querySelector('[data-testid="bi-toolbar-link"]');
    ...
    test('选中其他 inline 时，工具栏链接按钮展示为禁用', async () => {
      ...
      const linkButton = container.querySelector('[data-testid="bi-toolbar-link"]');
      expect(linkButton.parentElement?.className.indexOf('disabled')).toBeTruthy();
    });
  });
  describe('链接工具栏', () => {
...
//# sourceMappingURL=linkcard.ui.test.js.map