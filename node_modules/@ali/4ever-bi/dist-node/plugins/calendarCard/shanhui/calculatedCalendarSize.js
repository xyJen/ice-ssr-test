...
exports.getCalculatedCalendarReceivers = getCalculatedCalendarReceivers;
exports.calculatedCalendarSize = calculatedCalendarSize;
...
function getCalculatedCalendarReceivers(metadata, containerWidth, totalCount) {
  const {
  ...
  const totalCountText = receiverCount.replace('{count}', String(totalCount)); // 最大不超过 1 行
...
async function calculatedCalendarSize(metadata, containerWidth) {
  const {
    locale
  } = _zh_CN.default.calendarCard;
  const {
  ...
  }, /*#__PURE__*/_createElement(BodyWrapper, null, /*#__PURE__*/_createElement(TimeTextParagraph, null, time), /*#__PURE__*/_createElement(PlaceTextParagraph, null, place), /*#__PURE__*/_createElement(ReceiversParagraph, {
    isReadonly: true,
    locale: locale,
    metadata: metadata
...
//# sourceMappingURL=calculatedCalendarSize.js.map