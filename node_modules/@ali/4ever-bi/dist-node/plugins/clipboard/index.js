...
// 兼容
const createClipboardPlugin = configs => (0, _everPluginClipboard.biFactory)(configs);
...
createClipboardPlugin.utils = { ..._everPluginClipboard.utils,
  createOnCangjieCopyOrCut: _everPluginClipboard.createOnCangjieCopyOrCut
};
