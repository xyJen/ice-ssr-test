...
exports.default = convertTextLinkToBlockLinkCard;
...
function convertTextLinkToBlockLinkCard(controller, node, data) {
  const {
    text,
    href,
    cardInfo,
  ...
  controller.setOpRelatedId(card.key).command(_everCangjie.Commands.moveToStartOfNode, node).command(_commands.removeLink, node).command('insertCard', card).command(_deleteExtraBlankLine.default, card.key);
