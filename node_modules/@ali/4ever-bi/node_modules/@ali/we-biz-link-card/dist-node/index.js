...
const URLLinkCardLoading = ({
  isSelected,
  cardStyle
}) => {
  // 如果是 indoc，因为有 border，所以需要减去 2px
  const height = cardStyle === 'popup' ? URLLinkCardHeight : URLLinkCardHeight - 2;
  return /*#__PURE__*/React__namespace.createElement(weToolbar.AbstractCardLayout, {
    ...
    icon: _ImagePlaceholder$2 || (_ImagePlaceholder$2 = /*#__PURE__*/React__namespace.createElement(ImagePlaceholder, null))
  });
};

var _svg6, _svg7, _svg8;
const EditIcon = () => {
  return _svg6 || (_svg6 = /*#__PURE__*/React__default["default"].createElement("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "20",
    height: "20",
    fill: "none",
...
const CopyIcon = () => {
  return _svg7 || (_svg7 = /*#__PURE__*/React__default["default"].createElement("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "20",
    height: "20",
    fill: "none",
...
const UnlinkIcon = () => {
  return _svg8 || (_svg8 = /*#__PURE__*/React__default["default"].createElement("svg", {
    width: "24",
    height: "24",
    viewBox: "0 0 24 24",
    fill: "none",
...
const URLLinkCardError = props => {
  ...
  const onStyleChange = num => {
    switch (num) {
      case 0:
        onSwitchStyle === null || onSwitchStyle === void 0 ? void 0 : onSwitchStyle('popup', 'text');
        break;

      case 1:
        onSwitchStyle === null || onSwitchStyle === void 0 ? void 0 : onSwitchStyle('indoc', 'abstract');
        break;

      case 2:
        onSwitchStyle === null || onSwitchStyle === void 0 ? void 0 : onSwitchStyle('indoc', 'preview');
        break;
    }
  }; // 如果是 indoc，因为有 border，所以需要减去 2px
  ...
  const height = cardStyle === 'popup' ? URLLinkCardHeight : URLLinkCardHeight - 2;
  return /*#__PURE__*/React__default["default"].createElement(weToolbar.AbstractCardLayout, {
    isSelected: isSelected,
    height: height,
    type: "failure",
    title: (urlInfo === null || urlInfo === void 0 ? void 0 : urlInfo.title) || locale.error,
    icon: _ImagePlaceholder$1 || (_ImagePlaceholder$1 = /*#__PURE__*/React__default["default"].createElement(ImagePlaceholder, null)),
    toolbarVisible: cardStyle === 'popup' ? true : undefined,
    titleClick: () => onOpenURL === null || onOpenURL === void 0 ? void 0 : onOpenURL(url),
    ...
    toolbarConfigs: readonly ? [{
      ...
      icon: _CopyIcon$1 || (_CopyIcon$1 = /*#__PURE__*/React__default["default"].createElement(CopyIcon, null)),
      onClick: props.onCopy,
      testId: copyBtnTestID
    }] : [{
      type: 'button',
      title: locale.editTooltip,
      icon: _EditIcon$1 || (_EditIcon$1 = /*#__PURE__*/React__default["default"].createElement(EditIcon, null)),
      onClick: props.onEdit,
      testId: editBtnTestID
    }, {
      type: 'button',
      title: locale.unlinkTooltip,
      icon: _UnlinkIcon$1 || (_UnlinkIcon$1 = /*#__PURE__*/React__default["default"].createElement(UnlinkIcon, null)),
...
}, // 注意内网子域名要放在前面
{
  ...
  return { ...p,
    regexp: new RegExp(`^(https?:\\/\\/)?(.+\\.)?(${p.domains.map(d => d.replace(/\./g, '\\.')).join('|')})($|\\/)`)
  };
});
const patterns = [...domainPatterns];

const getImageIfMatchPattern = url => {
...
var getImgURL = ((url, info, type) => {
  ...
  let result = getImageIfMatchPattern(url);
...
const BgImg = /*#__PURE__*/styled__default["default"].div(["background-color:rgba(23,26,29,0.04);background-image:url(", ");background-size:cover;background-position:50% 50%;border-radius:8px;width:", "px;height:", "px;"], p => p.url, p => p.width, p => p.height);
const URLLinkCardNormal = props => {
  let {
    url,
    urlInfo,
    cardStyle,
  ...
  const imgURL = getImgURL(url, urlInfo, linkType);
  ...
  const onClick = () => onOpenURL === null || onOpenURL === void 0 ? void 0 : onOpenURL(url);

  const cardDesc = []; // 只有一段文本
  ...
  const icon = imgURL !== '' ? /*#__PURE__*/React__namespace.createElement(BgImg, {
    url: imgURL,
    width: 64,
    height: 64
  }) : _ImagePlaceholder || (_ImagePlaceholder = /*#__PURE__*/React__namespace.createElement(ImagePlaceholder, null));
  ...
  if (isMobile || readonly) {
    if (props.onCopy) {
      toolbar.push({
        type: 'button',
        title: locale.copyTooltip,
        icon: _CopyIcon || (_CopyIcon = /*#__PURE__*/React__namespace.createElement(CopyIcon, null)),
        onClick: props.onCopy,
        testId: copyBtnTestID
      });
    }
    ...
    if (props.onEdit) {
      toolbar.push({
        type: 'button',
        title: locale.editTooltip,
        icon: _EditIcon || (_EditIcon = /*#__PURE__*/React__namespace.createElement(EditIcon, null)),
        onClick: props.onEdit,
        testId: editBtnTestID
      });
    }
    ...
    if (props.onUnlink) {
      toolbar.push({
        type: 'button',
        title: locale.unlinkTooltip,
        icon: _UnlinkIcon || (_UnlinkIcon = /*#__PURE__*/React__namespace.createElement(UnlinkIcon, null)),
        onClick: props.onUnlink,
        testId: unlinkBtnTestID
      });
    }
...
const Wrapper = /*#__PURE__*/styled__default["default"].div(["isolation:isolate;.card-layout-title{", "}.card-layout-top{background:linear-gradient( 270deg,rgba(243,246,255,1) 0%,rgba(241,244,255,1) 26.04%,rgba(244,246,249,1) 100% );}.card-layout-icon{margin:8px 16px 8px 8px !important;max-width:100% !important;max-height:100% !important;overflow:visible !important;}.card-layout-desc .item .text{white-space:'break-spaces';}"], p => {
  if (p.state === 'loading' && p.cardStyle === 'popup') {
    return 'margin-top: 5px !important;';
  }
});
const URLLinkCard = props => {
  const stopPropagation = e => {
    e.stopPropagation();
  };

  let el = /*#__PURE__*/React__namespace.createElement(React__namespace.Fragment, null);

  switch (props.state) {
    case 'loading':
      el = /*#__PURE__*/React__namespace.createElement(URLLinkCardLoading, props);
      break;

    case 'error':
      el = /*#__PURE__*/React__namespace.createElement(URLLinkCardError, props);
      break;

    case 'normal':
      el = /*#__PURE__*/React__namespace.createElement(URLLinkCardNormal, props);
      break;
...
exports.URLLinkCard = URLLinkCard;
exports.URLLinkCardHeight = URLLinkCardHeight;
exports.domainPatterns = domainPatterns;
