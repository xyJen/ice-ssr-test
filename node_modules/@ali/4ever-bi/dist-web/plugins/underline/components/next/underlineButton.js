...
import { UnderlineButton as Button } from '@ali/4ever-component';
;
...
export default function UnderlineButton(props) {
  ...
  var tooltip = React.useMemo(function () {
    var description = 'Markdown: ' + DELIMITER.character.repeat(DELIMITER.size) + ((locale == null ? void 0 : locale.text) || 'Text') + DELIMITER.character.repeat(DELIMITER.size) + ' ' + ((locale == null ? void 0 : locale.space) || 'Space');
    return {
