...
var _isInSameList = require("../../utils/isInSameList");
 ...
 *
 * */
var _default = (value, currrentItem) => {
  const {
    key
  } = currrentItem;
  ...
  for (let i = 0; i < nodesLength; i++) {
    ...
    const listConfig = node.data.list; // 当前节点不属于目标列表项，跳过遍历下个节点

    if (!(0, _isInSameList.isInSameList)(listConfig, listId)) {
      continue;
    } // 初始化当前level在map中的初始值
