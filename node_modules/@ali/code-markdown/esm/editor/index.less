...
.custom-html-style .header-anchor {
  float: left;
  line-height: 1;
  margin-left: -20px;
  padding-right: 4px;
...
.custom-html-style .header-anchor:focus {
  outline: none;
}

.custom-html-style h1 .octicon-link-code,
.custom-html-style h2 .octicon-link-code,
.custom-html-style h3 .octicon-link-code,
.custom-html-style h4 .octicon-link-code,
.custom-html-style h5 .octicon-link-code,
.custom-html-style h6 .octicon-link-code {
  color: #1b1f23;
  vertical-align: middle;
  visibility: hidden;
}

.custom-html-style h1:hover .header-anchor,
.custom-html-style h2:hover .header-anchor,
.custom-html-style h3:hover .header-anchor,
.custom-html-style h4:hover .header-anchor,
.custom-html-style h5:hover .header-anchor,
.custom-html-style h6:hover .header-anchor {
  text-decoration: none;
}

.custom-html-style h1:hover .header-anchor .octicon-link-code,
.custom-html-style h2:hover .header-anchor .octicon-link-code,
.custom-html-style h3:hover .header-anchor .octicon-link-code,
.custom-html-style h4:hover .header-anchor .octicon-link-code,
.custom-html-style h5:hover .header-anchor .octicon-link-code,
.custom-html-style h6:hover .header-anchor .octicon-link-code {
  visibility: visible;
}
...
.custom-html-style .emoji {
  font-size: 1.2em;
}

.custom-html-style .mention {
  cursor: pointer;
  white-space: nowrap;
  text-indent: 0px;
  color: rgb(49, 126, 208);
}
