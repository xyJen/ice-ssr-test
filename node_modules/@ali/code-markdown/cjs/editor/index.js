...
var _MultilineBlockquote = require("../previewOnly/MultilineBlockquote");
...
var Editor = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.insertMarkdown = function insertMarkdown(type, option) {
    ...
    if (type === 'shiftTab' && curSelection.start !== curSelection.end) {
      var _curLineStart = this.getMdValue().slice(0, curSelection.start).lastIndexOf('\n') + 1;
  ...
  _proto.render = function render() {
    ...
    var md = new _previewOnly.EditorMdObj({
      useAnchor: false
    });
    ...
    var ResText = (0, _MultilineBlockquote.transMulitiToSingle)(text); // transTabToBlock(text)
    // ResText = deleteSingleEnter(ResText);
