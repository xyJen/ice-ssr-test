...
exports.use = exports.nodeMdText = exports.EditorInput = void 0;
...
var _chooseItem = _interopRequireDefault(require("./chooseItem"));

var _tools = _interopRequireDefault(require("../components/tools"));

var _previewOnly = require("../previewOnly");
...
var EditorInput = function EditorInput(props) {
  if (props.nodeMdEditor) {
    exports.nodeMdText = nodeMdText = props.nodeMdEditor;
  }
  ...
  var _React$useState11 = React.useState(config.view || _defaultConfig.default.view),
  ...
  var editor = {
    ...
    insertMarkdown: function insertMarkdown(type, option) {
      ...
      if (type === 'tab') {
        ...
        var lineInfo = (0, _tool.getLineAndCol)(_text, curLineStart);
    ...
    setView: function setView(to) {
      var newView = (0, _extends2.default)({}, view, to);
      setViewValue(newView);
      emitter.emit(emitter.EVENT_VIEW_CHANGE, newView);
    },
    getView: function getView() {
      return (0, _extends2.default)({}, view);
    }
  };
  ...
  var chooseDebouce = React.useCallback((0, _tools.default)( /*#__PURE__*/function () {
    var _ref2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(chooseStart) {
  ...
  var handleKeyUp = function handleKeyUp(e) {
    ...
    var lineInfo = (0, _tool.getLineAndCol)(text, curPos);
    ...
    if ((_props$onCharMatch = props.onCharMatch) !== null && _props$onCharMatch !== void 0 && _props$onCharMatch.length) {
      props.onCharMatch.map( /*#__PURE__*/function () {
        var _ref3 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3(item, index) {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              lineInfo = (0, _tool.getLineAndCol)(_text2, curPos);
  ...
  var uploadWithDataTransfer = function uploadWithDataTransfer(items) {
    ...
    Array.prototype.forEach.call(items, function (it) {
      if (it.kind === 'file' && it.type.includes('image')) {
        ...
        if (file) {
          var _placeholder = (0, _uploadPlaceholder.default)(file, onImageUpload);
  ...
  if (!props.useToolbar) {
    return /*#__PURE__*/React.createElement("div", {
      className: (0, _classnames.default)(className, "rc-md-editor"),
      ...
      onDrop: handleDrop,
      onKeyUp: handleKeyUp
    }), chooseVisible && /*#__PURE__*/React.createElement(_chooseItem.default, {
      ItemList: chooseList,
  ...
  }, /*#__PURE__*/React.createElement(_previewOnly.EditorPreview, {
