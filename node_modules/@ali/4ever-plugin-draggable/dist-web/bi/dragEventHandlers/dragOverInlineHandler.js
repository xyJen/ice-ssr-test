...
export default function dragOverInlineHandler(event, controller) {
  var draggableData = getDraggableData(controller);
  if (!draggableData) return;
  var dragFragment = draggableData.dragFragment; // 只处理 inline 元素
