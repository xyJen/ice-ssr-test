...
export var handleDragChange = function handleDragChange(action, controller) {
  var _leftToolbar$action;
  ...
  (_leftToolbar$action = leftToolbar[action]) == null ? void 0 : _leftToolbar$action.call(leftToolbar);
  return {};
};
