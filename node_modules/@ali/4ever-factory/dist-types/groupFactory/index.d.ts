...
export declare function groupFactory(createPlugin: (bizConfig: BiPluginConfig) => CustomizedBiGroupPluginType): (bizConfig: BiPluginConfig) => {
    ...
    onKeyDown: (event: import("react").KeyboardEvent<Element>, controller: import("@ali/4ever-cangjie").Controller, next: import("@ali/4ever-cangjie/src/interfaces/next").default<void>) => void;
    ...
    commands: {
        toggleFold(controller: import("@ali/4ever-cangjie").Controller, node: import("@ali/4ever-cangjie").Element<import("@ali/4ever-cangjie/src/interfaces/data").default, import("@ali/4ever-cangjie").Node[]>, fold: boolean): import("@ali/4ever-cangjie").Controller;
    };
    queries: Record<string, import("@ali/4ever-cangjie").Query> | undefined;
};
export declare namespace groupFactory {
    var actions: typeof import("@ali/4ever-plugin-group-factory/src/utils/actions");
    var commands: typeof factoryCommands;
}
