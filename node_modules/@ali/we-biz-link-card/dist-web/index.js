...
var _templateObject$1, _ImagePlaceholder, _CopyIcon, _EditIcon, _UnlinkIcon;

var BgImg = styled.div(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteralLoose(["\n  background-color: rgba(23, 26, 29, 0.04);\n  background-image: url(", ");\n  background-size: cover;\n  background-position: 50% 50%;\n  border-radius: 8px;\n  width: ", "px;\n  height: ", "px;\n"])), function (p) {
  return p.url;
}, function (p) {
  return p.width;
}, function (p) {
