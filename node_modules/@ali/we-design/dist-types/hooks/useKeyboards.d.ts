...
export declare type IKeyboardPair = [IKeyboardCondition, React.KeyboardEventHandler<HTMLElement>] | [IKeyboardCondition, React.KeyboardEventHandler<HTMLElement>, boolean];
