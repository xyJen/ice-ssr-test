...
import type { IPlacement } from '../../components/trigger';
...
export declare type ITooltipHandlerEvent = Pick<ITooltipProps, 'title' | 'zIndex' | 'placement' | 'overlayClassName' | 'overlayStyle' | 'getContainer'> & {
