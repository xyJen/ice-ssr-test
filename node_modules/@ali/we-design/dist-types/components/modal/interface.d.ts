...
export interface IModalProps {
     ...
     * 内部自定义的 ModalContent
     */
    customizeChildren?: React.ReactElement;
}
export interface IModalConfirmOptions extends Pick<IModalProps, 'okText' | 'cancelText' | 'locale' | 'onOk' | 'onCancel' | 'zIndex' | 'width' | 'title' | 'okButtonProps' | 'cancelButtonProps' | 'testid' | 'keyboard'> {
...
export interface IModalMethodResult {
    destroy: () => void;
}
