...
import { Size, ExcessMode, TabBarExtraContent } from './interface';
export declare type TabType = 'biz' | 'line' | 'card' | 'capsule' | 'editable-line' | 'editable-card' | 'custom' | 'editable-biz' | 'd-design';
