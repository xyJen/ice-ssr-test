...
export var Trigger = /*#__PURE__*/React.memo(function (props) {
  var type = props.type,
      ...
      title = props.title,
      testid = props.testid,
      _props$delayHide = props.delayHide,
      delayHide = _props$delayHide === void 0 ? DELAY_TO_HIDE : _props$delayHide,
  ...
  var handleEnter = useCallback(function () {
    ...
    if (newVisible && !visible) {
      if (delayShow) {
        timerEnter.current = window.setTimeout(function () {
  ...
  }, [isEntered, handleClearTimerEnter, handleClearTimerLeave, handleVisibleChange, visible, delayShow]);
  /**
   * 离开trigger/overlay
   *
   * @return void
  ...
  }, [handleClearTimerEnter, handleClearTimerLeave, isEntered, visible, handleVisibleChange, delayHide]);
  /**
   * 进入trigger
   *
  ...
  return /*#__PURE__*/_createElement(React.Fragment, null, !!child && /*#__PURE__*/_createElement(Tooltip, {
    ...
    overlayAutoAlignDelay: overlayAutoAlignDelay,
    role: role
  }));
});
