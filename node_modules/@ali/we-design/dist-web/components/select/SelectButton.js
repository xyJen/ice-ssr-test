...
var getValueString = function getValueString(value, inputTriggerText) {
  var v = typeof value === 'undefined' ? '' : "" + value;
  return inputTriggerText ? inputTriggerText(v) : v;
};
...
export function SelectButton(props) {
  var locale = props.locale,
      ...
      testid = props.testid,
      inputTriggerText = props.inputTriggerText; // 自定义显示区函数优先级最高
  ...
  if (mode === 'search' || mode === 'input') {
    return /*#__PURE__*/_createElement(InputStyled, {
      ref: inputRef,
      className: "fix-box-shadow",
      placeholder: getValueString(value, inputTriggerText),
      locale: locale,
      value: "" + (!isInputFocused || !visible ? getValueString(value, inputTriggerText) : keyword),
      autoComplete: "off",
      readOnly: !visible,
      onFocus: onFocus,
      onChange: onChange,
