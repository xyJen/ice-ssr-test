...
import { SelectWrap, StandardSelectWrap, TriggerWrap, TriggerContent, EmptyWrap, OverlayWrap, ErrorTip } from "./styled";
...
var Select = function Select(props, ref) {
  var children = props.children,
      ...
      styleType = _props$styleType === void 0 ? 'toolbar' : _props$styleType,
      ...
      restProps = _objectWithoutPropertiesLoose(props, ["children", "getContainer", "style", "className", "overlayStyle", "renderTrigger", "bordered", "onChange", "onSelect", "disabled", "onVisibleChange", "optionWrapperStyle", "selectable", "locale", "size", "zIndex", "showArrow", "placement", "overlayClassName", "mode", "rules", "autoClose", "testid", "title", "errored", "showErrorState", "animationPlacement", "showSelectOnRight", "styleType", "errorTip", "role", "dropdownRender", "filterOption", "inputTriggerText", "disableDomAlign", "overlayAutoAlign"]); // value 受控
  ...
  }, [value, selectable, handleVisibleChange, handleValueChange, autoClose, onSelect]);
  /**
   * Option 被移除
   *
   * @param {ValueType} key
  ...
  var handleInputChange = useCallback(function (e) {
    ...
    state.showOptionValues = Array.from(state.OptionChildrenRecord.entries()).filter(function (_ref) {
      var v = _ref[0],
          node = _ref[1];
      var keyword = e.target.value.trim();

      if (typeof filterOption === 'function') {
        return filterOption(keyword, node);
      } // filterOption 为 false 时，不做筛选
  ...
  var SelectStyle = useMemo(function () {
    return styleType === 'standard' ? StandardSelectWrap : SelectWrap;
  }, [styleType]);
  var overlayContentNode = useMemo(function () {
    var baseNOde = /*#__PURE__*/_createElement(React.Fragment, null, /*#__PURE__*/_createElement("div", {
      style: {
    ...
    return dropdownRender ? dropdownRender(baseNOde) : baseNOde;
  }, [children, dropdownRender, searchNoMatch, t]);
  return /*#__PURE__*/_createElement(SelectContext.Provider, {
  ...
  }, /*#__PURE__*/_createElement(SelectStyle, _extends({
    showArrow: showArrow,
    ref: ref,
    ...
    className: classnames(className, size, {
      bordered: bordered,
      focused: styleType === 'standard' ? visible : state.isInputFocused,
      disabled: disabled,
      actived: visible,
      errored: showErrorState && !disabled && errored
    })
  ...
  }, /*#__PURE__*/_createElement(TriggerContent, {
  ...
  }, SelectedOptionChildren || /*#__PURE__*/_createElement("span", null, value))), /*#__PURE__*/_createElement("div", {
  ...
  }))), errored && errorTip && /*#__PURE__*/_createElement(ErrorTip, {
    style: {
      marginLeft: '-6px'
    }
  }, errorTip))));
