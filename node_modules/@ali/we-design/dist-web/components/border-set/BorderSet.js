...
var _BorderOuterNormal, _BorderInnerNormal, _BorderAllNormal, _BorderLeftNormal, _BorderRightNormal, _BorderTopNormal, _BorderBottomNormal, _BorderNoneNormal, _BorderHorizontalNorm, _BorderVerticalNormal, _BorderNoneNormal2;

import React from 'react';
var _createElement = /*#__PURE__*/React.createElement;
import { FillColorPicker } from "../../components/color-picker";
import { SplitButton } from "../../components/button";
import { BorderTopNormal, BorderNoneNormal, BorderAllNormal, BorderBottomNormal, BorderHorizontalNormal, BorderInnerNormal, BorderLeftNormal, BorderOuterNormal, BorderRightNormal, BorderVerticalNormal } from "../../components/icons";
import { NumberInput } from "../../components/number";
import { CommonLineSelect } from "../../components/lines";
  ...
  function BorderSet(props) {
    ...
    _this.renderShowIcon = function () {
      ...
      switch (innerBorderType) {
        case 'outer':
          return _BorderOuterNormal || (_BorderOuterNormal = /*#__PURE__*/_createElement(BorderOuterNormal, null));

        case 'inner':
          return _BorderInnerNormal || (_BorderInnerNormal = /*#__PURE__*/_createElement(BorderInnerNormal, null));

        case 'all':
          return _BorderAllNormal || (_BorderAllNormal = /*#__PURE__*/_createElement(BorderAllNormal, null));

        case 'left':
          return _BorderLeftNormal || (_BorderLeftNormal = /*#__PURE__*/_createElement(BorderLeftNormal, null));

        case 'right':
          return _BorderRightNormal || (_BorderRightNormal = /*#__PURE__*/_createElement(BorderRightNormal, null));

        case 'top':
          return _BorderTopNormal || (_BorderTopNormal = /*#__PURE__*/_createElement(BorderTopNormal, null));

        case 'bottom':
          return _BorderBottomNormal || (_BorderBottomNormal = /*#__PURE__*/_createElement(BorderBottomNormal, null));

        case 'none':
          return _BorderNoneNormal || (_BorderNoneNormal = /*#__PURE__*/_createElement(BorderNoneNormal, null));

        case 'horizon':
          return _BorderHorizontalNorm || (_BorderHorizontalNorm = /*#__PURE__*/_createElement(BorderHorizontalNormal, null));

        case 'vertical':
          return _BorderVerticalNormal || (_BorderVerticalNormal = /*#__PURE__*/_createElement(BorderVerticalNormal, null));

        default:
          return _BorderNoneNormal2 || (_BorderNoneNormal2 = /*#__PURE__*/_createElement(BorderNoneNormal, null));
      }
    };
