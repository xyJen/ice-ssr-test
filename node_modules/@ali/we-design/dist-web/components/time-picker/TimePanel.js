...
var matchTimeTag = function matchTimeTag(format, type) {
  var TIME_TAGS = {
    hour: ['h', 'H'],
    minute: ['m'],
    second: ['s']
  };
  var tags = TIME_TAGS[type];
  return tags.some(function (tag) {
    return format.indexOf(tag) > -1;
  });
};
...
var TimePanel = function TimePanel(props) {
  var locale = props.locale,
      ...
      format = _props$format === void 0 ? 'HH:mm:ss' : _props$format; // 国际化
  ...
  }, matchTimeTag(format, 'hour') ? /*#__PURE__*/_createElement(PanelColumnWrap, null, /*#__PURE__*/_createElement(PanelColumnTitle, null, t('we_ui_time_hour')), /*#__PURE__*/_createElement(PanelColumnBody, null, /*#__PURE__*/_createElement(NumberSlider, {
    visible: visible,
    number: value ? value.hour() : 0,
    numbers: hourNumbers,
    onChange: handleChanges.hour,
    testid: testid + "_hour"
  }))) : null, matchTimeTag(format, 'minute') ? /*#__PURE__*/_createElement(PanelColumnWrap, null, /*#__PURE__*/_createElement(PanelColumnTitle, null, t('we_ui_time_minute')), /*#__PURE__*/_createElement(PanelColumnBody, null, /*#__PURE__*/_createElement(NumberSlider, {
    visible: visible,
    number: value ? value.minute() : 0,
    numbers: minuteNumbers,
    onChange: handleChanges.minute,
    testid: testid + "_minute"
  }))) : null, matchTimeTag(format, 'second') ? /*#__PURE__*/_createElement(PanelColumnWrap, null, /*#__PURE__*/_createElement(PanelColumnTitle, null, t('we_ui_time_second')), /*#__PURE__*/_createElement(PanelColumnBody, null, /*#__PURE__*/_createElement(NumberSlider, {
    visible: visible,
