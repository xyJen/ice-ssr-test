...
export var ColorBlockItem = /*#__PURE__*/React.memo(function (props) {
  var colorBlockText = props.colorBlockText,
      customColorBlockTextColor = props.customColorBlockTextColor;
  /**
   * 将颜色值转换成颜色对象
   */
  ...
  var border = isWhite(colorValue) || isTransparent(colorValue);
  var customColor = customColorBlockTextColor ? customColorBlockTextColor(colorValue) : getContrastingColor(colorValue); // 选中的样式
