...
import { FontcolorNormal, BgNormal, BgfontcolorNormal, BgsheetcolorNormal } from "../../components/icons";
...
export var ColorPicker = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var _this$props4 = this.props,
        ...
        getContainer = _this$props4.getContainer; // 如果填充部分表现为白色（传入空字符串，白色或透明），则填充的外围边界线需有颜色

    var whiteFilling = !currentColor || isWhite(currentColor) || isTransparent(currentColor);
    var pathColors = disabled ? undefined : [!whiteFilling ? currentColor : ICON_DEFAULT_COLOR, !whiteFilling ? currentColor : 'white', ICON_DEFAULT_COLOR];
    var btnTypeList = (_btnTypeList = {}, _btnTypeList[EColorPickerIcon.font] = /*#__PURE__*/_createElement(FontcolorNormal, {
      pathColors: pathColors
    }), _btnTypeList[EColorPickerIcon.background] = /*#__PURE__*/_createElement(BgNormal, {
      pathColors: pathColors
    }), _btnTypeList[EColorPickerIcon.backgroundfont] = /*#__PURE__*/_createElement(BgfontcolorNormal, {
      pathColors: pathColors
    }), _btnTypeList[EColorPickerIcon.backgroundsheet] = /*#__PURE__*/_createElement(BgsheetcolorNormal, {
      pathColors: pathColors
    }), _btnTypeList);
    return children ? this.renderCustomTrigger() : /*#__PURE__*/_createElement(SplitButton, {
      ...
      size: size,
      getContainer: getContainer
    }, /*#__PURE__*/_createElement(SplitButtonWrapper, null, btnType ? btnTypeList[btnType] : /*#__PURE__*/_createElement(React.Fragment, null, btnIcon, /*#__PURE__*/_createElement(FillColorArea, {
      color: color || currentColor
    }))));
  };
