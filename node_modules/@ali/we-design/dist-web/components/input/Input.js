...
import { CloseNormal } from '@ali/we-icon';
...
var Input = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var _ref = props,
      ...
      restProps = _objectWithoutPropertiesLoose(_ref, ["suffix", "prefix", "onChange", "type", "locale", "onFocus", "onBlur", "allowClear", "id", "className", "disabled", "size", "bordered", "maxLength", "style", "onKeyDown", "onEnter", "testid", "meta", "autoFocus", "placeholderColor", "defaultValue", "inputStyle"]);
  ...
  return /*#__PURE__*/_createElement(InputWrap, {
    ...
    className: classnames(className, {
      focused: isFocused,
      disabled: disabled,
      error: meta && meta.errors.length > 0
    }),
    style: style,
    size: size,
    bordered: bordered,
    "data-testid": testid ? "Input_" + testid + "_wrap" : undefined
  }, !!prefix && /*#__PURE__*/_createElement(InputPrefix, {
    "data-testid": testid ? "Input_" + testid + "_prefix" : undefined
  }, prefix), /*#__PURE__*/_createElement(InputNode, _extends({}, restProps, {
    ref: inputRef,
    maxLength: maxLength,
    autoFocus: autoFocus,
    value: value || '',
    ...
    style: inputStyle
  })), !!allowClear && !!value && /*#__PURE__*/_createElement(CloseNormal, {
    "data-testid": testid ? "Input_" + testid + "_clear" : undefined,
    onClick: handleReset,
    onMouseDown: blockEvent,
    className: "clear-icon"
  }), !!suffix && /*#__PURE__*/_createElement(InputSuffix, {
    allowClear: !!allowClear,
    "data-testid": testid ? "Input_" + testid + "_suffix" : undefined
  }, suffix));
});
Input.defaultProps = {
  allowClear: false,
